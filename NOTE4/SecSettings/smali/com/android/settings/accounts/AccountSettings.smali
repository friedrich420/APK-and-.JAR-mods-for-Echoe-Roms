...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/accounts/AccountSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/os/UserManager;

    iput-object v1, p0, Lcom/android/settings/accounts/AccountSettings;->mUm:Landroid/os/UserManager;
    ...
    iput-object v1, p0, Lcom/android/settings/accounts/AccountSettings;->mProfileNotAvailablePreference:Landroid/preference/Preference;
    ...
    iput-object v1, p0, Lcom/android/settings/accounts/AccountSettings;->mAuthorities:[Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/settings/accounts/AccountSettings;->mRefreshListFilter:Landroid/content/IntentFilter;

    .line 166
    iget-object v1, p0, Lcom/android/settings/accounts/AccountSettings;->mRefreshListFilter:Landroid/content/IntentFilter;

    const-string v2, "com.sec.android.app.sns3.TwitterSSOAccountsRemoved"
    ...
    iput-object v1, p0, Lcom/android/settings/accounts/AccountSettings;->mContext:Landroid/content/Context;

    .line 170
    iget-object v1, p0, Lcom/android/settings/accounts/AccountSettings;->mContext:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/android/settings/accounts/AccountSettings;->mBrAccountMenu:Landroid/content/BroadcastReceiver;

    iget-object v3, p0, Lcom/android/settings/accounts/AccountSettings;->mRefreshListFilter:Landroid/content/IntentFilter;

    invoke-virtual {v1, v2, v3}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 172
    iput-boolean v5, p0, Lcom/android/settings/accounts/AccountSettings;->mRegistered:Z
    ...
    .line 182
    invoke-virtual {p0, v4}, Lcom/android/settings/accounts/AccountSettings;->setHasOptionsMenu(Z)V
    ...
    .line 187
    :cond_4
    invoke-virtual {p0, v5}, Lcom/android/settings/accounts/AccountSettings;->setHasOptionsMenu(Z)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    new-instance v2, Lcom/android/settings/accounts/AccountSettings$HelpClickListener;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/android/settings/accounts/AccountSettings$HelpClickListener;-><init>(Lcom/android/settings/accounts/AccountSettings;Lcom/android/settings/accounts/AccountSettings$1;)V
