...
.method public onCheckingstatus(Z)Z
    ...
    .line 616
    .local v5, "onehandoperation":I
    const/4 v6, 0x0

    .line 618
    .local v6, "sidesoftkey":I
    invoke-virtual {p0}, Lcom/android/settings/accessibility/ToggleAccessibilityServicePreferenceFragment;->getActivity()Landroid/app/Activity;
    ...
    const-string v9, "any_screen_enabled"
    ...
    .line 619
    iget-object v8, p0, Lcom/android/settings/accessibility/ToggleAccessibilityServicePreferenceFragment;->context:Landroid/content/Context;

    invoke-virtual {v8}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v8

    const-string v9, "com.sec.feature.floating_side_softkey"
    ...
    const-string v9, "sidesoftkey_switch"
    ...
    .line 630
    .end local v5    # "onehandoperation":I
    .end local v6    # "sidesoftkey":I
    :cond_a
    iget-object v8, p0, Lcom/android/settings/accessibility/ToggleAccessibilityServicePreferenceFragment;->mTts:Landroid/speech/tts/TextToSpeech;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    const-string v8, "sidesoftkey_switch"
