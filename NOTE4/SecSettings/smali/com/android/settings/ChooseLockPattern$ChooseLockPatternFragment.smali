...
.method private sendIntentToKnoxKeyguard(I)V
    ...
    .prologue
    .line 833
    # getter for: Lcom/android/settings/ChooseLockPattern;->isKnoxB2CResetCase:Z
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 492
    iget-object v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mUiStage:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;

    iget-object v8, v8, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;->leftMode:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$LeftButtonMode;

    sget-object v9, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$LeftButtonMode;->Retry:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$LeftButtonMode;

    if-ne v8, v9, :cond_1

    .line 493
    iput-object v13, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mChosenPattern:Ljava/util/List;
    ...
    invoke-virtual {v8}, Lcom/android/internal/widget/LockPatternView;->clearPattern()V
    ...
    sget-object v9, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$LeftButtonMode;->Cancel:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$LeftButtonMode;

    if-ne v8, v9, :cond_7

    .line 499
    iget v8, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mPwdChangeEnforce:I
    ...
    sget-object v9, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;->Introduction:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;
    ...
    .line 507
    :cond_2
    invoke-direct {p0, v10}, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->sendIntentToKnoxKeyguard(I)V
    ...
    iget v9, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mPwdChangeTimeout:I

    invoke-direct {p0, v8, v9}, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->scheduleNextPwdChange(II)V
    ...
    invoke-virtual {v8, v11}, Landroid/app/Activity;->setResult(I)V
    ...
    const-string v10, "left footer button pressed, but stage of "
    ...
    const-string v10, " doesn\'t make sense"
    ...
    iget-object v8, v8, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;->rightMode:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$RightButtonMode;
    ...
    const-string v10, "expected ui stage "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    sget-object v10, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;->FirstChoiceValid:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string v10, " when button is "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    sget-object v10, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$RightButtonMode;->Continue:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$RightButtonMode;
    ...
    sget-object v10, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;->ChoiceConfirmed:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;
    ...
    const-class v10, Lcom/android/settings/ChooseLockAdditionalPin;
    ...
    .line 588
    const-string v8, "firstlock"

    iget-object v9, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mChosenPattern:Ljava/util/List;

    invoke-static {v9}, Lcom/android/internal/widget/LockPatternUtils;->patternToString(Ljava/util/List;)Ljava/lang/String;
    ...
    sget-object v9, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;->HelpScreen:Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment$Stage;
    ...
    const-string v10, "Help screen is only mode with ok button, but stage is "
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    # setter for: Lcom/android/settings/ChooseLockPattern;->isKnoxB2CResetCase:Z
