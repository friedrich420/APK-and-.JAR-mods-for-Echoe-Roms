...
.method private initPreferences()V
    ...
    .line 278
    .local v27, "isCscWifiEnableWarning":Z
    :goto_0
    ...
    .line 307
    .local v38, "scanAlwaysAvailable":Landroid/preference/CheckBoxPreference;
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 313
    .local v32, "pref":Landroid/preference/Preference;
    if-eqz v32, :cond_1
    ...
    .line 321
    .local v24, "isAllowPermissionPopup":Landroid/preference/CheckBoxPreference;
    ...
    invoke-static {v15}, Lcom/android/settings/wifi/WifiSettings;->getWifiAssistantApp(Landroid/content/Context;)Landroid/net/NetworkScorerAppManager$NetworkScorerAppData;

    move-result-object v39

    .line 368
    .local v39, "scorer":Landroid/net/NetworkScorerAppManager$NetworkScorerAppData;
    ...
    .line 369
    .local v43, "wifiAssistant":Landroid/preference/SwitchPreference;
    if-eqz v39, :cond_23

    .line 370
    invoke-static {v15}, Landroid/net/NetworkScorerAppManager;->getActiveScorer(Landroid/content/Context;)Landroid/net/NetworkScorerAppManager$NetworkScorerAppData;
    ...
    .line 441
    .local v11, "apListPriority":Landroid/preference/ListPreference;
    if-eqz v11, :cond_6
    ...
    .line 455
    .local v41, "stringValue":Ljava/lang/String;
    ...
    invoke-direct {v0, v11, v1}, Lcom/android/settings/wifi/AdvancedWifiSettings;->updateApListPrioritySummary(Landroid/preference/Preference;Ljava/lang/String;)V

    .line 466
    .end local v41    # "stringValue":Ljava/lang/String;
    ...
    check-cast v44, Landroid/preference/ListPreference;

    .line 467
    .local v44, "wifiConnectType":Landroid/preference/ListPreference;
    ...
    .line 472
    .restart local v41    # "stringValue":Ljava/lang/String;
    move-object/from16 v0, v44
    ...
    .line 482
    .local v20, "enablePriorityPref":Landroid/preference/PreferenceScreen;
    ...
    iget-object v3, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;

    const/4 v5, 0x0

    invoke-virtual {v3, v5}, Landroid/app/admin/DevicePolicyManager;->getAllowWifi(Landroid/content/ComponentName;)Z

    move-result v3

    move-object/from16 v0, p0

    iput-boolean v3, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->allowWifi:Z
    ...
    iget-boolean v6, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->allowWifi:Z
    ...
    iget-object v3, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mSharedPref:Landroid/content/SharedPreferences;
    ...
    sget-boolean v5, Lcom/android/settings/wifi/AdvancedWifiSettings;->hideNavigationButton:Z
    ...
    iget-boolean v3, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->allowWifi:Z
    ...
    .line 507
    .local v10, "alarm_intent":Landroid/content/Intent;
    ...
    invoke-virtual {v3, v10}, Landroid/content/Context;->sendStickyBroadcast(Landroid/content/Intent;)V

    .line 531
    .end local v10    # "alarm_intent":Landroid/content/Intent;
    ...
    check-cast v40, Landroid/preference/ListPreference;

    .line 546
    .local v40, "sleepPolicyPref":Landroid/preference/ListPreference;
    if-eqz v40, :cond_d
    ...
    .line 555
    .restart local v41    # "stringValue":Ljava/lang/String;
    invoke-virtual/range {v40 .. v41}, Landroid/preference/ListPreference;->setValue(Ljava/lang/String;)V
    ...
    .line 562
    .local v35, "preferredBandPref":Landroid/preference/ListPreference;
    if-eqz v35, :cond_e
    ...
    .line 580
    .local v21, "hiddenApsByRssiPref":Landroid/preference/ListPreference;
    if-eqz v21, :cond_f
    ...
    .line 597
    .local v22, "hiddenApsBySsidPref":Landroid/preference/Preference;
    if-eqz v22, :cond_10
    ...
    .line 606
    .local v37, "resetPref":Landroid/preference/Preference;
    if-eqz v37, :cond_11
    ...
    .line 614
    .local v13, "connMonitoringPref":Landroid/preference/CheckBoxPreference;
    ...
    .line 616
    .local v14, "connSettingsPref":Landroid/preference/PreferenceScreen;
    ...
    .line 636
    .local v31, "parentPreference":Landroid/preference/PreferenceGroup;
    ...
    .line 637
    .local v36, "removablePref":Landroid/preference/Preference;
    if-eqz v36, :cond_13
    ...
    .line 650
    .end local v31    # "parentPreference":Landroid/preference/PreferenceGroup;
    .end local v36    # "removablePref":Landroid/preference/Preference;
    :cond_15
    ...
    .line 652
    .local v29, "mWlanEnabled":Landroid/preference/CheckBoxPreference;
    if-eqz v29, :cond_16
    ...
    .line 656
    .local v28, "mWlan":Landroid/content/Context;
    ...
    .line 657
    .local v34, "pref_mWlan_4":Landroid/content/SharedPreferences;
    const-string v3, "mwlan"
    ...
    .line 658
    .local v33, "pref_mWlan":Landroid/content/SharedPreferences;
    ...
    .line 664
    .local v18, "e":Landroid/content/SharedPreferences$Editor;
    const-string v3, "mwlan_permission_allowed_2"
    ...
    .line 682
    .end local v18    # "e":Landroid/content/SharedPreferences$Editor;
    .end local v25    # "isAllowed":Z
    .end local v26    # "isAllowed_4":Z
    .end local v28    # "mWlan":Landroid/content/Context;
    .end local v33    # "pref_mWlan":Landroid/content/SharedPreferences;
    .end local v34    # "pref_mWlan_4":Landroid/content/SharedPreferences;
    :cond_16
    :goto_15
    return-void

    .line 276
    .end local v11    # "apListPriority":Landroid/preference/ListPreference;
    .end local v13    # "connMonitoringPref":Landroid/preference/CheckBoxPreference;
    .end local v14    # "connSettingsPref":Landroid/preference/PreferenceScreen;
    .end local v15    # "context":Landroid/content/Context;
    .end local v20    # "enablePriorityPref":Landroid/preference/PreferenceScreen;
    .end local v21    # "hiddenApsByRssiPref":Landroid/preference/ListPreference;
    .end local v22    # "hiddenApsBySsidPref":Landroid/preference/Preference;
    .end local v23    # "intent":Landroid/content/Intent;
    .end local v24    # "isAllowPermissionPopup":Landroid/preference/CheckBoxPreference;
    .end local v27    # "isCscWifiEnableWarning":Z
    .end local v29    # "mWlanEnabled":Landroid/preference/CheckBoxPreference;
    .end local v32    # "pref":Landroid/preference/Preference;
    .end local v35    # "preferredBandPref":Landroid/preference/ListPreference;
    .end local v37    # "resetPref":Landroid/preference/Preference;
    .end local v38    # "scanAlwaysAvailable":Landroid/preference/CheckBoxPreference;
    .end local v39    # "scorer":Landroid/net/NetworkScorerAppManager$NetworkScorerAppData;
    .end local v40    # "sleepPolicyPref":Landroid/preference/ListPreference;
    .end local v43    # "wifiAssistant":Landroid/preference/SwitchPreference;
    .end local v44    # "wifiConnectType":Landroid/preference/ListPreference;
    :cond_17
    const/16 v27, 0x0
    ...
    .line 280
    .restart local v27    # "isCscWifiEnableWarning":Z
    :cond_18
    const/4 v3, 0x0
    ...
    .line 297
    .restart local v17    # "defaultValue":I
    :cond_19
    const/4 v3, 0x0
    ...
    .line 307
    .restart local v38    # "scanAlwaysAvailable":Landroid/preference/CheckBoxPreference;
    :cond_1b
    const/4 v3, 0x0
    ...
    .restart local v24    # "isAllowPermissionPopup":Landroid/preference/CheckBoxPreference;
    .restart local v32    # "pref":Landroid/preference/Preference;
    :cond_1c
    const/4 v3, 0x0
    ...
    .restart local v39    # "scorer":Landroid/net/NetworkScorerAppManager$NetworkScorerAppData;
    .restart local v43    # "wifiAssistant":Landroid/preference/SwitchPreference;
    :cond_22
    const/4 v12, 0x0
    ...
    .line 450
    .restart local v11    # "apListPriority":Landroid/preference/ListPreference;
    .restart local v42    # "value":I
    :cond_24
    move-object/from16 v0, p0
    ...
    .line 475
    .end local v42    # "value":I
    .restart local v44    # "wifiConnectType":Landroid/preference/ListPreference;
    :cond_25
    if-eqz v44, :cond_7
    ...
    .line 488
    .restart local v20    # "enablePriorityPref":Landroid/preference/PreferenceScreen;
    :cond_26
    if-eqz v20, :cond_8
    ...
    iget-object v5, v0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mSharedPref:Landroid/content/SharedPreferences;
    ...
    invoke-static {v3, v5}, Lcom/android/settings/wifi/WifiTimer;->getTimeAmPmFormat(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v46

    .line 513
    .local v46, "wifiTimerStartTime":Ljava/lang/String;
    :goto_17
    move-object/from16 v0, p0
    ...
    .line 515
    .local v45, "wifiTimerEndTime":Ljava/lang/String;
    :goto_18
    const-string v3, ""
    ...
    .line 511
    .end local v45    # "wifiTimerEndTime":Ljava/lang/String;
    .end local v46    # "wifiTimerStartTime":Ljava/lang/String;
    :cond_28
    const-string v46, ""
    ...
    .line 513
    .restart local v46    # "wifiTimerStartTime":Ljava/lang/String;
    :cond_29
    const-string v45, ""
    ...
    .line 518
    .restart local v45    # "wifiTimerEndTime":Ljava/lang/String;
    :cond_2a
    move-object/from16 v0, p0
    ...
    .line 572
    .restart local v35    # "preferredBandPref":Landroid/preference/ListPreference;
    .restart local v40    # "sleepPolicyPref":Landroid/preference/ListPreference;
    :cond_30
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 589
    .restart local v21    # "hiddenApsByRssiPref":Landroid/preference/ListPreference;
    :cond_31
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 618
    .restart local v13    # "connMonitoringPref":Landroid/preference/CheckBoxPreference;
    .restart local v14    # "connSettingsPref":Landroid/preference/PreferenceScreen;
    .restart local v22    # "hiddenApsBySsidPref":Landroid/preference/Preference;
    .restart local v37    # "resetPref":Landroid/preference/Preference;
    :cond_32
    const/4 v3, 0x0
    ...
    invoke-virtual {v3, v14}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    goto/16 :goto_14

    .line 669
    .restart local v29    # "mWlanEnabled":Landroid/preference/CheckBoxPreference;
    :cond_35
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 671
    .restart local v31    # "parentPreference":Landroid/preference/PreferenceGroup;
    ...
    .line 672
    .restart local v36    # "removablePref":Landroid/preference/Preference;
    if-eqz v36, :cond_36
