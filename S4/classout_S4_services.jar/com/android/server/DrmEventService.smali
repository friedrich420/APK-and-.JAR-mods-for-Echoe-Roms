...
.method public constructor <init>()V
    ...
    .line 109
    iput-object v1, p0, nitzFilter:Landroid/content/IntentFilter;

    .line 110
    iput-boolean v0, p0, bTimeChangeReceived:Z

    .line 111
    iput-boolean v0, p0, bNitzReceived:Z

    .line 112
    iput-object v1, p0, timeFormat:Ljava/lang/String;

    .line 114
    iput-boolean v0, p0, isRegisteredBootTime:Z

    .line 116
    iput-boolean v0, p0, mIs24HourFormat:Z
    ...
    iput-object v0, p0, wapPushReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, drmEventListener:Landroid/drm/DrmManagerClient$OnEventListener;
    ...
    iput-object v0, p0, errorListener:Landroid/drm/DrmManagerClient$OnErrorListener;
...
.method static synthetic access$000(Lcom/android/server/DrmEventService;ILandroid/drm/DrmInfo;Landroid/drm/DrmInfoRequest;Landroid/content/Intent;)I
    ...
    .prologue
    .line 69
    invoke-direct {p0, p1, p2, p3, p4}, handleDbOperation(ILandroid/drm/DrmInfo;Landroid/drm/DrmInfoRequest;Landroid/content/Intent;)I
...
.method private declared-synchronized handleDbOperation(ILandroid/drm/DrmInfo;Landroid/drm/DrmInfoRequest;Landroid/content/Intent;)I
    ...
    :pswitch_d2
    invoke-direct {p0, p4}, handleDrmInit(Landroid/content/Intent;)V
    :try_end_d5
...
.method private handleDrmInit(Landroid/content/Intent;)V
    ...
    invoke-static {v7}, checkForFileorDirectoryExists(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v1}, createTables(Landroid/database/sqlite/SQLiteDatabase;)V

    .line 524
    invoke-direct {p0, v1}, createIndexData(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, v7}, deleteDRMDBFile(Ljava/lang/String;)Z
...
.method InitializeOmaIntent(ILjava/lang/String;)V
    ...
    .prologue
    .line 1128
    sget-boolean v2, isLogEnabled:Z
...
.method public handleNitztimeUpdation(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v7, v8, v2, v9}, handleDbOperation(ILandroid/drm/DrmInfo;Landroid/drm/DrmInfoRequest;Landroid/content/Intent;)I
    ...
    invoke-direct {p0, v7, v8, v3, v9}, handleDbOperation(ILandroid/drm/DrmInfo;Landroid/drm/DrmInfoRequest;Landroid/content/Intent;)I
...
.method public handleUserUpdatedTimeUpdation(Landroid/content/Intent;)V
    ...
    .line 1006
    :cond_26
    sget-boolean v8, isLogEnabled:Z
    ...
    invoke-direct {p0, v8, v9, v4, v10}, handleDbOperation(ILandroid/drm/DrmInfo;Landroid/drm/DrmInfoRequest;Landroid/content/Intent;)I
    ...
    invoke-direct {p0, v8, v9, v5, v10}, handleDbOperation(ILandroid/drm/DrmInfo;Landroid/drm/DrmInfoRequest;Landroid/content/Intent;)I
...
.method public onCreate()V
    ...
    .line 268
    :cond_b
    iget-object v2, p0, mDrmManagerClient:Landroid/drm/DrmManagerClient;
    ...
    iput-object v2, p0, mDrmManagerClient:Landroid/drm/DrmManagerClient;
    ...
    iget-object v3, p0, drmEventListener:Landroid/drm/DrmManagerClient$OnEventListener;
    ...
    iget-object v3, p0, errorListener:Landroid/drm/DrmManagerClient$OnErrorListener;
    ...
    iput-object v2, p0, mServiceLooper:Landroid/os/Looper;

    .line 284
    new-instance v2, Lcom/android/server/DrmEventService$ServiceHandler;

    iget-object v3, p0, mServiceLooper:Landroid/os/Looper;
    ...
    iput-object v2, p0, mServiceHandler:Lcom/android/server/DrmEventService$ServiceHandler;
...
.method public onStart(Landroid/content/Intent;I)V
    ...
    iget-boolean v4, p0, isRegisteredBootTime:Z
    ...
    .line 131
    :cond_4d
    iget-boolean v2, p0, isRegisteredBootTime:Z
    ...
    invoke-static {v2}, checkForFileorDirectoryExists(Ljava/lang/String;)I
    ...
    .line 151
    :cond_8f
    invoke-virtual {p0, p0, p1}, processWapPush(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 156
    :cond_b6
    iget-object v2, p0, mServiceHandler:Lcom/android/server/DrmEventService$ServiceHandler;
...
.method public processWapPush(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v7, v8, v11, v11}, handleDbOperation(ILandroid/drm/DrmInfo;Landroid/drm/DrmInfoRequest;Landroid/content/Intent;)I
