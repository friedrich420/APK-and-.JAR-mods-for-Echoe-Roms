...
.method constructor <init>(Lcom/android/server/clipboardex/ClipboardExService;Landroid/sec/clipboard/data/list/ClipboardDataText;Ljava/lang/CharSequence;)V
    ...
    iput-object p2, p0, val$data:Landroid/sec/clipboard/data/list/ClipboardDataText;
...
.method public run()V
    ...
    .line 1078
    :try_start_1
    iget-object v0, p0, val$data:Landroid/sec/clipboard/data/list/ClipboardDataText;
    ...
    iget-object v1, p0, val$data:Landroid/sec/clipboard/data/list/ClipboardDataText;

    invoke-virtual {v1}, Landroid/sec/clipboard/data/list/ClipboardDataText;->GetFomat()I

    move-result v1

    iget-object v2, p0, val$data:Landroid/sec/clipboard/data/list/ClipboardDataText;
