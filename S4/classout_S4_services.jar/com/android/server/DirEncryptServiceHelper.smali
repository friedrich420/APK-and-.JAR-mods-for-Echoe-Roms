...
.method private doEncryption()V
    ...
    :goto_1b
    iget-boolean v7, p0, mPassword:Z
...
.method private doWorkForPassword(Ljava/lang/String;)V
    ...
    iput-boolean v10, p0, mPassword:Z
    ...
    invoke-direct {p0, v10, v11}, sendCommand(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 875
    :cond_25
    iget-boolean v10, p0, mPassword:Z
    ...
    .line 894
    iget-object v10, p0, mDep:Lcom/android/server/DirEncryptPrefs;
    ...
    .line 897
    iget-object v10, p0, mDew:Landroid/dirEncryption/DirEncryptionWrapper;
    ...
    iput-boolean v10, p0, mFirstUnlockLockscreen:Z
    ...
    invoke-virtual {p0, v10}, setNeedToCreateKey(Z)V
...
.method private doWorkForUSBState(Ljava/lang/String;)V
    ...
    iget-boolean v7, p0, mSelfSDMountRequested:Z

    if-nez v7, :cond_32

    iget-object v7, p0, mDew:Landroid/dirEncryption/DirEncryptionWrapper;
    ...
    .line 1029
    :cond_32
    iget-boolean v7, p0, mFirstUnlockLockscreen:Z

    if-ne v7, v3, :cond_3a

    .line 1030
    iput-boolean v6, p0, mFirstUnlockLockscreen:Z

    .line 1031
    iput-boolean v6, p0, mSelfSDMountRequested:Z

    .line 1034
    :cond_3a
    const-string v7, "clearNotification"

    invoke-static {v7}, logD(Ljava/lang/String;)V
    ...
    .line 1086
    iget-boolean v7, p0, mWasEncryptedCard:Z
    ...
    invoke-direct {p0, v10, v6, v7}, showNotification(IILjava/lang/String;)V

    .line 1089
    iput-boolean v6, p0, mWasEncryptedCard:Z

    .line 1090
    invoke-direct {p0, v6}, setStatus(I)V

    .line 1091
    const-string v6, "Mount"

    invoke-direct {p0, v11, v6}, notifyEncryptionStatusChanged(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v11, v7}, notifyEncryptionStatusChanged(ILjava/lang/String;)V
    ...
    .line 1125
    iput-boolean v6, p0, mUnnmountRequested:Z

    .line 1126
    iput-boolean v6, p0, mSelfSDMountRequested:Z

    .line 1127
    iput v6, p0, mLastError:I
    ...
    .line 1152
    :cond_1c3
    iget-boolean v7, p0, mUnnmountRequested:Z
    ...
    invoke-direct {p0, v7, v6, v8}, showNotification(IILjava/lang/String;)V
...
.method private showNotification(IILjava/lang/String;)V
    ...
    monitor-exit v11
    :try_end_204
    .catchall {:try_start_1c9 .. :try_end_204} :catchall_202
    ...
    invoke-virtual {v2}, Lcom/android/server/DirEncryptServiceHelper$AnimatingNotification;->stop()V
    :try_end_210
    .catchall {:try_start_209 .. :try_end_210} :catchall_202
...
.method public doHandleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v0}, doWorkForPassword(Ljava/lang/String;)V
    ...
    .line 487
    invoke-direct {p0, v1}, doWorkForUSBState(Ljava/lang/String;)V
...
.method public onEventInner(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    iget-object v0, v0, mSync:Ljava/lang/Object;
    ...
    invoke-direct {v0, v14}, doWorkForPassword(Ljava/lang/String;)V
    ...
    iput v9, v0, mErrAdditionalSpace:I
    ...
    invoke-direct {v0, v1, v5, v2}, showNotification(IILjava/lang/String;)V
    ...
    invoke-direct {v0, v11, v1}, notifyEncryptionStatusChanged(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2}, notifyEncryptionStatusChanged(ILjava/lang/String;)V
    :try_end_819
    .catchall {:try_start_50 .. :try_end_819} :catchall_43
