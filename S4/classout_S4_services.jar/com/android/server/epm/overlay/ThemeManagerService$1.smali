...
.method constructor <init>(Lcom/android/server/epm/overlay/ThemeManagerService;Landroid/content/Context;Ljava/lang/String;Ljava/util/HashMap;Ljava/lang/String;I)V
    ...
    .prologue
    .line 341
    iput-object p1, p0, this$0:Lcom/android/server/epm/overlay/ThemeManagerService;

    iput-object p2, p0, val$masterContext:Landroid/content/Context;

    iput-object p3, p0, val$packageName:Ljava/lang/String;

    iput-object p4, p0, val$compMap:Ljava/util/HashMap;

    iput-object p5, p0, val$str:Ljava/lang/String;

    iput p6, p0, val$index:I
...
.method public run()V
    ...
    .prologue
    .line 344
    iget-object v0, p0, this$0:Lcom/android/server/epm/overlay/ThemeManagerService;

    iget-object v1, p0, val$masterContext:Landroid/content/Context;

    iget-object v2, p0, val$packageName:Ljava/lang/String;

    iget-object v3, p0, val$compMap:Ljava/util/HashMap;

    iget-object v4, p0, val$str:Ljava/lang/String;
