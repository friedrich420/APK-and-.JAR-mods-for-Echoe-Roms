...
.method static synthetic access$500(Lcom/android/server/AlarmManagerService;I)Landroid/app/AlarmManager$AlarmClockInfo;
    ...
    .prologue
    .line 100
    invoke-direct {p0, p1}, getNextAlarmClockImpl(I)Landroid/app/AlarmManager$AlarmClockInfo;
...
.method private removeDisallowedAlarmList(I)V
    ...
    iget-object v11, p0, mAlarmBatches:Ljava/util/ArrayList;
...
.method private removeLocked(Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {p0, p1, v0}, removeLocked(Landroid/app/PendingIntent;Z)V
...
.method private restoreDisallowedAlarmList()V
    ...
    .line 2802
    invoke-virtual/range {v4 .. v15}, setImpl(IJJJLandroid/app/PendingIntent;ZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;)V
...
.method private sendNextAlarmClockChanged()V
    ...
    invoke-static {v7, v1}, formatNextAlarm(Landroid/content/Context;Landroid/app/AlarmManager$AlarmClockInfo;)Ljava/lang/String;
...
.method private setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
    ...
    iget-object v7, v0, mSyncScheduler:Lcom/android/server/AlarmManagerServiceExt$SyncScheduler;

    if-eqz v7, :cond_165

    sget-boolean v7, APP_SYNC_NewAlarm:Z
    ...
    sput-boolean v7, APP_SYNC_NewAlarm:Z

    .line 943
    sget-boolean v7, APP_SYNC_LOG:Z
    ...
    iget-object v7, v0, mAlarmBatches:Ljava/util/ArrayList;
    ...
    iput-boolean v7, v0, mNextAlarmClockMayChange:Z

    .line 994
    invoke-direct/range {p0 .. p0}, updateNextAlarmClockLocked()V

    .line 1008
    :cond_157
    invoke-virtual/range {p0 .. p0}, rescheduleKernelAlarmsLocked()V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, attemptCoalesceLocked(JJ)I
...
.method deliverAlarmsLocked(Ljava/util/ArrayList;J)V
    ...
    invoke-virtual {v0, v5}, removeImpl(Landroid/app/PendingIntent;)V
...
.method dumpImpl(Ljava/io/PrintWriter;)V
    ...
    monitor-exit v39
    :try_end_163
    .catchall {:try_start_7 .. :try_end_163} :catchall_161
    ...
    monitor-exit v39
    :try_end_5c8
    .catchall {:try_start_164 .. :try_end_5c8} :catchall_161
...
.method public onStart()V
    ...
    iput-wide v4, p0, mNativeData:J

    .line 733
    iput-wide v8, p0, mNextRtcWakeup:J

    iput-wide v8, p0, mNextNonWakeup:J
    ...
    invoke-virtual {p0, v3}, setTimeZoneImpl(Ljava/lang/String;)V
    ...
    iput-object v3, p0, mTimeTickSender:Landroid/app/PendingIntent;
    ...
    iput-object v3, p0, mDateChangeSender:Landroid/app/PendingIntent;
    ...
    iput-object v3, p0, mClockReceiver:Lcom/android/server/AlarmManagerService$ClockReceiver;

    .line 754
    iget-object v3, p0, mClockReceiver:Lcom/android/server/AlarmManagerService$ClockReceiver;
    ...
    iput-object v3, p0, mInteractiveStateReceiver:Lcom/android/server/AlarmManagerService$InteractiveStateReceiver;
    ...
    iput-object v3, p0, mUninstallReceiver:Lcom/android/server/AlarmManagerService$UninstallReceiver;
    ...
    iput-object v3, p0, mQuickBootReceiver:Lcom/android/server/AlarmManagerService$QuickBootReceiver;
    ...
    iput-object v3, p0, mFactoryOnOffControlReceiver:Lcom/android/server/AlarmManagerService$FactoryOnOffControlReceiver;
    ...
    iput-object v3, p0, mSyncScheduler:Lcom/android/server/AlarmManagerServiceExt$SyncScheduler;

    .line 771
    :cond_a7
    iget-wide v4, p0, mNativeData:J
    ...
    invoke-virtual {p0, v3, v4}, publishBinderService(Ljava/lang/String;Landroid/os/IBinder;)V
...
.method rebatchAllAlarmsLocked(Z)V
    ...
    iget-object v6, v0, mAlarmBatches:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v6 .. v23}, setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
...
.method removeLocked(Landroid/app/PendingIntent;Z)V
    ...
    iget-object v2, v0, mAlarmBatches:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v2, v3}, removeSetAlarmFromHistoryLocked(J)V
    ...
    iget-wide v3, v0, mNativeData:J

    iget v5, v10, Lcom/android/server/AlarmManagerService$Alarm;->type:I

    move-object/from16 v2, p0

    invoke-direct/range {v2 .. v9}, clear(JIJJ)V
    ...
    iput-wide v2, v0, mNextRtcWakeup:J
    ...
    .line 1647
    sget-boolean v2, APP_SYNC_ON:Z

    if-eqz v2, :cond_da

    move-object/from16 v0, p0

    iget-object v2, v0, mSyncScheduler:Lcom/android/server/AlarmManagerServiceExt$SyncScheduler;
    ...
    invoke-virtual {v0, v2}, rebatchAllAlarmsLocked(Z)V
...
.method setImpl(IJJJLandroid/app/PendingIntent;ZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    :try_start_110
    sput-boolean v8, APP_SYNC_NewAlarm:Z
    ...
    iput-boolean v8, v0, mRecordClockHistory:Z
    ...
    invoke-direct/range {v8 .. v25}, setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
...
.method triggerAlarmsLocked(Ljava/util/ArrayList;JJ)Z
    ...
    iget v2, v0, mCurrentSeq:I

    add-int/lit8 v2, v2, 0x1

    move-object/from16 v0, p0

    iput v2, v0, mCurrentSeq:I
    ...
    iget-object v2, v0, mAlarmDispatchComparator:Ljava/util/Comparator;
    ...
    iput-boolean v2, v0, mNextAlarmClockMayChange:Z
