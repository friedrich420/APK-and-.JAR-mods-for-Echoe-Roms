...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    .line 158
    iput v1, p0, mNextAppTransitionType:I
...
.method createAspectScaledThumbnailEnterExitAnimationLocked(IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;Z)Landroid/view/animation/Animation;
    ...
    iget v14, v0, mNextAppTransitionStartHeight:I
    ...
    iget v7, v0, mNextAppTransitionStartY:I

    invoke-static {v7, v2}, computePivot(IF)F
    ...
    iget-object v8, v0, mThumbnailFastOutSlowInInterpolator:Landroid/view/animation/Interpolator;
...
.method createThumbnailAspectScaleAnimationLocked(IIII)Landroid/view/animation/Animation;
    ...
    iget-object v3, v0, mThumbnailFastOutSlowInInterpolator:Landroid/view/animation/Interpolator;
    ...
    iget-object v10, v0, mThumbnailFastOutSlowInInterpolator:Landroid/view/animation/Interpolator;
...
.method loadAnimation(Landroid/view/WindowManager$LayoutParams;IZIIILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)Landroid/view/animation/Animation;
    ...
    invoke-virtual {p0, v0, v4}, loadAnimationRes(Landroid/view/WindowManager$LayoutParams;I)Landroid/view/animation/Animation;
    ...
    .line 868
    :cond_46
    iget v4, p0, mNextAppTransitionType:I
    ...
    .line 869
    iget-object v5, p0, mNextAppTransitionPackage:Ljava/lang/String;

    if-eqz p3, :cond_56

    iget v4, p0, mNextAppTransitionEnter:I

    :goto_51
    invoke-direct {p0, v5, v4}, loadAnimationRes(Ljava/lang/String;I)Landroid/view/animation/Animation;
    ...
    .end local v13    # "a":Landroid/view/animation/Animation;
    :cond_56
    iget v4, p0, mNextAppTransitionExit:I
    ...
    invoke-virtual {p0, v0, v1}, checkCocktailAppTransition(IZ)Z
    ...
    invoke-direct {p0, v0, v1, v2}, createTransAnimationLocked(ZII)Landroid/view/animation/Animation;
    ...
    invoke-direct {p0, v0, v1, v2, v3}, createScaleUpAnimationLocked(IZII)Landroid/view/animation/Animation;
    ...
    :cond_8a
    iget-boolean v4, p0, mEasyOneHandRunning:Z
    ...
    :goto_94
    iput-boolean v4, p0, mNextAppTransitionScaleUp:Z

    .line 893
    move/from16 v0, p3

    invoke-virtual {p0, v0}, getThumbnailTransitionState(Z)I
    ...
    invoke-virtual {p0, v4, v0, v1, v2}, createThumbnailEnterExitAnimationLocked(IIII)Landroid/view/animation/Animation;
    ...
    invoke-virtual/range {v4 .. v12}, createAspectScaledThumbnailEnterExitAnimationLocked(IIIIILandroid/graphics/Rect;Landroid/graphics/Rect;Z)Landroid/view/animation/Animation;
    ...
    invoke-virtual {p0, v0, v14}, loadAnimationAttr(Landroid/view/WindowManager$LayoutParams;I)Landroid/view/animation/Animation;
...
.method overridePendingAppTransitionAspectScaledThumb(Landroid/graphics/Bitmap;IIIILandroid/os/IRemoteCallback;Z)V
    ...
    .line 1076
    iput-boolean p7, p0, mNextAppTransitionScaleUp:Z
...
.method overridePendingAppTransitionThumb(Landroid/graphics/Bitmap;IILandroid/os/IRemoteCallback;Z)V
    ...
    .line 1059
    iput-boolean p5, p0, mNextAppTransitionScaleUp:Z
...
.method postAnimationCallback()V
    ...
    iget-object v3, p0, mNextAppTransitionCallback:Landroid/os/IRemoteCallback;
    ...
    iput-object v0, p0, mNextAppTransitionCallback:Landroid/os/IRemoteCallback;
