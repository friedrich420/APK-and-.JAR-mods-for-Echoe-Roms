...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/TaskStack;Lcom/android/server/wm/DisplayContent;)V
    ...
    iput-object v0, p0, mDimBounds:Landroid/graphics/Rect;
...
.method animateBlackBackground()V
    ...
    .line 1320
    iget-object v7, p0, mBlackSurface:Lcom/android/server/wm/DimLayer;
    ...
    iget-object v8, p0, mDimBounds:Landroid/graphics/Rect;

    invoke-virtual {v7, v8}, Lcom/android/server/wm/DimLayer;->setBounds(Landroid/graphics/Rect;)V

    .line 1324
    iget-object v7, p0, mBaseWindow:Lcom/android/server/wm/WindowState;

    if-nez v7, :cond_1e

    .line 1325
    iget-boolean v6, p0, mShown:Z

    if-eqz v6, :cond_6

    .line 1327
    iget-object v6, p0, mBlackSurface:Lcom/android/server/wm/DimLayer;

    invoke-virtual {v6}, Lcom/android/server/wm/DimLayer;->hide()V

    .line 1328
    iput-boolean v5, p0, mShown:Z
    ...
    .line 1352
    iget-object v5, p0, mBlackSurface:Lcom/android/server/wm/DimLayer;
...
.method notifyVisibleWindow(Lcom/android/server/wm/WindowState;)V
    ...
    iput-object v1, p0, mBaseWindow:Lcom/android/server/wm/WindowState;
    ...
    .line 1282
    :cond_17
    iget-object v1, p0, mBaseWindow:Lcom/android/server/wm/WindowState;
...
.method setBound(Landroid/graphics/Rect;)V
    ...
    .prologue
    .line 1312
    iget-object v0, p0, mDimBounds:Landroid/graphics/Rect;
