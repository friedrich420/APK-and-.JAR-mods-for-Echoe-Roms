...
.method public clearAnimation()V
    ...
    .line 146
    :cond_b
    iget-boolean v0, p0, deferThumbnailDestruction:Z
...
.method public clearDeferredThumbnail()V
    ...
    .line 163
    iget-object v0, p0, deferredThumbnail:Landroid/view/SurfaceControl;
    ...
    .line 166
    iget-object v0, p0, openingAppAnimatorSharingThumbnailSurface:Lcom/android/server/wm/AppWindowAnimator;

    if-eqz v0, :cond_20

    iget-object v0, p0, openingAppAnimatorSharingThumbnailSurface:Lcom/android/server/wm/AppWindowAnimator;

    iget-boolean v0, v0, deferThumbnailDestruction:Z

    if-eqz v0, :cond_20

    iget-object v0, p0, deferredThumbnail:Landroid/view/SurfaceControl;

    iget-object v1, p0, openingAppAnimatorSharingThumbnailSurface:Lcom/android/server/wm/AppWindowAnimator;

    iget-object v1, v1, thumbnail:Landroid/view/SurfaceControl;
    ...
    iput-object v2, v0, thumbnail:Landroid/view/SurfaceControl;

    .line 172
    :cond_20
    iput-object v2, p0, deferredThumbnail:Landroid/view/SurfaceControl;
...
.method stepAnimationLocked(J)Z
    ...
    .line 263
    iget-object v5, p0, animation:Landroid/view/animation/Animation;

    sget-object v6, sDummyAnimation:Landroid/view/animation/Animation;
    ...
    iget-boolean v5, p0, animating:Z
    ...
    .line 285
    :cond_3e
    invoke-static {p1, p2, v4}, notifyAnimationState(JZ)V
    ...
    .line 290
    iget-object v3, p0, thumbnail:Landroid/view/SurfaceControl;
    ...
    iput-object v5, p0, animation:Landroid/view/animation/Animation;

    .line 303
    :cond_59
    iput-boolean v3, p0, hasTransformation:Z
    ...
    .line 313
    iput-boolean v3, p0, animating:Z

    .line 314
    iget v5, p0, animLayerAdjustment:I

    if-eqz v5, :cond_7a

    .line 315
    iput v3, p0, animLayerAdjustment:I
...
.method updateLayers()V
    ...
    .line 178
    .local v0, "N":I
    iget v1, p0, animLayerAdjustment:I

    .line 179
    .local v1, "adj":I
    const/4 v5, -0x1

    iput v5, p0, thumbnailLayer:I
