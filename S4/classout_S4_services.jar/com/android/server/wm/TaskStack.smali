...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;III)V
    ...
    iput-object v0, p0, mTasks:Ljava/util/ArrayList;
    ...
    .line 83
    iput-boolean v4, p0, mFullscreen:Z
    ...
    iput-object v0, p0, mTmpDimBounds:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, mStackFrameBounds:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, mExitingAppTokens:Lcom/android/server/wm/AppTokenList;
    ...
    iput-object v0, p0, mMinimizedRects:Ljava/util/HashMap;
...
.method addTask(Lcom/android/server/wm/Task;Z)V
    ...
    invoke-virtual {p0, p1, p2, v0}, addTask(Lcom/android/server/wm/Task;ZI)V
...
.method addTask(Lcom/android/server/wm/Task;ZI)V
    ...
    .line 355
    iget-boolean v4, p0, mFixedBound:Z

    invoke-virtual {p0, v4, p1}, setWindowFlagFixedBoundInner(ZLcom/android/server/wm/Task;)V
...
.method animateDimLayers()Z
    ...
    .prologue
    .line 498
    invoke-virtual/range {p0 .. p0}, checkFixedBound()Z
    ...
    invoke-virtual {v0, v12}, needUpdateFixedBound(Z)Z
    ...
    invoke-virtual {v0, v12}, setWindowFlagFixedBound(Z)V
    ...
    :cond_75
    invoke-virtual/range {p0 .. p0}, isVisible()Z
    ...
    iget-object v0, v0, mStackFrameBounds:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v1}, hasWindowOutOfStack(I)Z
    ...
    invoke-virtual {v0, v8}, adjustBoundForEasyOneHand(Landroid/graphics/Rect;)Z
    ...
    invoke-direct {v0, v10, v11}, getDimBehindFadeDuration(J)J
...
.method attachDisplayContent(Lcom/android/server/wm/DisplayContent;)V
    ...
    iput-object v0, p0, mDimLayer:Lcom/android/server/wm/DimLayer;
    ...
    iput-object v0, p0, mAnimationBackgroundSurface:Lcom/android/server/wm/DimLayer;
...
.method detachDisplay()V
    ...
    .line 464
    iput-object v8, p0, mAnimationBackgroundSurface:Lcom/android/server/wm/DimLayer;
    ...
    .line 466
    iput-object v8, p0, mDimLayer:Lcom/android/server/wm/DimLayer;
    ...
    .line 471
    iput-object v8, p0, mBlackBackground:Lcom/android/server/wm/TaskStack$BlackBackground;

    .line 475
    :cond_73
    iput-object v8, p0, mDisplayContent:Lcom/android/server/wm/DisplayContent;
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-object v3, p0, mStackFrameBounds:Landroid/graphics/Rect;
...
.method getBounds(Landroid/graphics/Rect;)V
    ...
    .line 218
    invoke-direct {p0, v0}, getMinimizedRect(Lcom/android/server/wm/AppWindowToken;)Landroid/graphics/Rect;
...
.method getStackFrameBounds(Landroid/graphics/Rect;)V
    ...
    .prologue
    .line 1217
    iget-object v0, p0, mStackFrameBounds:Landroid/graphics/Rect;
...
.method hasWindowOutOfStack(I)Z
    ...
    .line 1067
    iget-object v6, p0, mTmpDimBounds:Landroid/graphics/Rect;
    ...
    iget-object v7, p0, mTmpDimBounds:Landroid/graphics/Rect;

    invoke-virtual {v6, v7, p1}, Lcom/android/server/wm/DisplayContent;->getZoneBounds(Landroid/graphics/Rect;I)V

    .line 1069
    iget-object v6, p0, mDimWinAnimator:Lcom/android/server/wm/WindowStateAnimator;
    ...
    iget-object v6, p0, mStackFrameBounds:Landroid/graphics/Rect;
    ...
    iget-object v7, p0, mStackFrameBounds:Landroid/graphics/Rect;
...
.method moveTaskToTop(Lcom/android/server/wm/Task;)V
    ...
    .line 371
    invoke-virtual {p0, p1, v2, v0}, addTask(Lcom/android/server/wm/Task;ZI)V
    ...
    .line 377
    :cond_28
    invoke-virtual {p0, p1, v2}, addTask(Lcom/android/server/wm/Task;Z)V
...
.method removeTask(Lcom/android/server/wm/Task;)V
    ...
    .line 402
    iget-boolean v0, p0, mFixedBound:Z

    if-eqz v0, :cond_8

    .line 403
    invoke-virtual {p0, v1, p1}, setWindowFlagFixedBoundInner(ZLcom/android/server/wm/Task;)V
...
.method setBounds(Landroid/graphics/Rect;)Z
    ...
    iget-object v6, p0, mTmpRect:Landroid/graphics/Rect;
    ...
    .line 180
    invoke-virtual {p0, p1, v3}, checkFixedBound(Landroid/graphics/Rect;Z)Z
    ...
    iget-boolean v5, p0, mFullscreen:Z
    ...
    .line 191
    :cond_46
    invoke-virtual {p0, p1}, setStackFrameBounds(Landroid/graphics/Rect;)V

    .line 194
    if-eqz v1, :cond_58

    .line 195
    invoke-virtual {p0, v4}, setWindowFlagFixedBound(Z)V
    ...
    .line 197
    :cond_58
    invoke-virtual {p0, v3}, setWindowFlagFixedBound(Z)V
