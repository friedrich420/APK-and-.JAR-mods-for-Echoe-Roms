...
.method private enforceCarrierPrivilege()V
    ...
    invoke-direct {p0}, getTelephonyManager()Landroid/telephony/TelephonyManager;
...
.method private getServiceGuarded()Lcom/android/internal/telephony/IMms;
    ...
    .prologue
    .line 179
    invoke-direct {p0}, ensureService()V

    .line 180
    iget-object v0, p0, mService:Lcom/android/internal/telephony/IMms;
