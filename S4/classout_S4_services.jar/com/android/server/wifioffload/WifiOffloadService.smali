...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 87
    iput-object v5, p0, mWifiOffloadDB:Landroid/database/sqlite/SQLiteDatabase;

    .line 88
    iput-object v5, p0, mDBHelper:Lcom/android/server/wifioffload/WifiOffloadDB;

    .line 89
    iput-object v5, p0, mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 98
    iput-boolean v4, p0, mDataUsageLimitCrossed:Z
    ...
    .line 102
    iput-object v5, p0, mPackageName:Ljava/lang/String;

    .line 103
    iput-wide v6, p0, mLatestWifiScanTime:J

    .line 104
    iput-wide v6, p0, mStartTime:J

    .line 105
    iput-boolean v4, p0, isTimerRunning:Z
    ...
    .line 576
    iput-object v5, p0, mDependentPackagesTable:Ljava/util/HashMap;
    ...
    iput-object v2, p0, settingsObserver:Landroid/database/ContentObserver;
    ...
    iget-object v5, p0, settingsObserver:Landroid/database/ContentObserver;
    ...
    .line 149
    invoke-direct {p0}, buildTable()Ljava/util/HashMap;
...
.method static synthetic access$402(Lcom/android/server/wifioffload/WifiOffloadService;Z)Z
    ...
    .prologue
    .line 76
    iput-boolean p1, p0, isTimerRunning:Z
...
.method static synthetic access$502(Lcom/android/server/wifioffload/WifiOffloadService;J)J
    ...
    .prologue
    .line 76
    iput-wide p1, p0, mLatestWifiScanTime:J
...
.method private checkNetworksAndShowAPDialog()V
    ...
    iput-boolean v1, p0, mIsWifiOffloadDialogIntentSent:Z
...
.method private checkWifiOffloadConditions(Ljava/lang/String;)V
    ...
    .line 428
    iput-boolean v8, p0, mIsWifiOffloadDialogIntentSent:Z

    .line 429
    iput v8, p0, mAppLaunchCount:I
    ...
    invoke-direct {p0, v5}, addDumpLogs(Ljava/lang/String;)V

    .line 437
    invoke-direct {p0, p1}, isAppBlackListed(Ljava/lang/String;)Z
    ...
    iget-boolean v6, p0, mIsWifiOffloadDialogIntentSent:Z
    ...
    .line 476
    iget-object v5, p0, mWifiOffloadLog:Ljava/lang/StringBuilder;
    ...
    iget-boolean v7, p0, isTimerRunning:Z
    ...
    iget-boolean v6, p0, mWifiConnectedToAP:Z
    ...
    iget-boolean v6, p0, mMobileHotSpotEnabled:Z
    ...
    iget-boolean v6, p0, mAirPlaneModeEnabled:Z
    ...
    iget-boolean v6, p0, mShowWifiPopupEnabled:Z
    ...
    .line 456
    :cond_178
    iget v5, p0, mAppLaunchCount:I

    add-int/lit8 v5, v5, 0x1

    iput v5, p0, mAppLaunchCount:I

    invoke-direct {p0, p1, v5}, updateAppLaunchCount(Ljava/lang/String;I)V

    goto/16 :goto_fb

    .line 465
    :cond_183
    invoke-direct {p0, p1}, isAppDataUsageLimitExceeded(Ljava/lang/String;)Z
    ...
    iget-boolean v5, p0, mWifiEnabled:Z
...
.method private isAppDataUsageLimitExceeded(Ljava/lang/String;)Z
    ...
    iput-boolean v8, p0, mDataUsageLimitCrossed:Z
    ...
    invoke-direct {p0, v3, p1, v8}, calculateDataUsageforInterface(ILjava/lang/String;Landroid/net/NetworkTemplate;)J
    ...
    .line 265
    iput-boolean v12, p0, mDataUsageLimitCrossed:Z
    ...
    invoke-direct {p0, p1, v8}, updateAppLaunchCount(Ljava/lang/String;I)V
    ...
    iget-boolean v9, p0, mDataUsageLimitCrossed:Z
    ...
    iget-boolean v10, p0, mDataUsageLimitCrossed:Z
    ...
    .line 294
    iget-boolean v8, p0, mDataUsageLimitCrossed:Z
    ...
    invoke-static {v8}, getActiveSubscriberId(Landroid/content/Context;)Ljava/lang/String;
...
.method private isTimerRunning()Z
    ...
    .prologue
    .line 204
    iget-boolean v0, p0, isTimerRunning:Z
    ...
    iput-boolean v0, p0, isTimerRunning:Z
    ...
    iget-boolean v1, p0, isTimerRunning:Z
...
.method public getLatestWifiScanTime()J
    ...
    .prologue
    .line 549
    iget-wide v0, p0, mLatestWifiScanTime:J
