...
.method private isValidApnId(J)Z
    ...
    invoke-virtual {v0, v3}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
    :try_end_8b
    .catch Ljava/lang/Exception; {:try_start_1b .. :try_end_8b} :catch_95
    .catchall {:try_start_1b .. :try_end_8b} :catchall_9f
    ...
    :try_end_99
    .catchall {:try_start_96 .. :try_end_99} :catchall_9f
...
.method public declared-synchronized addUpdateApn(Landroid/app/enterprise/ContextInfo;ZLandroid/app/enterprise/ApnSettings;)J
    ...
    :try_end_4
    .catchall {:try_start_1 .. :try_end_4} :catchall_366
    ...
    invoke-direct {v0, v1}, validateString(Ljava/lang/String;)Ljava/lang/String;
    :try_end_ae
    .catchall {:try_start_11 .. :try_end_ae} :catchall_366
    ...
    invoke-static/range {v34 .. v35}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_19d
    .catch Ljava/lang/Exception; {:try_start_af .. :try_end_19d} :catch_35e
    .catchall {:try_start_af .. :try_end_19d} :catchall_366
    ...
    if-ge v0, v10, :cond_388

    const/16 v35, 0x4

    move/from16 v0, v35

    if-le v0, v10, :cond_388
    ...
    :try_end_359
    .catch Ljava/lang/Exception; {:try_start_19f .. :try_end_359} :catch_3a5
    .catchall {:try_start_19f .. :try_end_359} :catchall_366
    ...
    :try_end_364
    .catchall {:try_start_361 .. :try_end_364} :catchall_366
    ...
    if-ge v0, v10, :cond_2fe

    const/16 v34, 0x4

    move/from16 v0, v34

    if-le v0, v10, :cond_2fe
    ...
    invoke-virtual/range {v33 .. v35}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
    :try_end_3a3
    .catch Ljava/lang/Exception; {:try_start_369 .. :try_end_3a3} :catch_3a5
    .catchall {:try_start_369 .. :try_end_3a3} :catchall_366
    ...
    invoke-virtual {v14}, Ljava/lang/Exception;->printStackTrace()V
    :try_end_3a9
    .catchall {:try_start_3a6 .. :try_end_3a9} :catchall_366
    ...
    invoke-static/range {v34 .. v35}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3ee
    .catch Ljava/lang/Exception; {:try_start_3ad .. :try_end_3ee} :catch_3a5
    .catchall {:try_start_3ad .. :try_end_3ee} :catchall_366
