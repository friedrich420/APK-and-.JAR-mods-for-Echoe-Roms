...
.method private _disableKioskMode(Landroid/app/enterprise/ContextInfo;I)V
    ...
    .prologue
    .line 633
    sget-object v16, mLock:Ljava/lang/Object;
    ...
    invoke-direct {v0, v7, v6, v14}, setDefaultHomeScreen(ILjava/lang/String;Ljava/lang/String;)Z
...
.method private _enableKioskMode(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)V
    ...
    .prologue
    .line 527
    sget-object v18, mLock:Ljava/lang/Object;
    ...
    :try_start_5
    sput-boolean v17, mProcessing:Z
    ...
    invoke-direct {v0, v4, v1, v11}, broadcastKioskResult(III)V
    ...
    invoke-direct {v0, v1, v5, v2}, setDefaultHomeScreen(ILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v4, v1, v2, v5}, updateDB(IZLjava/lang/String;Ljava/lang/String;)V
...
.method private evaluateAirModeConfigurationsAsUser(I)V
    ...
    .line 1965
    invoke-direct {p0, p1}, resetAirCommandConfigurationAsUser(I)V
...
.method private resetAirCommandConfigurationAsUser(I)V
    ...
    invoke-direct {p0, p1, v0}, setAirCommandOn(IZ)V
    ...
    invoke-direct {p0, p1, v0}, setPenDetachmentOption(ILcom/android/server/enterprise/kioskmode/KioskModeService$PenDetachmentOption;)V
...
.method public allowAirCommandMode(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    .line 1926
    invoke-direct {p0, v0}, resetAirCommandConfigurationAsUser(I)V
...
.method public allowHardwareKeys(Landroid/app/enterprise/ContextInfo;[IZ)[I
    ...
    invoke-direct {p0, v0, v8}, addToBlocked(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, v0, v8}, removeFromBlocked(ILjava/lang/String;)Z
    ...
    :cond_6e
    iget-object v8, p0, mCache:Lcom/android/server/enterprise/kioskmode/KioskModeService$KioskModeCache;
...
.method public allowMultiWindowMode(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    .line 1810
    :cond_10
    invoke-virtual {p0, p1, v3}, isMultiWindowModeAllowed(Landroid/app/enterprise/ContextInfo;Z)Z
...
.method public disableKioskMode(Landroid/app/enterprise/ContextInfo;)V
    ...
    invoke-direct {p0, v2, v4, v3}, broadcastKioskResult(III)V
    ...
    .line 387
    :cond_18
    iget-object v2, p0, mHandler:Lcom/android/server/enterprise/kioskmode/KioskModeService$KioskHandler;
...
.method public onPreAdminRemoval(I)V
    ...
    invoke-direct {p0, v0}, getActiveKioskAdmin(I)I
    ...
    .line 315
    invoke-direct {p0, v0}, forceTerminateKiosk(I)V
