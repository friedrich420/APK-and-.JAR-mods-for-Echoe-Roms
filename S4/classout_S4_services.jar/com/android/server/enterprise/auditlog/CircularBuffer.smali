...
.method static synthetic access$122(Lcom/android/server/enterprise/auditlog/CircularBuffer;J)J
    ...
    .prologue
    .line 60
    iget-wide v0, p0, mCircularBufferSize:J

    sub-long/2addr v0, p1

    iput-wide v0, p0, mCircularBufferSize:J
...
.method static synthetic access$208(Lcom/android/server/enterprise/auditlog/CircularBuffer;)I
    ...
    .prologue
    .line 60
    iget v0, p0, mNumberOfDeprecatedFiles:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mNumberOfDeprecatedFiles:I
...
.method static synthetic access$300(Lcom/android/server/enterprise/auditlog/CircularBuffer;I)V
    ...
    .prologue
    .line 60
    invoke-direct {p0, p1}, setNumberOfDeprecatedFiles(I)V
...
.method private checkCriticalSizes()V
    ...
    iget v5, p0, mAdminCriticalSize:F
    ...
    .line 513
    iget-boolean v4, p0, mCriticalIntent:Z
    ...
    iget v5, p0, mAdminMaximumSize:F
    ...
    .line 528
    iget-boolean v4, p0, mMaximumIntent:Z
    ...
    .line 543
    iget-boolean v4, p0, mFullIntent:Z
    ...
    .line 523
    :cond_a3
    iput-boolean v8, p0, mCriticalIntent:Z

    goto :goto_3b

    .line 538
    :cond_a6
    iput-boolean v8, p0, mMaximumIntent:Z

    goto :goto_69

    .line 554
    :cond_a9
    iput-boolean v8, p0, mFullIntent:Z
...
.method private cleanBuffer()V
    ...
    invoke-direct {p0, v6, v7}, resizeBubbleFile(J)V
...
.method private dirListByAscendingDate(Ljava/io/File;)[Ljava/io/File;
    ...
    invoke-direct {v0, v1, v2}, resizeBubbleFile(J)V
...
.method public deleteAllFiles()V
    ...
    .line 430
    iget-object v4, p0, mCurrentNode:Lcom/android/server/enterprise/auditlog/PartialFileNode;
...
.method public write(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2, v3}, resizeBubbleFile(J)V
    ...
    invoke-direct {p0, v4, v5}, resizeBubbleFile(J)V
