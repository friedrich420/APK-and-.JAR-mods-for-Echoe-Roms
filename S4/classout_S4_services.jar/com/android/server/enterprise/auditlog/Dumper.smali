...
.method public constructor <init>(JJLandroid/os/ParcelFileDescriptor;Ljava/util/ArrayList;Lcom/android/server/enterprise/auditlog/IObserver;)V
    ...
    .line 69
    iput-object v1, p0, mHeader:Ljava/lang/StringBuilder;

    .line 70
    iput-object v1, p0, mTemporaryDirectory:Ljava/io/File;
    ...
    .line 80
    iput-object v1, p0, mFilter:Lcom/android/server/enterprise/auditlog/Filter;
...
.method private fullDump()V
    ...
    iget-object v0, v0, mZos:Ljava/util/zip/GZIPOutputStream;
    ...
    sget-object v24, mTemporaryPath:Ljava/lang/String;
...
.method public run()V
    ...
    iput-object v3, p0, mZos:Ljava/util/zip/GZIPOutputStream;
    ...
    .line 106
    iget-object v3, p0, mFilter:Lcom/android/server/enterprise/auditlog/Filter;
    ...
    iput-boolean v3, p0, mIsFullDump:Z
    :try_end_33
    ...
    :cond_33
    :goto_33
    iget-object v3, p0, mObserver:Lcom/android/server/enterprise/auditlog/IObserver;

    iget-boolean v4, p0, mDumpResult:Z

    iget-boolean v5, p0, mIsFullDump:Z

    invoke-interface {v3, v4, v5}, Lcom/android/server/enterprise/auditlog/IObserver;->notifyDumpFinished(ZZ)V

    .line 120
    :try_start_3c
    iget-object v3, p0, mZos:Ljava/util/zip/GZIPOutputStream;
    ...
    iput-boolean v3, p0, mDumpResult:Z
    ...
    :goto_f1
    iget-object v4, p0, mObserver:Lcom/android/server/enterprise/auditlog/IObserver;

    iget-boolean v5, p0, mDumpResult:Z

    iget-boolean v6, p0, mIsFullDump:Z

    invoke-interface {v4, v5, v6}, Lcom/android/server/enterprise/auditlog/IObserver;->notifyDumpFinished(ZZ)V

    .line 120
    :try_start_fa
    iget-object v4, p0, mZos:Ljava/util/zip/GZIPOutputStream;
