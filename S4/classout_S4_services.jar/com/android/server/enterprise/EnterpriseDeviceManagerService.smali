...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/IPackageManager;Landroid/app/admin/IDevicePolicyManager;)V
    ...
    iput-object v7, p0, mFirstInitializedPolicyServices:Ljava/util/List;
    ...
    iput-object v7, p0, mAdminMap:Ljava/util/HashMap;
    ...
    iput-object v7, p0, mAdminList:Ljava/util/ArrayList;

    .line 312
    iput v11, p0, KNOXVPN_FEATURE:I
    ...
    iput v7, p0, KNOXVPN_CONTAINER_ENABLED:I
    ...
    iput-object v7, p0, mReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v7, p0, mLMS:Lcom/android/server/enterprise/log/LogManagerService;

    .line 1728
    const-string v7, "log_manager_service"

    iget-object v8, p0, mLMS:Lcom/android/server/enterprise/log/LogManagerService;

    invoke-static {v7, v8}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V

    .line 1729
    iput-object p2, p0, mPMS:Landroid/content/pm/IPackageManager;
    ...
    iput-object v7, p0, mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    iput-object v7, p0, mDPMS:Landroid/app/admin/IDevicePolicyManager;
    ...
    iput-object v7, p0, mMonitor:Lcom/android/server/enterprise/EnterpriseDeviceManagerService$MyPackageMonitor;

    .line 1734
    iget-object v7, p0, mMonitor:Lcom/android/server/enterprise/EnterpriseDeviceManagerService$MyPackageMonitor;
    ...
    sput-object v7, mPackageManagerAdapter:Lcom/android/server/enterprise/adapterlayer/PackageManagerAdapter;
    ...
    iget-object v8, p0, mReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v7, p0, mEdmStorageProvider:Lcom/android/server/enterprise/storage/EdmStorageProvider;
    ...
    iget-object v8, p0, mPMS:Landroid/content/pm/IPackageManager;
    ...
    .line 1754
    sget-object v7, mPolicyServices:Ljava/util/Map;
    ...
    .line 1755
    iget-object v7, p0, mFirstInitializedPolicyServices:Ljava/util/List;
    ...
    invoke-static {v7}, getPolicyService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    sput-object v7, mConstrainedState:Lcom/android/server/enterprise/utils/ConstrainedState;

    .line 1826
    invoke-direct {p0}, isMdmAdminPresent()Z

    move-result v7

    if-nez v7, :cond_20a

    sget-object v7, mConstrainedState:Lcom/android/server/enterprise/utils/ConstrainedState;
...
.method private activateAdmin(Landroid/content/ComponentName;Z)V
    ...
    invoke-direct {v0, v1, v12}, findAdmin(Landroid/content/ComponentName;I)Landroid/app/enterprise/EnterpriseDeviceAdminInfo;
    ...
    invoke-static {v13}, getPolicyService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget-object v13, EXCLUDED_ADMINS:Ljava/util/List;
    ...
    invoke-direct {v0, v3, v13}, getActiveAdminLocked(Landroid/content/ComponentName;I)Landroid/app/enterprise/EnterpriseDeviceAdminInfo;
    ...
    :goto_c4
    sget-object v13, mInternalHandler:Landroid/os/Handler;
    ...
    iget-object v13, v0, mAdminMap:Ljava/util/HashMap;
    ...
    iget-object v13, v0, mAdminList:Ljava/util/ArrayList;
    ...
    :cond_156
    :try_start_156
    sget-object v13, mPolicyServices:Ljava/util/Map;
    ...
    iget-object v13, v0, mDPMS:Landroid/app/admin/IDevicePolicyManager;
...
.method private addServices()V
    ...
    sput-boolean v13, mServicesAdded:Z
...
.method private compareSystemSignature([Landroid/content/pm/Signature;)Z
    ...
    .prologue
    .line 1650
    iget-object v7, p0, mPMS:Landroid/content/pm/IPackageManager;
...
.method private enforceActiveAdminPermissionByContext(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;ZZ)Landroid/app/enterprise/ContextInfo;
    ...
    invoke-static {v7, p1}, isManagedProfileUser(Landroid/content/Context;Landroid/app/enterprise/ContextInfo;)Z
    ...
    invoke-static {v7, v8}, getProxyAdminOwnerUid(Lcom/android/server/enterprise/storage/EdmStorageProvider;I)I
...
.method private enforceUMCSignature()V
    ...
    invoke-direct {p0, v3}, compareSystemSignature([Landroid/content/pm/Signature;)Z
...
.method private removeActiveAdminDelayed(Landroid/content/ComponentName;I)V
    ...
    :cond_98
    :try_start_98
    sget-object v14, mConstrainedState:Lcom/android/server/enterprise/utils/ConstrainedState;
    ...
    iget-object v14, v0, mAdminList:Ljava/util/ArrayList;
    ...
    iget-object v14, v0, mAdminMap:Ljava/util/HashMap;
    ...
    invoke-direct {v0, v1, v13}, deactivateProxyAdminsForOwnerAdmin(Landroid/content/ComponentName;I)V
...
.method private selfUpdate()V
    ...
    monitor-enter p0
    :try_end_4
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_4} :catch_33
    ...
    :try_end_76
    .catchall {:try_start_3f .. :try_end_76} :catchall_30
    ...
    monitor-exit p0
    :try_end_8f
    .catchall {:try_start_76 .. :try_end_8f} :catchall_107
    ...
    :try_end_97
    .catch Ljava/lang/IllegalArgumentException; {:try_start_92 .. :try_end_97} :catch_103
    .catch Ljava/lang/IllegalStateException; {:try_start_92 .. :try_end_97} :catch_105
    ...
    monitor-enter v2
    :try_end_a3
    .catch Ljava/lang/Exception; {:try_start_97 .. :try_end_a3} :catch_b4
    ...
    :try_end_af
    .catch Ljava/lang/InterruptedException; {:try_start_a3 .. :try_end_af} :catch_b8
    ...
    monitor-exit v2
    :try_end_b3
    .catchall {:try_start_af .. :try_end_b3} :catchall_b1
    ...
    :try_end_100
    .catch Ljava/lang/Exception; {:try_start_bd .. :try_end_100} :catch_b4
...
.method public activateAdminForUser(Landroid/content/ComponentName;ZI)V
    ...
    invoke-direct {v0, v5, v13}, getActiveAdminLocked(Landroid/content/ComponentName;I)Landroid/app/enterprise/EnterpriseDeviceAdminInfo;
...
.method public declared-synchronized selfUpdateAdmin(Ljava/lang/String;)I
    ...
    invoke-direct {v0, v1}, compareSystemSignature([Landroid/content/pm/Signature;)Z
