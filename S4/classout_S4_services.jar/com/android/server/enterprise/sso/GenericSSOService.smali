...
.method private vendorPermissionCheck(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, v3, v7}, getAttributeNode(Lorg/w3c/dom/Node;Ljava/lang/String;)Lorg/w3c/dom/Node;
...
.method public addWhiteListPackages(Landroid/app/enterprise/ContextInfo;Ljava/util/List;)I
    ...
    invoke-direct {v0, v1, v13}, isCallingMDMMatch(II)Z
    ...
    invoke-direct {v0, v1}, getWhitelistAppNode(Lorg/w3c/dom/Node;)Ljava/util/ArrayList;
...
.method public deleteWhiteListPackages(Landroid/app/enterprise/ContextInfo;Ljava/util/List;)I
    ...
    .line 2482
    .local v7, "userId":I
    invoke-direct {p0, v7, v4}, isCallingMDMMatch(II)Z
    ...
    invoke-direct {p0, v0, v9, v5}, findNodeByAttribute(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)Lorg/w3c/dom/Node;
    ...
    :cond_c9
    :try_start_c9
    invoke-direct {p0, v7, v1}, updateCacheAndFile(ILcom/android/server/enterprise/sso/GenericSSOService$RequestConfigDocument;)V
    :try_end_cc
...
.method public getEnrolledSSOVendor(Landroid/app/enterprise/ContextInfo;)Ljava/lang/String;
    ...
    .line 1922
    .local v1, "userId":I
    invoke-direct {p0, v1}, getSSOConfigForUserId(I)Lcom/android/server/enterprise/sso/GenericSSOService$RequestConfigDocument;
...
.method public getToken(Landroid/app/enterprise/ContextInfo;ZLandroid/app/enterprise/sso/IGenericSSOCallback;)V
    ...
    invoke-direct {p0, v7, v6, v1}, callingAppIsPermitted(ILjava/lang/String;Landroid/os/Bundle;)Z
...
.method public getUserInfo(Landroid/app/enterprise/ContextInfo;Landroid/app/enterprise/sso/IGenericSSOCallback;)V
    ...
    invoke-direct {p0, v5, v4, v0}, callingAppIsPermitted(ILjava/lang/String;Landroid/os/Bundle;)Z
...
.method public onAdminRemoved(I)V
    ...
    const-string v11, "onAdminRemoved: Admin removed"
    ...
    .line 4420
    sget-object v9, mKeystore:Ljava/security/KeyStore;
    ...
    :try_end_e0
    .catch Ljava/lang/SecurityException; {:try_start_20 .. :try_end_e0} :catch_e2
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_20 .. :try_end_e0} :catch_11f
    .catch Ljava/security/KeyStoreException; {:try_start_20 .. :try_end_e0} :catch_129
    .catch Ljava/io/IOException; {:try_start_20 .. :try_end_e0} :catch_133
    .catch Ljava/lang/Exception; {:try_start_20 .. :try_end_e0} :catch_13d
    ...
    invoke-static {v9, v10}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_11e
    .catch Ljava/lang/SecurityException; {:try_start_ec .. :try_end_11e} :catch_e2
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_ec .. :try_end_11e} :catch_11f
    .catch Ljava/security/KeyStoreException; {:try_start_ec .. :try_end_11e} :catch_129
    .catch Ljava/io/IOException; {:try_start_ec .. :try_end_11e} :catch_133
    .catch Ljava/lang/Exception; {:try_start_ec .. :try_end_11e} :catch_13d
...
.method public processWebServiceRequest(Landroid/app/enterprise/ContextInfo;Landroid/app/enterprise/sso/WebServiceRequest;)Landroid/app/enterprise/sso/WebServiceResponse;
    ...
    .line 3900
    .local v4, "configData":Landroid/os/Bundle;
    invoke-direct {p0, v9, v8, v4}, callingAppIsPermitted(ILjava/lang/String;Landroid/os/Bundle;)Z
...
.method public setCustomerBrandInfo(Landroid/app/enterprise/ContextInfo;Landroid/os/Bundle;)I
    ...
    invoke-direct {v0, v12, v8}, isCallingMDMMatch(II)Z
    ...
    invoke-direct {v0, v12}, getSSOConfigForUserId(I)Lcom/android/server/enterprise/sso/GenericSSOService$RequestConfigDocument;
    ...
    invoke-direct {v0, v10, v14}, existedNode(Lorg/w3c/dom/Node;Ljava/lang/String;)Lorg/w3c/dom/Node;
    ...
    invoke-direct {v0, v2, v7}, existedNode(Lorg/w3c/dom/Node;Ljava/lang/String;)Lorg/w3c/dom/Node;
    ...
    invoke-direct {v0, v12, v3}, updateCacheAndFile(ILcom/android/server/enterprise/sso/GenericSSOService$RequestConfigDocument;)V
    :try_end_119
...
.method public unenrollSSOVendor(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)I
    ...
    .line 2156
    .local v5, "userId":I
    invoke-direct {p0, v5, v3}, isCallingMDMMatch(II)Z
    ...
    :cond_3f
    :try_start_3f
    invoke-direct {p0, v5}, getSSOConfigForUserId(I)Lcom/android/server/enterprise/sso/GenericSSOService$RequestConfigDocument;
    ...
    .line 2179
    :cond_77
    invoke-direct {p0, v5}, clearConfigAndTokenForAuthenticator(I)I
    ...
    .line 2187
    :cond_8b
    invoke-direct {p0, v5}, cleanUpSSOConnections(I)V

    .line 2188
    invoke-direct {p0, p2, v5}, stopAuthenticatorApplication(Ljava/lang/String;I)V
