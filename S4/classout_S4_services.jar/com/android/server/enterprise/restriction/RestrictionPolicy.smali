...
.method static constructor <clinit>()V
    ...
    sput-object v0, DEVELOPER_GLOBAL_SETTINGS_DEFAULT:Ljava/util/Map;
    ...
    sput-object v0, DEVELOPER_SECURE_SETTINGS_DEFAULT:Ljava/util/Map;
    ...
    sput-object v0, DEVELOPER_SYSTEM_SETTINGS_DEFAULT:Ljava/util/Map;
    ...
    sput-object v0, DEVELOPER_SYSTEM_PROPERTIES_DEFAULT:Ljava/util/Map;
...
.method private extractFromRestrictionCache(JZI)Z
    ...
    .line 926
    :try_start_a
    iget-object v2, p0, mRestrictionCache:Ljava/util/HashMap;
    ...
    iget-object v3, p0, mRestrictionCacheLock:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
...
.method private resetDisableOverlaysOption()V
    ...
    .line 4037
    invoke-direct {p0}, updateFlingerOptions()V
    :try_end_22
...
.method private resetGlobalDeveloperSettings()Z
    ...
    .line 3985
    .local v2, "ret":Z
    sget-object v3, DEVELOPER_GLOBAL_SETTINGS_DEFAULT:Ljava/util/Map;
...
.method private static resetPermissionEnforced(Ljava/lang/String;)V
    ...
    invoke-static {p0, v1}, setPermissionEnforced(Ljava/lang/String;Z)V
    ...
    invoke-static {p0, v2}, setPermissionEnforced(Ljava/lang/String;Z)V
...
.method private resetSecureDeveloperSettings()Z
    ...
    .line 3997
    .local v2, "ret":Z
    sget-object v3, DEVELOPER_SECURE_SETTINGS_DEFAULT:Ljava/util/Map;
...
.method private resetShowUpdatesOption()V
    ...
    invoke-direct {p0}, isShowingScreenUpdate()Z
...
.method private resetSystemDeveloperSettings()Z
    ...
    .line 4009
    .local v2, "ret":Z
    sget-object v3, DEVELOPER_SYSTEM_SETTINGS_DEFAULT:Ljava/util/Map;
...
.method private resetSystemPropertiesDeveloperSettings()V
    ...
    .prologue
    .line 4020
    sget-object v2, DEVELOPER_SYSTEM_PROPERTIES_DEFAULT:Ljava/util/Map;
...
.method public allowDeveloperMode(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    .line 3939
    iput-boolean v4, p0, mDontPokeProperties:Z

    .line 3942
    invoke-direct {p0}, resetShowUpdatesOption()V

    .line 3945
    invoke-direct {p0}, resetDisableOverlaysOption()V

    .line 3947
    invoke-direct {p0}, resetGlobalDeveloperSettings()Z
    ...
    .line 3948
    invoke-direct {p0}, resetSecureDeveloperSettings()Z
    ...
    .line 3949
    invoke-direct {p0}, resetSystemDeveloperSettings()Z
    ...
    .line 3950
    invoke-direct {p0}, resetSystemPropertiesDeveloperSettings()V

    .line 3953
    invoke-static {}, resetDebuggerOptions()V

    .line 3956
    const-string v0, "android.permission.READ_EXTERNAL_STORAGE"

    invoke-static {v0}, resetPermissionEnforced(Ljava/lang/String;)V

    .line 3959
    invoke-direct {p0}, resetAnimationScaleOption()V

    .line 3962
    invoke-direct {p0}, resetImmediatelyDestroyActivitiesOptions()V

    .line 3965
    invoke-direct {p0}, resetAppProcessLimitOptions()V

    .line 3968
    invoke-direct {p0}, resetCpuUsageOptions()Z
    ...
    .line 3971
    invoke-direct {p0}, resetStrictModeVisualOptions()V

    .line 3973
    iput-boolean v5, p0, mDontPokeProperties:Z

    .line 3974
    invoke-virtual {p0}, pokeSystemProperties()V
...
.method public enableODETrustedBootVerification(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-virtual {v6, v0}, Landroid/app/admin/DevicePolicyManager;->isSupportTrustZoneForODE(Landroid/content/ComponentName;)Z
...
.method public isClipboardAllowedAsUser(ZI)Z
    ...
    invoke-direct {p0, v8, v9, v10, p2}, extractFromRestrictionCache(JZI)Z
...
.method public isSVoiceAllowedAsUser(ZI)Z
    ...
    invoke-direct {p0, v4, v5, v1, p2}, extractFromRestrictionCache(JZI)Z
...
.method public onAdminRemoved(I)V
    ...
    invoke-virtual {p0, v4, v2}, isScreenCaptureEnabled(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    iget-boolean v1, p0, preAdminRemoval_SDCardWrite:Z
...
.method pokeSystemProperties()V
    ...
    .prologue
    .line 4055
    iget-boolean v0, p0, mDontPokeProperties:Z
...
.method public setCCMode(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    .line 4603
    invoke-virtual {p0, p1, v4}, isCCModeEnabled(Landroid/app/enterprise/ContextInfo;Z)Z
...
.method public setMicrophoneState(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    .line 821
    .local v5, "userId":I
    invoke-virtual {p0, p1, v0}, isMicrophoneEnabled(Landroid/app/enterprise/ContextInfo;Z)Z
...
.method public setScreenCapture(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-direct {p0, v10, v0}, isScreenCaptureEnabled(IZ)Z
    ...
    :goto_89
    invoke-direct {p0, v10, v0}, updateScreenCaptureDisabledInWindowManager(IZ)V
    :try_end_8c
...
.method public setUsbTethering(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-direct {v0, v2, v10}, matchRegex([Ljava/lang/String;Ljava/lang/String;)Z
...
.method public systemReady()V
    ...
    invoke-direct {p0, v7}, loadRestrictionCache(I)V
    ...
    iput-boolean v7, p0, mIsUsbMassStorageAvailable:Z
