...
.method private findCertificateOrIssuer(Ljava/security/cert/X509Certificate;)Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {p0, v6}, generateAlias(Ljavax/security/auth/x500/X500Principal;)Ljava/lang/String;
    ...
    invoke-static {v4, p1}, areEqual(Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-direct {p0, v4, p1}, matchPublicKey(Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-direct {p0, v3, p1}, matchPublicKey(Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;)Z

    move-result v6

    if-nez v6, :cond_61

    invoke-static {v3, p1}, areEqual(Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;)Z
    :try_end_5e
...
.method static declared-synchronized getInstance(I)Lcom/android/server/enterprise/certificate/EdmKeyStore;
    ...
    invoke-direct {v1, v3}, <init>(Ljava/lang/String;)V
...
.method containsCertificateOrChain(Ljava/security/cert/X509Certificate;)Z
    ...
    .line 331
    :cond_16
    invoke-direct {p0, p1}, findCertificateOrIssuer(Ljava/security/cert/X509Certificate;)Ljava/security/cert/X509Certificate;
    ...
    invoke-static {p1}, isSelfSigned(Ljava/security/cert/X509Certificate;)Z
    ...
    .line 342
    invoke-virtual {p0, v0}, containsCertificateOrChain(Ljava/security/cert/X509Certificate;)Z
...
.method installCertificates(Ljava/util/List;)Ljava/util/List;
    ...
    .line 196
    .local v1, "cert":Ljava/security/cert/X509Certificate;
    invoke-virtual {p0, v1}, generateAlias(Ljava/security/cert/X509Certificate;)Ljava/lang/String;
