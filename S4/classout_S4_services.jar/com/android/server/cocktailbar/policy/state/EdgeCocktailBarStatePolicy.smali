...
.method public constructor <init>(Lcom/android/server/cocktailbar/policy/state/CocktailBarStatePolicy$OnCocktailBarStateListener;)V
    ...
    iput-object v0, p0, mBackupStateInfo:Lcom/samsung/android/cocktailbar/CocktailBarStateInfo;
...
.method private beginCheckStateInfo()V
    ...
    .line 360
    iget-object v0, p0, mBackupStateInfo:Lcom/samsung/android/cocktailbar/CocktailBarStateInfo;
...
.method private getChangeFlagOfStateInfo(Lcom/samsung/android/cocktailbar/CocktailBarStateInfo;)I
    ...
    invoke-direct {p0, p1, v0}, compareStateInfo(Lcom/samsung/android/cocktailbar/CocktailBarStateInfo;Lcom/samsung/android/cocktailbar/CocktailBarStateInfo;)I
...
.method private updateCocktailBarVisibility(I)Z
    ...
    :cond_10
    :try_start_10
    invoke-virtual {p0, p1}, changeCocktailBarVisibility(I)V
    :try_end_13
...
.method public handleUpdateState(ZZ)V
    ...
    .line 127
    invoke-direct {p0}, beginCheckStateInfo()V
    ...
    .line 132
    invoke-virtual {p0, v7, v5}, setLockState(IZ)V

    .line 133
    iget v2, p0, mWindowType:I

    invoke-direct {p0, v2, v5, v8}, canUpdateVisibility(III)Z
    ...
    .line 135
    invoke-direct {p0, v5}, updateCocktailBarVisibility(I)Z
    ...
    .line 147
    invoke-direct {p0, v1}, getChangeFlagOfStateInfo(Lcom/samsung/android/cocktailbar/CocktailBarStateInfo;)I
    ...
    .line 149
    iget-object v2, p0, mListener:Lcom/android/server/cocktailbar/policy/state/CocktailBarStatePolicy$OnCocktailBarStateListener;
    ...
    .line 151
    :cond_62
    invoke-direct {p0}, finishCheckStateInfo()V
    ...
    invoke-virtual {p0, v7, v2}, setLockState(IZ)V

    .line 139
    iget v2, p0, mWindowType:I

    invoke-direct {p0, v2, v6, v8}, canUpdateVisibility(III)Z
    ...
    .line 141
    invoke-direct {p0, v6}, updateCocktailBarVisibility(I)Z
...
.method public handleUpdateStateFromSystem(I)V
    ...
    .line 94
    invoke-virtual {p0, v8, v9}, setLockState(IZ)V
    ...
    .line 96
    invoke-direct {p0, p1, v6, v7}, canUpdateVisibility(III)Z
    ...
    .line 75
    invoke-virtual {p0, v8, v5}, setLockState(IZ)V
    ...
    .line 77
    invoke-direct {p0, p1, v5, v7}, canUpdateVisibility(III)Z
    ...
    invoke-virtual {p0, v2}, refreshHideTimer(I)Z
    ...
    .line 99
    :cond_bb
    invoke-direct {p0, p1, v5, v7}, needToUpdateVisibility(III)Z
...
.method public handleUpdateVisibility(I)V
    ...
    .line 44
    invoke-virtual {p0, v6}, refreshHideTimer(I)Z
    ...
    .line 45
    invoke-virtual {p0, v6}, startHideTimer(I)V
    ...
    invoke-direct {p0, v3, p1, v4}, canUpdateVisibility(III)Z
    ...
    .line 52
    invoke-direct {p0, p1}, updateCocktailBarVisibility(I)Z
    ...
    .line 57
    iget-object v3, p0, mListener:Lcom/android/server/cocktailbar/policy/state/CocktailBarStatePolicy$OnCocktailBarStateListener;
