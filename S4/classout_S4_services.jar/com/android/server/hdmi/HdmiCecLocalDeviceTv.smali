...
.method constructor <init>(Lcom/android/server/hdmi/HdmiControlService;)V
    ...
    .line 74
    iput-boolean v2, p0, mArcFeatureEnabled:Z
...
.method private canStartArcUpdateAction(IZ)Z
    ...
    .line 940
    invoke-virtual {p0}, isArcFeatureEnabled()Z
...
.method private disableArcIfExist()V
    ...
    invoke-virtual {p0}, isArcEstabilished()Z
...
.method private disableSystemAudioIfExist()V
    ...
    .line 1440
    invoke-virtual {p0, v1, v1}, setSystemAudioMode(ZZ)V
...
.method private sendClearTimerMessage(II[B)V
    ...
    invoke-virtual {p0, v1}, announceClearTimerRecordingResult(I)V
...
.method final addCecDevice(Landroid/hardware/hdmi/HdmiDeviceInfo;)V
    ...
    invoke-direct {p0, p1, v0}, invokeDeviceEventListener(Landroid/hardware/hdmi/HdmiDeviceInfo;I)V
...
.method changeArcFeatureEnabled(Z)V
    ...
    .line 793
    iget-boolean v0, p0, mArcFeatureEnabled:Z

    if-eq v0, p1, :cond_13

    .line 794
    iput-boolean p1, p0, mArcFeatureEnabled:Z
...
.method clearTimerRecording(II[B)V
    ...
    invoke-virtual {p0, v0}, announceClearTimerRecordingResult(I)V
...
.method doManualPortSwitching(ILandroid/hardware/hdmi/IHdmiControlCallback;)V
    ...
    .line 306
    invoke-static {p2, v5}, invokeCallback(Landroid/hardware/hdmi/IHdmiControlCallback;I)V
    ...
    .line 319
    iput-boolean v5, p0, mSkipRoutingControl:Z
...
.method protected dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    iget-boolean v3, p0, mArcFeatureEnabled:Z
...
.method protected handleActiveSource(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    .line 381
    invoke-direct {p0, v2}, handleNewDeviceAtTheTailOfActivePath(I)V
...
.method protected handleRecordTvScreen(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {p0, v5}, announceOneTouchRecordResult(I)V
...
.method protected handleReportPhysicalAddress(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    .line 463
    .local v2, "type":I
    invoke-virtual {p0, v0, v2, v1}, updateCecSwitchInfo(III)Z
    ...
    .line 471
    :cond_3f
    invoke-direct {p0, v0, v1}, isInDeviceList(II)Z
    ...
    .line 472
    invoke-direct {p0, v1}, handleNewDeviceAtTheTailOfActivePath(I)V
    ...
    invoke-virtual {p0, v3}, startNewDeviceAction(Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;)V
...
.method protected handleTimerClearedStatus(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    invoke-virtual {p0, v1}, announceTimerRecordingResult(I)V
...
.method protected onAddressAllocated(II)V
    ...
    :goto_42
    invoke-virtual {p0, v1}, launchRoutingControl(Z)V
...
.method startOneTouchRecord(I[B)I
    ...
    invoke-virtual {p0, v1}, announceOneTouchRecordResult(I)V
    ...
    invoke-virtual {p0, v0}, announceOneTouchRecordResult(I)V
...
.method startTimerRecording(II[B)V
    ...
    invoke-virtual {p0, v0}, announceTimerRecordingResult(I)V
