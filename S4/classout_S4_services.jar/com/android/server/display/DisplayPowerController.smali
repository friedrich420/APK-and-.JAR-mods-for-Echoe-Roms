...
.method public constructor <init>(Landroid/content/Context;Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayBlanker;)V
    ...
    iput v2, v0, mScreenBrightnessOnCover:I
    ...
    iput-object v2, v0, mLights:Lcom/android/server/lights/LightsManager;
    ...
    iput-object v2, v0, mTimeMeasurement:Lcom/android/server/power/PowerManagerService$TimeMeasurement;
    ...
    iget-object v10, v0, mDynamicAutoBrightnessConfig:Lcom/android/server/display/DisplayPowerController$DynamicAutoBrightnessConfig;
    ...
    invoke-static {v12, v14}, createAutoBrightnessSpline([I[I)Landroid/util/Spline;
...
.method private animateScreenStateChange(IZ)V
    ...
    .line 1060
    :cond_f
    iget-object v2, p0, mColorFadeOnAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object v2, p0, mColorFadeOffAnimator:Landroid/animation/ObjectAnimator;
    ...
    .line 1068
    iget-boolean v2, p0, mPendingScreenOff:Z
    ...
    .line 1069
    invoke-direct {p0, v1}, setScreenState(I)Z

    .line 1070
    iput-boolean v6, p0, mPendingScreenOff:Z
...
.method private dumpLocal(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v1, p0, mUsingScreenAutoBrightness:Z
...
.method private getFinalBrightness(I)I
    ...
    :cond_2a
    :goto_2a
    iget-boolean v2, p0, mUsingScreenAutoBrightness:Z
...
.method private initialize()V
    ...
    iget-object v2, p0, mLights:Lcom/android/server/lights/LightsManager;
...
.method private setScreenState(I)Z
    ...
    .line 964
    iget-object v4, p0, mPowerState:Lcom/android/server/display/DisplayPowerState;
    ...
    .line 982
    iget-object v4, p0, mScreenBrightnessRampAnimator:Lcom/android/server/display/RampAnimator;
    ...
    iget-object v5, p0, mPendingScreenOnUnblocker:Lcom/android/server/display/DisplayPowerController$ScreenOnUnblocker;
...
.method private updatePowerState()V
    ...
    :try_start_6
    iput-boolean v10, p0, mPendingUpdatePowerStateLocked:Z

    .line 577
    iget-object v10, p0, mPendingRequestLocked:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;
    ...
    .line 581
    :cond_e
    iget-object v10, p0, mPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;
    ...
    iget-object v12, p0, mPendingRequestLocked:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;
    ...
    iput-object v10, p0, mPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;

    .line 583
    iget-boolean v10, p0, mPendingWaitForNegativeProximityLocked:Z

    iput-boolean v10, p0, mWaitingForNegativeProximity:Z

    .line 584
    const/4 v10, 0x0

    iput-boolean v10, p0, mPendingWaitForNegativeProximityLocked:Z

    .line 586
    iget-boolean v10, p0, mPendingScreenOnEvenThoughProximityPositiveLocked:Z

    iput-boolean v10, p0, mScreenOnEvenThoughProximityPositive:Z

    .line 587
    const/4 v10, 0x0

    iput-boolean v10, p0, mPendingScreenOnEvenThoughProximityPositiveLocked:Z

    .line 589
    const/4 v10, 0x0

    iput-boolean v10, p0, mPendingRequestChangedLocked:Z
    ...
    :cond_2d
    :goto_2d
    iget-boolean v10, p0, mDisplayReadyLocked:Z
    ...
    .local v9, "state":I
    :goto_42
    sget-boolean v10, $assertionsDisabled:Z
    ...
    :cond_4e
    :try_start_4e
    iget-boolean v10, p0, mPendingRequestChangedLocked:Z
    ...
    .line 595
    iget-boolean v10, p0, mWaitingForNegativeProximity:Z

    iget-boolean v12, p0, mPendingWaitForNegativeProximityLocked:Z
    ...
    .line 598
    iget-boolean v10, p0, mScreenOnEvenThoughProximityPositive:Z

    iget-boolean v12, p0, mPendingScreenOnEvenThoughProximityPositiveLocked:Z
    ...
    iput-boolean v10, p0, mDisplayReadyLocked:Z
    ...
    iput-boolean v10, p0, mScreenOnOffAlreadyDone:Z

    .line 673
    iget-object v10, p0, mProximitySensor:Landroid/hardware/Sensor;

    if-eqz v10, :cond_2dd

    .line 674
    iget-boolean v10, p0, mWaitProximityToggled:Z

    if-nez v10, :cond_b3

    iget v10, p0, mProximity:I
    ...
    iput-boolean v10, p0, mWaitProximityToggled:Z
    ...
    .line 684
    iget-boolean v10, p0, mScreenOffBecauseOfProximity:Z
    ...
    invoke-direct {p0, v10}, setProximitySensorEnabled(Z)V

    .line 689
    const/4 v10, 0x1

    invoke-direct {p0, v10}, setScreenState(I)Z
    ...
    :cond_e0
    :goto_e0
    invoke-direct {p0, v9, v6}, animateScreenStateChange(IZ)V

    .line 771
    iget-object v10, p0, mPowerState:Lcom/android/server/display/DisplayPowerState;
    ...
    .line 781
    :cond_f5
    iget v2, p0, mScreenBrightnessDozeConfig:I
    ...
    iput-boolean v10, p0, mUsingScreenAutoBrightness:Z

    .line 789
    iget-object v10, p0, mAutomaticBrightnessController:Lcom/android/server/display/AutomaticBrightnessController;
    ...
    iget-object v11, p0, mPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;

    iget v11, v11, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->screenAutoBrightnessAdjustment:F

    iget-object v12, p0, mPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;

    iget-boolean v12, v12, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->useAutoBrightness:Z

    iget-object v13, p0, mPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;
    ...
    iput-boolean v10, p0, mPendingScreenAutoBrightness:Z
    ...
    .line 815
    iget-boolean v10, p0, mAppliedAutoBrightness:Z
    ...
    iput-boolean v10, p0, mAppliedAutoBrightness:Z
    ...
    invoke-direct {p0, v10}, clampScreenBrightness(I)I
    ...
    .line 846
    iget v10, p0, mScreenBrightnessRangeMinimum:I
    ...
    iget v11, p0, mScreenBrightnessDimConfig:I

    invoke-static {v10, v11}, Ljava/lang/Math;->min(II)I

    move-result v10

    iget v11, p0, mScreenBrightnessRangeMinimum:I
    ...
    .line 850
    :cond_16a
    iget-boolean v10, p0, mAppliedDimming:Z
    ...
    iput-boolean v10, p0, mAppliedDimming:Z
    ...
    .line 862
    :cond_184
    iget-boolean v10, p0, mAppliedLowPower:Z
    ...
    iput-boolean v10, p0, mAppliedLowPower:Z
    ...
    .line 870
    iget-boolean v10, p0, mPendingScreenAutoBrightness:Z
    ...
    .line 872
    iput v2, p0, mScreenBrightnessOnCover:I

    .line 879
    :cond_19f
    iget v10, p0, mLatestAnimationTarget:I

    if-eq v10, v2, :cond_1a5

    .line 880
    iput v2, p0, mLatestAnimationTarget:I

    .line 883
    :cond_1a5
    invoke-direct {p0, v2}, getFinalBrightness(I)I
    ...
    :goto_1b3
    invoke-direct {p0, v2, v10}, animateScreenBrightness(II)V

    .line 899
    :goto_1b6
    iget-object v10, p0, mPendingScreenOnUnblocker:Lcom/android/server/display/DisplayPowerController$ScreenOnUnblocker;

    if-nez v10, :cond_310

    iget-object v10, p0, mColorFadeOnAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object v10, p0, mColorFadeOffAnimator:Landroid/animation/ObjectAnimator;
    ...
    iget-object v11, p0, mCleanListener:Ljava/lang/Runnable;
    ...
    iget-object v10, p0, mScreenBrightnessRampAnimator:Lcom/android/server/display/RampAnimator;
    ...
    iget-boolean v10, p0, mUnfinishedBusiness:Z
    ...
    .line 911
    :cond_1f1
    iget-object v10, p0, mCallbacks:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;
    ...
    iput-boolean v10, p0, mUnfinishedBusiness:Z
    ...
    .line 927
    invoke-direct {p0}, sendOnStateChangedWithWakelock()V
    ...
    iput-boolean v10, p0, mScreenOffBecauseOfProximity:Z
    ...
    .line 705
    invoke-direct {p0}, sendOnProximityPositiveWithWakelock()V
    ...
    .line 709
    invoke-direct {p0}, setScreenOnAndElectronBeamExit()V
    ...
    .line 714
    :cond_26c
    invoke-direct {p0}, sendOnProximityNegativeWithWakelock()V
    ...
    iget v2, p0, mLatestAnimationTarget:I
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget v1, p0, mScreenBrightnessOnCover:I
...
.method public getScreenBrightnessOnCover()I
    ...
    .prologue
    .line 1573
    iget v0, p0, mScreenBrightnessOnCover:I
