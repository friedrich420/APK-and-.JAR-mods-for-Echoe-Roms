...
.method public constructor <init>(Lcom/android/server/display/DisplayManagerService$SyncRoot;Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/display/DisplayAdapter$Listener;Lcom/android/server/display/PersistentDataStore;)V
    ...
    .line 117
    iput v6, p0, mConnectedState:I

    .line 118
    iput v6, p0, mConnectWifidisplayState:I
...
.method private IsRunningIpRemoteDisplay()Z
    ...
    .prologue
    .line 434
    iget v0, p0, mConnectWifidisplayState:I

    if-ltz v0, :cond_b

    const/4 v0, 0x5

    iget v1, p0, mConnectWifidisplayState:I
...
.method static synthetic access$2902(Lcom/android/server/display/WifiDisplayAdapter;I)I
    ...
    .prologue
    .line 81
    iput p1, p0, mConnectWifidisplayState:I
...
.method private handleUpdateNotification()V
    ...
    iput-boolean v1, p0, mPendingNotificationUpdate:Z

    .line 692
    iget v11, p0, mActiveDisplayState:I

    .line 693
    .local v11, "state":I
    iget-object v7, p0, mActiveDisplay:Landroid/hardware/display/WifiDisplay;
    ...
    iget-object v1, p0, mSettingsPendingIntent:Landroid/app/PendingIntent;
    ...
    iput-object v1, p0, mSettingsPendingIntent:Landroid/app/PendingIntent;

    .line 715
    .end local v2    # "settingsIntent":Landroid/content/Intent;
    :cond_45
    iget-object v1, p0, mDisconnectPendingIntent:Landroid/app/PendingIntent;
    ...
    iput-object v1, p0, mDisconnectPendingIntent:Landroid/app/PendingIntent;
...
.method private updateDisplaysLocked()V
    ...
    iget-object v1, v0, mAvailableDisplays:[Landroid/hardware/display/WifiDisplay;

    array-length v1, v1

    move-object/from16 v0, p0

    iget-object v2, v0, mRememberedDisplays:[Landroid/hardware/display/WifiDisplay;
    ...
    iput-object v1, v0, mDisplays:[Landroid/hardware/display/WifiDisplay;
...
.method public dumpLocked(Ljava/io/PrintWriter;)V
    ...
    iget v2, p0, mActiveDisplayState:I
    ...
    iget-object v2, p0, mActiveDisplay:Landroid/hardware/display/WifiDisplay;
    ...
    iget-object v2, p0, mDisplays:[Landroid/hardware/display/WifiDisplay;
    ...
    iget-object v2, p0, mAvailableDisplays:[Landroid/hardware/display/WifiDisplay;
    ...
    iget-object v2, p0, mRememberedDisplays:[Landroid/hardware/display/WifiDisplay;
    ...
    iget-boolean v2, p0, mPendingStatusChangeBroadcast:Z
    ...
    iget-boolean v2, p0, mPendingNotificationUpdate:Z
    ...
    iget-object v2, p0, mDisplayController:Lcom/android/server/display/WifiDisplayController;
...
.method public requestEnableLocked(Landroid/net/wifi/p2p/WifiP2pDevice;I)V
    ...
    .line 1320
    iput p2, p0, mConnectWifidisplayState:I
...
.method public requestEnableLocked(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    .prologue
    .line 1334
    iput p3, p0, mConnectWifidisplayState:I
