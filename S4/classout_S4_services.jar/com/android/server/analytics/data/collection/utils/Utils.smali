...
.method public static readPropertyValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_9
    .catch Ljava/io/FileNotFoundException; {:try_start_4 .. :try_end_9} :catch_49
    ...
    :try_end_38
    .catch Ljava/lang/Exception; {:try_start_11 .. :try_end_38} :catch_80
    .catchall {:try_start_11 .. :try_end_38} :catchall_97
    ...
    :try_end_47
    .catch Ljava/io/IOException; {:try_start_3e .. :try_end_47} :catch_68
    ...
    const-string v6, ""
    :try_end_67
    .catch Ljava/lang/Exception; {:try_start_65 .. :try_end_67} :catch_80
    .catchall {:try_start_65 .. :try_end_67} :catchall_97
    ...
    invoke-virtual {v2}, Ljava/io/BufferedReader;->close()V
    :try_end_78
    .catch Ljava/io/IOException; {:try_start_6f .. :try_end_78} :catch_7b
    ...
    invoke-virtual {v2}, Ljava/io/BufferedReader;->close()V
    :try_end_8f
    .catch Ljava/io/IOException; {:try_start_86 .. :try_end_8f} :catch_92
    ...
    invoke-virtual {v2}, Ljava/io/BufferedReader;->close()V
    :try_end_a3
    .catch Ljava/io/IOException; {:try_start_9a .. :try_end_a3} :catch_a5
