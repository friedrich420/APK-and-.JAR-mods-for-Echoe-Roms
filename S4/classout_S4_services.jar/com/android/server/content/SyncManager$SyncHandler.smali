...
.method public constructor <init>(Lcom/android/server/content/SyncManager;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, mBootQueue:Ljava/util/List;
...
.method private cancelActiveSyncLocked(Lcom/android/server/content/SyncStorageEngine$EndPoint;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v4, v0}, runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
...
.method private dispatchSyncOperation(Lcom/android/server/content/SyncOperation;)Z
    ...
    invoke-virtual {p0, p1}, insertStartSyncEvent(Lcom/android/server/content/SyncOperation;)J
    ...
    .line 2718
    invoke-direct {p0, v1}, closeActiveSyncContext(Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
...
.method private manageSyncAlarmLocked(JJ)V
    ...
    iget-object v0, v0, mSyncNotificationInfo:Lcom/android/server/content/SyncManager$SyncHandler$SyncNotificationInfo;
...
.method private manageSyncNotificationLocked()V
    ...
    .line 2925
    iget-object v10, p0, this$0:Lcom/android/server/content/SyncManager;
    ...
    .line 2926
    iget-object v10, p0, mSyncNotificationInfo:Lcom/android/server/content/SyncManager$SyncHandler$SyncNotificationInfo;
    ...
    .line 2971
    invoke-direct {p0}, sendSyncStateIntent()V
    ...
    .line 2976
    iget-object v9, p0, this$0:Lcom/android/server/content/SyncManager;
    ...
    .line 2978
    iget-object v9, p0, mSyncNotificationInfo:Lcom/android/server/content/SyncManager$SyncHandler$SyncNotificationInfo;
...
.method private maybeStartNextSyncLocked()J
    ...
    invoke-direct {v0, v1, v2}, runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-direct {v0, v8}, dispatchSyncOperation(Lcom/android/server/content/SyncOperation;)Z
...
.method private tryEnqueueMessageUntilReadyToRun(Landroid/os/Message;)Z
    ...
    .line 1990
    iget-object v0, p0, mBootQueue:Ljava/util/List;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v13, v0, this$0:Lcom/android/server/content/SyncManager;
    ...
    :cond_36
    :goto_36
    invoke-direct/range {p0 .. p0}, manageSyncNotificationLocked()V

    .line 2156
    move-object/from16 v0, p0

    invoke-direct {v0, v4, v5, v10, v11}, manageSyncAlarmLocked(JJ)V

    .line 2157
    move-object/from16 v0, p0

    iget-object v13, v0, mSyncTimeTracker:Lcom/android/server/content/SyncManager$SyncTimeTracker;
    ...
    .line 2050
    invoke-direct/range {p0 .. p0}, maybeStartNextSyncLocked()J
    ...
    invoke-direct {v0, v9, v6}, cancelActiveSyncLocked(Lcom/android/server/content/SyncStorageEngine$EndPoint;Landroid/os/Bundle;)V
    ...
    iget-object v14, v0, mSyncTimeTracker:Lcom/android/server/content/SyncManager$SyncTimeTracker;
    ...
    invoke-direct {v0, v13, v14}, runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-direct {v0, v13, v14}, runBoundToAdapter(Lcom/android/server/content/SyncManager$ActiveSyncContext;Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, v12, v2}, runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    iput-object v13, v0, mAlarmScheduleTime:Ljava/lang/Long;
    :try_end_1ec
...
.method public onBootCompleted()V
    ...
    .line 1959
    :try_start_16
    iget-object v2, p0, mBootQueue:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, sendMessage(Landroid/os/Message;)Z
    ...
    :try_start_30
    iput-object v2, p0, mBootQueue:Ljava/util/List;
