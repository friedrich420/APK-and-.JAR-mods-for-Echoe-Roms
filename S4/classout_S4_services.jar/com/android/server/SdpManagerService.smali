...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mPolicyManager:Lcom/android/server/SdpPolicyManager;

    .line 76
    const/4 v0, 0x0

    iput-boolean v0, p0, mWaitForPassword:Z
    ...
    iput-object v0, p0, mSdpInfoLock:Ljava/lang/Object;
...
.method private readSdpInfo(I)Landroid/content/pm/SdpUserInfo;
    ...
    iget-object v13, v0, mSdpInfoLock:Ljava/lang/Object;
    ...
    invoke-direct/range {p0 .. p1}, getSdpInfoFilePath(I)Ljava/io/File;
    ...
    invoke-direct {v0, v3, v12, v14}, readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
...
.method private removeSdpInfo(I)V
    ...
    .prologue
    .line 377
    invoke-direct {p0, p1}, getSdpInfoFilePath(I)Ljava/io/File;
...
.method private setStatus(Landroid/content/pm/SdpUserInfo;I)V
    ...
    .line 158
    invoke-direct {p0, p1}, writeSdpInfo(Landroid/content/pm/SdpUserInfo;)V
...
.method private writeSdpInfo(Landroid/content/pm/SdpUserInfo;)V
    ...
    invoke-direct {p0, v5}, getSdpInfoFilePath(I)Ljava/io/File;
    ...
    iget-object v6, p0, mSdpInfoLock:Ljava/lang/Object;
...
.method public getSdpUserInfo(I)Landroid/content/pm/SdpUserInfo;
    ...
    iget-object v3, p0, mSdpInfoLock:Ljava/lang/Object;
    ...
    .line 248
    invoke-direct {p0, p1}, readSdpInfo(I)Landroid/content/pm/SdpUserInfo;
...
.method public getSensitiveDBInfo(II)Ljava/util/List;
    ...
    .line 564
    .local v0, "ident":J
    iget-object v3, p0, mPolicyManager:Lcom/android/server/SdpPolicyManager;
...
.method public getState(I)I
    ...
    .line 499
    iget-object v0, p0, mStateMap:Ljava/util/HashMap;
...
.method public getStatus(I)I
    ...
    .prologue
    .line 163
    invoke-virtual {p0, p1}, getSdpUserInfo(I)Landroid/content/pm/SdpUserInfo;
...
.method public isSDPEnabled(I)Z
    ...
    .line 573
    .local v0, "ident":J
    invoke-direct {p0}, getPersonaService()Lcom/android/server/pm/PersonaManagerService;
    ...
    iget-boolean v4, p0, mWaitForPassword:Z
...
.method public onBoot(I)Z
    ...
    .line 394
    invoke-static {p1}, nativeOnBoot(I)I
    ...
    .line 399
    :cond_45
    iget-object v2, p0, mStateMap:Ljava/util/HashMap;
    ...
    .line 407
    invoke-direct {p0, v0}, writeSdpInfo(Landroid/content/pm/SdpUserInfo;)V
    ...
    .line 413
    invoke-virtual {p0, v0}, onUpgrade(Landroid/content/pm/SdpUserInfo;)I
...
.method public onDeviceLocked(I)Z
    ...
    .line 426
    invoke-static {p1}, nativeOnDeviceLocked(I)I
    ...
    .line 432
    :cond_44
    iget-object v1, p0, mStateMap:Ljava/util/HashMap;
    ...
    .line 433
    invoke-direct {p0, p1, v0}, sendBroadcastForStateChange(II)V
...
.method public onDeviceUnlocked(ILjava/lang/String;)Z
    ...
    .line 443
    invoke-static {p1, p2}, nativeOnDeviceUnlocked(ILjava/lang/String;)I
    ...
    .line 449
    invoke-direct {p0, p1, v3}, sendBroadcastForStateChange(II)V
...
.method public onUpgrade(Landroid/content/pm/SdpUserInfo;)I
    ...
    .line 191
    :cond_5b
    invoke-direct {p0, p1, v8}, setStatus(Landroid/content/pm/SdpUserInfo;I)V
    ...
    .line 228
    invoke-direct {p0, p1, v7}, setStatus(Landroid/content/pm/SdpUserInfo;I)V
...
.method public onUserAdded(ILjava/lang/String;I)Z
    ...
    .line 472
    invoke-static {p1, p2}, nativeOnUserAdded(ILjava/lang/String;)I
...
.method public onUserRemoved(I)Z
    ...
    .line 486
    invoke-static {p1}, nativeOnUserRemoved(I)I
    ...
    .line 492
    invoke-direct {p0, p1}, removeSdpInfo(I)V
...
.method public setSDPMigrating(Z)V
    ...
    .line 594
    iput-boolean p1, p0, mWaitForPassword:Z
...
.method public setSensitiveDBInfo(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v0}, nativeMemSetProcessSensitive(I)I
    ...
    .line 545
    .local v6, "ident":J
    iget-object v0, p0, mPolicyManager:Lcom/android/server/SdpPolicyManager;
...
.method public setSensitiveFileInfo(IILjava/lang/String;)I
    ...
    invoke-static {v2}, nativeMemSetProcessSensitive(I)I
    ...
    .line 532
    .local v0, "ident":J
    iget-object v2, p0, mPolicyManager:Lcom/android/server/SdpPolicyManager;
