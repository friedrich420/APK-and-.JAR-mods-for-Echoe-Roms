...
.method public addListener(Landroid/os/IInterface;)Z
    ...
    .line 46
    invoke-virtual {p0}, isSupported()Z
    ...
    iget-object v5, p0, mListenerMap:Ljava/util/HashMap;

    monitor-enter v5

    .line 54
    :try_start_21
    iget-object v6, p0, mListenerMap:Ljava/util/HashMap;
    ...
    .line 72
    invoke-virtual {p0, p1}, removeListener(Landroid/os/IInterface;)Z
...
.method protected foreach(Lcom/android/server/location/RemoteListenerHelper$ListenerOperation;)V
    ...
    .line 113
    .local p0, "this":Lcom/android/server/location/RemoteListenerHelper;, "Lcom/android/server/location/RemoteListenerHelper<TTListener;>;"
    iget-object v7, p0, mListenerMap:Ljava/util/HashMap;
    ...
    .line 124
    invoke-virtual {p0, v4}, removeListener(Landroid/os/IInterface;)Z
...
.method public removeListener(Landroid/os/IInterface;)Z
    ...
    .line 90
    .local v0, "binder":Landroid/os/IBinder;
    iget-object v3, p0, mListenerMap:Ljava/util/HashMap;

    monitor-enter v3

    .line 91
    :try_start_1b
    iget-object v4, p0, mListenerMap:Ljava/util/HashMap;
