...
.method static constructor <clinit>()V
    ...
    .line 156
    sput-boolean v1, radioState:Z

    .line 157
    sput-boolean v1, gattState:Z
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 387
    iput-boolean v5, p0, mQuietEnableExternal:Z
    ...
    iput-object v3, p0, mRadioMgrCallbacks:Landroid/os/RemoteCallbackList;
...
.method static synthetic access$1000(Lcom/android/server/BluetoothManagerService;)Z
    ...
    .prologue
    .line 96
    iget-boolean v0, p0, mQuietEnableExternal:Z
...
.method static synthetic access$1300(Lcom/android/server/BluetoothManagerService;)V
    ...
    .prologue
    .line 96
    invoke-direct {p0}, reEnableBleRadio()V
...
.method static synthetic access$2700(Lcom/android/server/BluetoothManagerService;I)V
    ...
    .prologue
    .line 96
    invoke-direct {p0, p1}, handleEnableRadio(I)V
...
.method static synthetic access$2800(Lcom/android/server/BluetoothManagerService;I)V
    ...
    .prologue
    .line 96
    invoke-direct {p0, p1}, handleDisableRadio(I)V
...
.method static synthetic access$3000(Lcom/android/server/BluetoothManagerService;)Landroid/bluetooth/IBluetoothGatt;
    ...
    .prologue
    .line 96
    iget-object v0, p0, mBluetoothGatt:Landroid/bluetooth/IBluetoothGatt;
...
.method static synthetic access$3102(Lcom/android/server/BluetoothManagerService;Z)Z
    ...
    .prologue
    .line 96
    iput-boolean p1, p0, mGattBinding:Z
...
.method static synthetic access$3200(Lcom/android/server/BluetoothManagerService;Z)V
    ...
    .prologue
    .line 96
    invoke-direct {p0, p1}, sendGattServiceStatusCallback(Z)V
...
.method static synthetic access$3600(Lcom/android/server/BluetoothManagerService;)I
    ...
    .prologue
    .line 96
    invoke-direct {p0}, CheckItPolicy()I
...
.method static synthetic access$4400(Lcom/android/server/BluetoothManagerService;Z)V
    ...
    .prologue
    .line 96
    invoke-direct {p0, p1}, sendRadioSatusCallback(Z)V
...
.method static synthetic access$4600(Lcom/android/server/BluetoothManagerService;)Z
    ...
    .prologue
    .line 96
    iget-boolean v0, p0, mEnableUserSwitch:Z
...
.method static synthetic access$4602(Lcom/android/server/BluetoothManagerService;Z)Z
    ...
    .prologue
    .line 96
    iput-boolean p1, p0, mEnableUserSwitch:Z
...
.method static synthetic access$800(Lcom/android/server/BluetoothManagerService;I)V
    ...
    .prologue
    .line 96
    invoke-direct {p0, p1}, sendDisableRadioMsg(I)V
...
.method private bluetoothStateChangeHandler(II)V
    ...
    iget-object v9, p0, mBluetooth:Landroid/bluetooth/IBluetooth;
    ...
    .line 1893
    invoke-direct {p0, v5}, canUnbindBluetoothService(Z)Z
    ...
    iget-object v8, p0, mConnection:Lcom/android/server/BluetoothManagerService$BluetoothServiceConnection;
    ...
    .line 1897
    sget-boolean v5, BLE_ALWAYS_ON:Z
    ...
    .line 1900
    invoke-direct {p0, v6}, sendGattServiceStatusCallback(Z)V

    .line 1901
    invoke-direct {p0, v6}, sendRadioSatusCallback(Z)V
    ...
    .local v4, "isUp":Z
    :goto_107
    invoke-direct {p0, v4}, sendBluetoothStateCallback(Z)V
    ...
    iget-object v7, p0, mConnection:Lcom/android/server/BluetoothManagerService$BluetoothServiceConnection;

    const/16 v8, 0x41

    sget-object v9, Landroid/os/UserHandle;->CURRENT:Landroid/os/UserHandle;

    invoke-virtual {p0, v0, v7, v8, v9}, doBind(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    .line 1919
    iput-boolean v6, p0, mGattBinding:Z
    ...
    iget-boolean v6, p0, mShutdown:Z
    ...
    .line 1981
    :cond_1ad
    invoke-virtual {p0, v5}, disable(Z)Z
    ...
    .line 1929
    iput-boolean v6, p0, mEnable:Z

    .line 1931
    :cond_1bf
    if-nez v4, :cond_1cd

    invoke-direct {p0, v6}, canUnbindBluetoothService(Z)Z
    ...
    .line 1935
    :cond_1cd
    iget-boolean v7, p0, mShutdown:Z

    if-eqz v7, :cond_133

    .line 1936
    iput-boolean v6, p0, mShutdown:Z

    .line 1937
    sget-boolean v7, BLE_ALWAYS_ON:Z
    ...
    :cond_239
    invoke-direct {p0, v5}, sendRadioSatusCallback(Z)V
...
.method private handleEnableRadio(I)V
    ...
    invoke-virtual {p0, v1, v3, v5, v6}, doBind(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
...
.method private onUserSwitched()V
    ...
    .line 1100
    :cond_b
    iget-object v3, p0, mRadioMgrCallbacks:Landroid/os/RemoteCallbackList;
...
.method private sendGattServiceStatusCallback(Z)V
    ...
    iget-object v4, p0, mBluetoothGatt:Landroid/bluetooth/IBluetoothGatt;
...
.method private shutdown()Z
    ...
    .line 869
    iput-boolean v1, p0, mShutdown:Z
    ...
    .line 873
    invoke-direct {p0, v5}, sendDisableRadioMsg(I)V
    ...
    .line 877
    invoke-virtual {p0, v1}, disable(Z)Z
...
.method public disable(Z)Z
    ...
    invoke-direct {p0, v6}, persistBluetoothSetting(I)V
    ...
    iput-boolean v6, p0, mEnableExternal:Z
...
.method public disableRadio(I)Z
    ...
    monitor-exit v4
    :try_end_63
    .catchall {:try_start_5b .. :try_end_63} :catchall_73
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 2340
    :cond_3a
    sget-object v0, mainBuffer:Ljava/lang/String;
    ...
    .line 2341
    :cond_47
    sget-object v0, subBuffer:Ljava/lang/StringBuilder;
...
.method public enable()Z
    ...
    .line 697
    sget-boolean v8, isEnablePopup:Z
    ...
    :cond_c3
    sput-boolean v6, isEnablePopup:Z
    ...
    :try_start_f3
    iput-boolean v6, p0, mQuietEnableExternal:Z
...
.method public enableGatt()Z
    ...
    .line 916
    :try_start_25
    iget-object v3, p0, mBluetoothGatt:Landroid/bluetooth/IBluetoothGatt;
    ...
    invoke-direct {p0, v1}, sendGattServiceStatusCallback(Z)V
    ...
    .line 920
    :cond_3b
    iget-boolean v3, p0, mGattBinding:Z
    ...
    invoke-virtual {p0, v0, v3, v4, v5}, doBind(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    :try_start_8f
    iput-boolean v1, p0, mGattBinding:Z
...
.method public enableNoAutoConnect()Z
    ...
    :try_start_5b
    iput-boolean v3, p0, mQuietEnableExternal:Z
...
.method public isUserAction()Z
    ...
    .line 2285
    iget-object v4, p0, btEnablePopUp:Landroid/app/AlertDialog;
...
.method public registerRadioMgrCallback(Landroid/bluetooth/IBluetoothRadioMgrCallback;)Z
    ...
    .line 893
    :try_start_3
    iget-object v1, p0, mRadioMgrCallbacks:Landroid/os/RemoteCallbackList;
...
.method public unregisterRadioMgrCallback(Landroid/bluetooth/IBluetoothRadioMgrCallback;)Z
    ...
    .line 901
    :try_start_3
    iget-object v0, p0, mRadioMgrCallbacks:Landroid/os/RemoteCallbackList;
