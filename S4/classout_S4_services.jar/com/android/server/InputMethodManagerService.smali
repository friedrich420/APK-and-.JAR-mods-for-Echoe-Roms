...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v0, p0, mImeSwitcherNotification:Landroid/app/Notification;

    .line 1127
    iget-object v0, p0, mImeSwitcherNotification:Landroid/app/Notification;
...
.method static synthetic access$002(Lcom/android/server/InputMethodManagerService;Z)Z
    ...
    .prologue
    .line 183
    iput-boolean p1, p0, mCurClientInKeyguard:Z
...
.method static synthetic access$200(Lcom/android/server/InputMethodManagerService;)V
    ...
    .prologue
    .line 183
    invoke-direct {p0}, refreshImeWindowVisibilityLocked()V
...
.method static synthetic access$300(Lcom/android/server/InputMethodManagerService;)V
    ...
    .prologue
    .line 183
    invoke-direct {p0}, setImeWindowVisibilityStatusHiddenLocked()V
...
.method private chooseNewDefaultIMELocked()Z
    ...
    invoke-direct {p0, v5}, resetSelectedInputMethodAndSubtypeLocked(Ljava/lang/String;)V
...
.method private isSecureIMEKnox(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    iget-object v7, p0, mSettings:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
...
.method private needsToShowImeSwitchOngoingNotification()Z
    ...
    iget-boolean v13, v0, mShowOngoingImeSwitcherForPhones:Z
    ...
    iget-object v13, v0, mSwitchingDialog:Landroid/app/AlertDialog;
    ...
    iget-object v14, v0, mMethodMap:Ljava/util/HashMap;
    ...
    iget-object v13, v0, mSettings:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;
...
.method private refreshImeWindowVis()V
    ...
    .line 1524
    iget-object v12, p0, mRes:Landroid/content/res/Resources;
    ...
    iget-boolean v12, p0, mInputShown:Z
...
.method private refreshImeWindowVisibilityLocked()V
    ...
    .line 1600
    invoke-direct {p0}, updateImeWindowStatusLocked()V
...
.method private resetAllInternalStateLocked(ZZ)V
    ...
    .line 1298
    invoke-virtual {p0, v4, v6}, hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z

    .line 1299
    iput-object v6, p0, mCurMethodId:Ljava/lang/String;
...
.method private resetDefaultImeLocked(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0, v3, v4}, setSelectedInputMethodAndSubtypeLocked(Landroid/view/inputmethod/InputMethodInfo;IZ)V
...
.method private showInputMethodMenuInternal(Z)V
    ...
    iget-boolean v0, v0, mShowImeWithHardKeyboard:Z
    ...
    .line 4356
    invoke-direct/range {p0 .. p0}, updateImeWindowStatusLocked()V
...
.method private switchUserLocked(I)V
    ...
    iput-object v2, p0, mFileManager:Lcom/android/server/InputMethodManagerService$InputMethodFileManager;
    ...
    invoke-direct {p0, v2, v1}, resetAllInternalStateLocked(ZZ)V
    ...
    iput-boolean v2, p0, mIsPersona:Z
...
.method private updateImeWindowStatusLocked()V
    ...
    invoke-virtual {p0, v0, v1, v2}, setImeWindowStatus(Landroid/os/IBinder;II)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v11, p0, mScreenOn:Z
...
.method public getInputMethodList()Ljava/util/List;
    ...
    invoke-direct {p0, v0}, switchUserLocked(I)V
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    .line 3469
    :sswitch_9
    invoke-direct {p0}, showInputMethodMenu()V
    ...
    .line 3478
    :sswitch_11
    iget-object v9, p0, mSwitchingDialog:Landroid/app/AlertDialog;
    ...
    invoke-direct {p0, v9}, showInputMethodAndSubtypeEnabler(Ljava/lang/String;)V
    ...
    :sswitch_230
    iget-object v12, p0, mHardKeyboardListener:Lcom/android/server/InputMethodManagerService$HardKeyboardListener;
...
.method hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    iget-boolean v4, p0, mShowExplicitlyRequested:Z

    if-nez v4, :cond_1a

    iget-boolean v4, p0, mShowForced:Z
    ...
    .line 2751
    :cond_26
    iget-boolean v4, p0, mInputShown:Z
    ...
    iget-object v5, p0, mCaller:Lcom/android/internal/os/HandlerCaller;
    ...
    invoke-virtual {p0, v4, v5}, executeOrSendMessage(Landroid/os/IInterface;Landroid/os/Message;)V
    ...
    .local v1, "res":Z
    :goto_3e
    iget-boolean v4, p0, mHaveConnection:Z

    if-eqz v4, :cond_4f

    iget-boolean v4, p0, mVisibleBound:Z
    ...
    iget-object v5, p0, mVisibleConnection:Landroid/content/ServiceConnection;
    ...
    .line 2766
    :cond_4f
    iput-boolean v3, p0, mInputShown:Z

    .line 2767
    iput-boolean v3, p0, mShowRequested:Z

    .line 2768
    iput-boolean v3, p0, mShowExplicitlyRequested:Z

    .line 2769
    iput-boolean v3, p0, mShowForced:Z
    ...
    .line 2781
    :try_start_59
    iget-object v3, p0, mIWindowManager:Landroid/view/IWindowManager;
...
.method hideInputMethodMenuLocked()V
    ...
    .line 4480
    iput-object v1, p0, mSwitchingDialog:Landroid/app/AlertDialog;
    ...
    .line 4484
    iput-object v1, p0, mDialogBuilder:Landroid/app/AlertDialog$Builder;

    .line 4485
    iput-object v1, p0, mIms:[Landroid/view/inputmethod/InputMethodInfo;
...
.method public setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    iget-object v13, v0, mMethodMap:Ljava/util/HashMap;
    ...
    invoke-direct/range {p0 .. p0}, needsToShowImeSwitchOngoingNotification()Z
    ...
    iget-object v14, v0, mCurMethodId:Ljava/lang/String;
    ...
    iget-object v14, v0, mCurrentSubtype:Landroid/view/inputmethod/InputMethodSubtype;
    ...
    iget-object v12, v0, mImeSwitcherNotification:Landroid/app/Notification;
    ...
    iget-object v15, v0, mImeSwitchPendingIntent:Landroid/app/PendingIntent;
    ...
    iget-object v0, v0, mImeSwitcherNotification:Landroid/app/Notification;
...
.method setInputMethodLocked(Ljava/lang/String;I)V
    ...
    .prologue
    .line 2471
    iget-boolean v10, p0, mShowRequested:Z

    if-eqz v10, :cond_15

    iget-object v10, p0, mCurMethodId:Ljava/lang/String;
    ...
    .line 2480
    :cond_38
    iget-object v10, p0, mCurClient:Lcom/android/server/InputMethodManagerService$ClientState;

    if-eqz v10, :cond_81

    iget-object v10, p0, mCurAttribute:Landroid/view/inputmethod/EditorInfo;
    ...
    .line 2516
    iget-object v10, p0, mCurMethod:Lcom/android/internal/view/IInputMethod;
...
.method public systemRunning(Lcom/android/server/statusbar/StatusBarManagerService;)V
    ...
    iput-object v1, p0, mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    iput-object v1, p0, mNotificationManager:Landroid/app/NotificationManager;
    ...
    iput-boolean v1, p0, mShowOngoingImeSwitcherForPhones:Z

    .line 1443
    iget-boolean v1, p0, mShowOngoingImeSwitcherForPhones:Z
    ...
    iget-object v5, p0, mHardKeyboardListener:Lcom/android/server/InputMethodManagerService$HardKeyboardListener;
    ...
    iget-boolean v1, p0, mImeSelectedOnBoot:Z
    ...
    :goto_4e
    invoke-virtual {p0, v5, v6, v1}, buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;Z)V
    ...
    sput-object v1, mDeviceDefaultThemeType:Ljava/lang/String;

    .line 1471
    const/4 v1, 0x0

    sput-boolean v1, mEnabledKCMFeatureForHWKeyboard:Z
    :try_end_81
    .catchall {:try_start_5 .. :try_end_81} :catchall_96
    ...
    :try_end_8d
    .catch Ljava/lang/Exception; {:try_start_81 .. :try_end_8d} :catch_91
...
.method unbindCurrentMethodLocked(ZZ)V
    ...
    .line 2059
    iput-boolean v2, p0, mVisibleBound:Z
    ...
    .line 2064
    iput-boolean v2, p0, mHaveConnection:Z
    ...
    .line 2077
    :goto_32
    iput-object v3, p0, mCurToken:Landroid/os/IBinder;

    .line 2080
    :cond_34
    iput-object v3, p0, mCurId:Ljava/lang/String;
...
.method updateInputMethodsFromSettingsLocked(Z)V
    ...
    iput-object v0, p0, mCurMethodId:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, unbindCurrentMethodLocked(ZZ)V
...
.method public windowGainedFocus(Lcom/android/internal/view/IInputMethodClient;Landroid/os/IBinder;IIILandroid/view/inputmethod/EditorInfo;Lcom/android/internal/view/IInputContext;)Lcom/android/internal/view/InputBindResult;
    ...
    invoke-direct {v0, v1}, switchUserLocked(I)V
    ...
    iput v0, v1, mCurrentFocusedUserId:I
