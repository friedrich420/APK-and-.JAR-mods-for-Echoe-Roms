...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/usb/UsbNotificationHandler;)V
    ...
    iput-object v1, p0, mStorageEventListener:Landroid/os/storage/StorageEventListener;

    .line 113
    iput-boolean v2, p0, mNeedIntent:Z
    ...
    iput-object v1, p0, mBootCompletedReceiver:Landroid/content/BroadcastReceiver;

    .line 209
    const/4 v1, 0x1

    iput v1, p0, USBHOST_UPDATE_STATE:I

    .line 210
    const/16 v1, 0x7d0

    iput v1, p0, UPDATE_DELAY:I

    .line 56
    iput-object p1, p0, mContext:Landroid/content/Context;

    .line 57
    iput-object p2, p0, mHandler:Lcom/android/server/usb/UsbNotificationHandler;
    ...
    iget-object v2, p0, mBootCompletedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, mStorageVolumes:[Landroid/os/storage/StorageVolume;

    .line 63
    iget-object v1, p0, mStorageManager:Landroid/os/storage/StorageManager;

    iget-object v2, p0, mStorageEventListener:Landroid/os/storage/StorageEventListener;
    ...
    iput-object v1, p0, mNotificationEventHandler:Landroid/os/Handler;
...
.method static synthetic access$000(Lcom/android/server/usb/UsbStorageNotification;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 44
    invoke-direct {p0, p1, p2, p3}, onUsbHostStateChanged(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic access$100(Lcom/android/server/usb/UsbStorageNotification;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 44
    invoke-direct {p0, p1, p2, p3}, onWaterProofing(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic access$300(Lcom/android/server/usb/UsbStorageNotification;)Z
    ...
    .prologue
    .line 44
    iget-boolean v0, p0, mNeedIntent:Z
...
.method static synthetic access$302(Lcom/android/server/usb/UsbStorageNotification;Z)Z
    ...
    .prologue
    .line 44
    iput-boolean p1, p0, mNeedIntent:Z
...
.method private onUsbHostStateChanged(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 148
    invoke-direct/range {p0 .. p1}, isUsbHostDevice(Ljava/lang/String;)Z
    ...
    iget-object v2, v0, mNotificationEventHandler:Landroid/os/Handler;
    ...
    iget-object v5, v0, mHandler:Lcom/android/server/usb/UsbNotificationHandler;
    ...
    iget-object v2, v0, mHandler:Lcom/android/server/usb/UsbNotificationHandler;
    ...
    iget-object v11, v0, mHandler:Lcom/android/server/usb/UsbNotificationHandler;
...
.method private onWaterProofing(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 128
    invoke-direct {p0, p1}, isSDCard(Ljava/lang/String;)Z
    ...
    .line 137
    :cond_40
    iget-boolean v0, p0, mReady:Z

    if-eqz v0, :cond_48

    .line 139
    invoke-virtual {p0}, sendWaterProfingIntent()V

    goto :goto_7

    .line 141
    :cond_48
    iput-boolean v4, p0, mNeedIntent:Z
