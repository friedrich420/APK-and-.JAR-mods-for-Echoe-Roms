...
.method public constructor <init>(Lcom/android/server/pm/PackageInstallerService$InternalCallback;Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Landroid/os/Looper;IILjava/lang/String;ILandroid/content/pm/PackageInstaller$SessionParams;JLjava/io/File;Ljava/lang/String;ZZ)V
    ...
    iput-object v1, p0, mActiveCount:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput v1, p0, mInternalProgress:F

    .line 116
    const/4 v1, 0x0

    iput v1, p0, mProgress:F

    .line 118
    const/high16 v1, -0x40800000    # -1.0f

    iput v1, p0, mReportedProgress:F

    .line 121
    const/4 v1, 0x0

    iput-boolean v1, p0, mPrepared:Z
    ...
    iput-boolean v1, p0, mPermissionsAccepted:Z
    ...
    iput-object v1, p0, mBridges:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, mResolvedStagedFiles:Ljava/util/List;
    ...
    iput-object v1, p0, mResolvedInheritedFiles:Ljava/util/List;
    ...
    iget-object v2, p0, mHandlerCallback:Landroid/os/Handler$Callback;
...
.method private calculateInstalledSize()J
    ...
    .line 702
    iget-object v7, p0, mResolvedBaseFile:Ljava/io/File;
    ...
    iget-object v7, p0, mResolvedStagedFiles:Ljava/util/List;
    ...
    :cond_3b
    iget-object v7, p0, mResolvedInheritedFiles:Ljava/util/List;
    ...
    iget-object v7, p0, params:Landroid/content/pm/PackageInstaller$SessionParams;
...
.method private commitLocked()V
    ...
    .line 465
    invoke-direct {p0}, validateInstallLocked()V
    ...
    .line 469
    iget-object v0, p0, mResolvedBaseFile:Ljava/io/File;

    invoke-static {v0}, Lcom/android/internal/util/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;

    .line 471
    iget-boolean v0, p0, mPermissionsAccepted:Z
    ...
    .line 478
    :try_start_46
    iget-object v0, p0, mRemoteObserver:Landroid/content/pm/IPackageInstallObserver2;
    ...
    .line 492
    invoke-direct {p0}, calculateInstalledSize()J
    ...
    invoke-static {v0, v10, v11}, resizeContainer(Ljava/lang/String;J)V
    ...
    .line 503
    iget-object v0, p0, mResolvedInheritedFiles:Ljava/util/List;

    invoke-direct {p0}, resolveStageDir()Ljava/io/File;

    move-result-object v1

    invoke-static {v0, v1}, copyFiles(Ljava/util/List;Ljava/io/File;)V
    :try_end_7b
    ...
    .line 518
    iget-object v0, p0, mResolvedStageDir:Ljava/io/File;
    ...
    invoke-static {v0, v1}, extractNativeLibraries(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, finalizeAndFixContainer(Ljava/lang/String;)V
    ...
    iget-object v3, p0, stageCid:Ljava/lang/String;

    iget-object v5, p0, params:Landroid/content/pm/PackageInstaller$SessionParams;

    iget-object v6, p0, installerPackageName:Ljava/lang/String;

    iget v7, p0, installerUid:I
    ...
    invoke-static {v0, v1}, linkFiles(Ljava/util/List;Ljava/io/File;)V
    :try_end_bf
...
.method private validateInstallLocked()V
    ...
    invoke-direct {v0, v1, v8}, assertApkConsistent(Ljava/lang/String;Landroid/content/pm/PackageParser$ApkLite;)V
...
.method public commit(Landroid/content/IntentSender;)V
    ...
    .line 415
    :try_start_6
    iget-boolean v3, p0, mSealed:Z

    .line 416
    .local v3, "wasSealed":Z
    iget-boolean v4, p0, mSealed:Z

    if-nez v4, :cond_32

    .line 418
    iget-object v4, p0, mBridges:Ljava/util/ArrayList;
    ...
    iput v4, p0, mClientProgress:F

    .line 428
    const/4 v4, 0x1

    invoke-direct {p0, v4}, computeProgressLocked(Z)V
    ...
    .line 435
    iget-object v4, p0, mCallback:Lcom/android/server/pm/PackageInstallerService$InternalCallback;
    ...
    .line 440
    :cond_42
    iget-object v4, p0, mActiveCount:Ljava/util/concurrent/atomic/AtomicInteger;
