...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Ljava/io/File;)V
    ...
    iput-object v7, p0, mInternalCallback:Lcom/android/server/pm/PackageInstallerService$InternalCallback;
    ...
    iput-object v7, p0, mSessions:Landroid/util/SparseArray;
    ...
    iput-object v7, p0, mHistoricalSessions:Landroid/util/SparseArray;
    ...
    iput-object v7, p0, mLegacySessions:Landroid/util/SparseBooleanArray;
    ...
    iput-object v7, p0, mAppOps:Landroid/app/AppOpsManager;

    .line 197
    iput-object p3, p0, mStagingDir:Ljava/io/File;
    ...
    iput-object v7, p0, mInstallThread:Landroid/os/HandlerThread;

    .line 200
    iget-object v7, p0, mInstallThread:Landroid/os/HandlerThread;
    ...
    iget-object v8, p0, mInstallThread:Landroid/os/HandlerThread;
    ...
    iput-object v7, p0, mInstallHandler:Landroid/os/Handler;
    ...
    iput-object v7, p0, mCallbacks:Lcom/android/server/pm/PackageInstallerService$Callbacks;
    ...
    iput-object v7, p0, mSessionsFile:Landroid/util/AtomicFile;
    ...
    iput-object v7, p0, mSessionsDir:Ljava/io/File;

    .line 209
    iget-object v7, p0, mSessionsDir:Ljava/io/File;
    ...
    .line 214
    iget-object v7, p0, mStagingDir:Ljava/io/File;

    sget-object v9, sStageFilter:Ljava/io/FilenameFilter;
    ...
    invoke-direct {p0, v7}, buildAppIconFile(I)Ljava/io/File;
...
.method private buildInternalStageDir(I)Ljava/io/File;
    ...
    iget-object v1, p0, mStagingDir:Ljava/io/File;
...
.method private createSessionInternal(Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;I)I
    ...
    :try_end_10a
    .catchall {:try_start_ea .. :try_end_10a} :catchall_1a5
    ...
    monitor-exit v29
    :try_end_140
    .catchall {:try_start_114 .. :try_end_140} :catchall_13e
    ...
    :try_end_1a3
    .catchall {:try_start_1a0 .. :try_end_1a3} :catchall_1a5
    ...
    throw v2
    :try_end_1c5
    .catchall {:try_start_1aa .. :try_end_1c5} :catchall_1a5
    ...
    invoke-direct {v0, v9}, buildInternalStageDir(I)Ljava/io/File;
    ...
    monitor-exit v29
    :try_end_253
    .catchall {:try_start_1e2 .. :try_end_253} :catchall_13e
    ...
    :try_end_267
    .catchall {:try_start_262 .. :try_end_267} :catchall_13e
...
.method public allocateInternalStageDirLegacy()Ljava/io/File;
    ...
    .line 285
    invoke-direct {p0, v1}, buildInternalStageDir(I)Ljava/io/File;

    move-result-object v2

    .line 286
    .local v2, "stageDir":Ljava/io/File;
    invoke-static {v2}, prepareInternalStageDir(Ljava/io/File;)V
    :try_end_14
