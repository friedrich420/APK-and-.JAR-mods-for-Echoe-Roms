...
.method static constructor <clinit>()V
    ...
    sput-object v0, AMS_VERBOSE_PROP:Ljava/lang/String;

    .line 38
    sget v0, LOG_LEVEL_DENIALS:I

    sput v0, AMS_VERBOSE_DEFAULT:I
    ...
    sput-object v0, mAMSLogger:Lcom/android/server/am/AMSLogger;
...
.method private static copyStackTraceToAMSLog(ILjava/lang/String;Ljava/lang/String;JLjava/lang/String;)V
    ...
    .line 292
    :cond_b1
    sget-object v16, mAMSLogger:Lcom/android/server/am/AMSLogger;
    ...
    .line 293
    :try_start_b4
    sget-object v15, mLogger:Ljava/util/logging/Logger;
...
.method private static getCurrentLogLevel()I
    ...
    .prologue
    .line 91
    sget-object v0, AMS_VERBOSE_PROP:Ljava/lang/String;

    sget v1, AMS_VERBOSE_DEFAULT:I
...
.method public static declared-synchronized getLogger()Lcom/android/server/am/AMSLogger;
    ...
    sput-object v0, mAMSTxt:Lcom/android/server/am/AMSLogger$AMSHandler;
    :try_end_29
    ...
    sput-object v0, mFormatterTxt:Lcom/android/server/am/AMSLogger$AMSFormatter;

    .line 71
    sget-object v0, mAMSTxt:Lcom/android/server/am/AMSLogger$AMSHandler;

    sget-object v1, mFormatterTxt:Lcom/android/server/am/AMSLogger$AMSFormatter;
    ...
    sget-object v1, mAMSTxt:Lcom/android/server/am/AMSLogger$AMSHandler;
    ...
    :cond_4d
    :try_start_4d
    sget-object v0, mAMSLogger:Lcom/android/server/am/AMSLogger;
    :try_end_4f
...
.method public log(ZLandroid/content/pm/ApplicationInfo;ZLandroid/content/pm/ApplicationInfo;ZLandroid/content/Intent;I)V
    ...
    .line 181
    invoke-virtual {p0, p7, v1}, logStackTrace(ILjava/lang/String;)V
...
.method public logStackTrace(ILjava/lang/String;)V
    ...
    invoke-static {v2}, getTraceFileSize(Ljava/lang/String;)J
    ...
    .line 217
    :try_start_29
    sget-object v3, LOG_NEW:Ljava/lang/String;

    move v1, p1

    move-object v6, p2

    invoke-static/range {v1 .. v6}, copyStackTraceToAMSLog(ILjava/lang/String;Ljava/lang/String;JLjava/lang/String;)V
    :try_end_30
    ...
    .end local v7    # "observer":Landroid/os/FileObserver;
    :cond_68
    sget-object v3, mAMSLogger:Lcom/android/server/am/AMSLogger;

    monitor-enter v3

    .line 223
    :try_start_6b
    sget-object v1, mLogger:Ljava/util/logging/Logger;
