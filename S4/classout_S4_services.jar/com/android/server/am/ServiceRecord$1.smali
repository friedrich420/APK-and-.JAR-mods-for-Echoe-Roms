...
.method constructor <init>(Lcom/android/server/am/ServiceRecord;Landroid/app/Notification;Ljava/lang/String;III)V
    ...
    iput-object p2, p0, val$localForegroundNoti:Landroid/app/Notification;
...
.method public run()V
    ...
    :cond_b
    :try_start_b
    iget-object v1, p0, val$localForegroundNoti:Landroid/app/Notification;
    ...
    iget-object v2, p0, this$0:Lcom/android/server/am/ServiceRecord;
    ...
    .line 438
    iget-object v1, p0, this$0:Lcom/android/server/am/ServiceRecord;
    ...
    :try_end_3f
    .catch Ljava/lang/RuntimeException; {:try_start_b .. :try_end_3f} :catch_c4
    ...
    iget-object v3, p0, this$0:Lcom/android/server/am/ServiceRecord;
    ...
    :try_end_b6
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_40 .. :try_end_b6} :catch_fe
    .catch Ljava/lang/RuntimeException; {:try_start_40 .. :try_end_b6} :catch_c4
    ...
    throw v1
    :try_end_c4
    .catch Ljava/lang/RuntimeException; {:try_start_b6 .. :try_end_c4} :catch_c4
    ...
    iget v2, p0, val$appUid:I

    iget v3, p0, val$appPid:I
    ...
    iget v3, p0, val$appUid:I

    iget v4, p0, val$appPid:I

    const/4 v5, 0x0

    iget v6, p0, val$localForegroundId:I

    iget-object v7, p0, val$localForegroundNoti:Landroid/app/Notification;

    iget-object v9, p0, this$0:Lcom/android/server/am/ServiceRecord;
    ...
    :try_end_11c
    .catch Ljava/lang/RuntimeException; {:try_start_ff .. :try_end_11c} :catch_c4
