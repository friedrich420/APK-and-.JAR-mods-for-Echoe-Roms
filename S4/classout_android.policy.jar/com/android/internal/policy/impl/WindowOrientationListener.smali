...
.method static constructor <clinit>()V
    ...
    .line 71
    sput v1, sCurrentAppOrientation:I

    .line 72
    sput v1, sCurrentRotation:I

    .line 73
    const/4 v0, 0x0

    sput-object v0, sWindowOrientationListener:Lcom/android/internal/policy/impl/WindowOrientationListener;

    .line 95
    sput v1, sCurrentAppAngle:I

    .line 106
    sput-boolean v2, bCurrentAppOrientation:Z
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/Handler;I)V
    ...
    .line 96
    iput-boolean v5, p0, mHasSmartRotation:Z
    ...
    iput-boolean v1, p0, mbSContext:Z
    ...
    .line 138
    sput-boolean v5, mbResultFaceDectection:Z

    .line 139
    iput-boolean v4, p0, mEnabled_sensor:Z
    ...
    iput-boolean v1, p0, mHasSmartRotation:Z
    ...
    iget-boolean v3, p0, mHasSmartRotation:Z
    ...
    .line 144
    iget-boolean v1, p0, mbSContext:Z
    ...
    iput-object v1, p0, mSContextAutoRotationListener:Lcom/android/internal/policy/impl/WindowOrientationListener$SContextListenerImpl;

    .line 149
    iget-object v1, p0, mSContextAutoRotationListener:Lcom/android/internal/policy/impl/WindowOrientationListener$SContextListenerImpl;

    iget-boolean v2, p0, mHasSmartRotation:Z
    ...
    .line 161
    :cond_ad
    iput-boolean v4, p0, mUsedautorotioansensor:Z

    .line 168
    iget-boolean v1, p0, mUsedautorotioansensor:Z
    ...
    sput-boolean v4, bCurrentAppOrientation:Z
    ...
    .line 179
    iput-boolean v5, p0, mUsedautorotioansensor:Z
    ...
    iput-object v1, p0, mSOSensorEventListener:Lcom/android/internal/policy/impl/WindowOrientationListener$ScreenOrientationEventListenerImpl;

    .line 186
    iget-object v1, p0, mSOSensorEventListener:Lcom/android/internal/policy/impl/WindowOrientationListener$ScreenOrientationEventListenerImpl;
    ...
    :cond_f4
    :goto_f4
    sput-object p0, sWindowOrientationListener:Lcom/android/internal/policy/impl/WindowOrientationListener;
    ...
    iput-object v1, p0, mSensorEventListener:Lcom/android/internal/policy/impl/WindowOrientationListener$SensorEventListenerImpl;
...
.method static synthetic access$300()Z
    ...
    .prologue
    .line 66
    sget-boolean v0, mbResultFaceDectection:Z
...
.method public static setCurrentAppOrientation(I)V
    ...
    sget v2, sCurrentAppOrientation:I
    ...
    .line 362
    sget-boolean v0, bCurrentAppOrientation:Z
    ...
    .line 369
    sget-object v0, sWindowOrientationListener:Lcom/android/internal/policy/impl/WindowOrientationListener;
    ...
    iget-boolean v0, v0, mEnabled_sensor:Z
    ...
    iget-object v1, v0, mSensorManager:Landroid/hardware/SensorManager;

    sget-object v0, sWindowOrientationListener:Lcom/android/internal/policy/impl/WindowOrientationListener;

    iget-boolean v0, v0, mUsedautorotioansensor:Z

    if-eqz v0, :cond_73

    sget-object v0, sWindowOrientationListener:Lcom/android/internal/policy/impl/WindowOrientationListener;

    iget-object v0, v0, mSOSensorEventListener:Lcom/android/internal/policy/impl/WindowOrientationListener$ScreenOrientationEventListenerImpl;

    :goto_5f
    sget-object v2, sWindowOrientationListener:Lcom/android/internal/policy/impl/WindowOrientationListener;

    iget-object v2, v2, mSensor:Landroid/hardware/Sensor;

    sget-object v3, sWindowOrientationListener:Lcom/android/internal/policy/impl/WindowOrientationListener;

    iget v3, v3, mRate:I

    sget-object v4, sWindowOrientationListener:Lcom/android/internal/policy/impl/WindowOrientationListener;

    iget-object v4, v4, mHandler:Landroid/os/Handler;
    ...
    iput-boolean v5, v0, mEnabled_sensor:Z
    ...
    iget-object v0, v0, mSensorEventListener:Lcom/android/internal/policy/impl/WindowOrientationListener$SensorEventListenerImpl;
    ...
    iput-boolean v1, v0, mEnabled_sensor:Z
...
.method public disable()V
    ...
    iget-object v2, p0, mSContextAutoRotationListener:Lcom/android/internal/policy/impl/WindowOrientationListener$SContextListenerImpl;
    ...
    .line 254
    iget-object v0, p0, mSContextAutoRotationListener:Lcom/android/internal/policy/impl/WindowOrientationListener$SContextListenerImpl;
    ...
    iget-boolean v0, p0, mUsedautorotioansensor:Z

    if-eqz v0, :cond_4a

    iget-object v0, p0, mSOSensorEventListener:Lcom/android/internal/policy/impl/WindowOrientationListener$ScreenOrientationEventListenerImpl;
    ...
    .line 262
    :cond_4a
    iget-object v0, p0, mSensorEventListener:Lcom/android/internal/policy/impl/WindowOrientationListener$SensorEventListenerImpl;
    :try_end_4c
...
.method public enable()V
    ...
    sput-boolean v0, mbResultFaceDectection:Z
    ...
    .line 234
    :goto_3e
    iget-boolean v0, p0, mEnabled_sensor:Z
...
.method public getProposedRotation()I
    ...
    .line 300
    sget-boolean v2, mbResultFaceDectection:Z
    ...
    sget-boolean v4, mbResultFaceDectection:Z
...
.method public setFaceDetectionResult(Z)V
    ...
    .prologue
    .line 324
    sput-boolean p1, mbResultFaceDectection:Z
