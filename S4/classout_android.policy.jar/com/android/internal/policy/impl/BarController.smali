...
.method static synthetic access$402(Lcom/android/internal/policy/impl/BarController;Lcom/android/internal/statusbar/IStatusBarService;)Lcom/android/internal/statusbar/IStatusBarService;
    ...
    .prologue
    .line 37
    iput-object p1, p0, mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;
...
.method private setTransientBarState(I)V
    ...
    iput-wide v0, p0, mLastTranslucent:J
...
.method public adjustSystemUiVisibilityLw(II)V
    ...
    invoke-direct {p0, v0}, setTransientBarState(I)V

    .line 101
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, setBarShowingLw(Z)Z
...
.method public applyTranslucentFlagLw(Landroid/view/WindowManagerPolicy$WindowState;II)I
    ...
    .line 113
    .local v0, "fl":I
    iget v1, p0, mTranslucentWmFlag:I
...
.method public checkHiddenLw()Z
    ...
    invoke-direct {p0, v2}, updateStateLw(I)Z

    .line 198
    :cond_22
    iget v2, p0, mTransientBarState:I
    ...
    .line 200
    invoke-direct {p0, v1}, setTransientBarState(I)V

    .line 201
    iget-boolean v2, p0, mPendingShow:Z
    ...
    .line 203
    iput-boolean v1, p0, mPendingShow:Z
...
.method public setBarShowingLw(Z)Z
    ...
    .line 137
    iget-object v7, p0, mWin:Landroid/view/WindowManagerPolicy$WindowState;
    ...
    .line 139
    iput-boolean v6, p0, mPendingShow:Z
    ...
    invoke-direct {p0, v4, v3, v7, v0}, computeStateLw(ZZLandroid/view/WindowManagerPolicy$WindowState;Z)I

    move-result v1

    .line 146
    .local v1, "state":I
    invoke-direct {p0, v1}, updateStateLw(I)Z
...
.method public updateVisibilityLw(ZII)I
    ...
    :cond_6
    invoke-virtual {p0}, isTransientShowing()Z

    move-result v1

    if-nez v1, :cond_12

    invoke-virtual {p0}, isTransientShowRequested()Z
