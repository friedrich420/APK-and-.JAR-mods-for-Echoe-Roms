...
.method static synthetic access$002(Lcom/sec/android/provider/logsprovider/CountryMonitor;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/sec/android/provider/logsprovider/CountryMonitor;
...
.method public declared-synchronized getCountryIso()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/sec/android/provider/logsprovider/CountryMonitor;->mCurrentCountryIso:Ljava/lang/String;

    if-nez v2, :cond_2

    .line 48
    iget-object v2, p0, Lcom/sec/android/provider/logsprovider/CountryMonitor;->mContext:Landroid/content/Context;
    ...
    iput-object v2, p0, Lcom/sec/android/provider/logsprovider/CountryMonitor;->mCurrentCountryIso:Ljava/lang/String;

    .line 59
    new-instance v2, Lcom/sec/android/provider/logsprovider/CountryMonitor$1;

    invoke-direct {v2, p0}, Lcom/sec/android/provider/logsprovider/CountryMonitor$1;-><init>(Lcom/sec/android/provider/logsprovider/CountryMonitor;)V
