...
.method private constructor <init>()V
    ...
    iput-object v0, p0, mOperations:[Landroid/database/sqlite/SQLiteConnection$Operation;
...
.method private endOperationDeferLogLocked(I)Z
    ...
    .line 1571
    invoke-direct {p0, p1}, getOperationLocked(I)Landroid/database/sqlite/SQLiteConnection$Operation;
...
.method private getOperationLocked(I)Landroid/database/sqlite/SQLiteConnection$Operation;
    ...
    .line 1598
    .local v0, "index":I
    iget-object v2, p0, mOperations:[Landroid/database/sqlite/SQLiteConnection$Operation;
...
.method public beginOperation(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .prologue
    .line 1502
    iget-object v5, p0, mOperations:[Landroid/database/sqlite/SQLiteConnection$Operation;
    ...
    .line 1504
    .local v2, "index":I
    iget-object v4, p0, mOperations:[Landroid/database/sqlite/SQLiteConnection$Operation;
    ...
    .end local v1    # "i":I
    :cond_6d
    invoke-direct {p0, v2}, newOperationCookieLocked(I)I
...
.method public describeCurrentOperation()Ljava/lang/String;
    ...
    .prologue
    .line 1603
    iget-object v3, p0, mOperations:[Landroid/database/sqlite/SQLiteConnection$Operation;
...
.method public endOperation(I)V
    ...
    .prologue
    .line 1551
    iget-object v1, p0, mOperations:[Landroid/database/sqlite/SQLiteConnection$Operation;

    monitor-enter v1

    .line 1552
    :try_start_3
    invoke-direct {p0, p1}, endOperationDeferLogLocked(I)Z
    ...
    invoke-direct {p0, p1, v0}, logOperationLocked(ILjava/lang/String;)V
...
.method public logOperation(ILjava/lang/String;)V
    ...
    .line 1566
    :try_start_3
    invoke-direct {p0, p1, p2}, logOperationLocked(ILjava/lang/String;)V
