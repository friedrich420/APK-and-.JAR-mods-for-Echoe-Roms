...
.method private constructor <init>(Landroid/database/sqlite/SQLiteDatabaseConfiguration;)V
    ...
    iput-object v0, p0, mConnectionLeaked:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    .line 151
    invoke-direct {p0}, setMaxConnectionPoolSizeLocked()V
...
.method static synthetic access$100(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;)V
    ...
    .prologue
    .line 72
    invoke-direct {p0, p1}, cancelConnectionWaiterLocked(Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;)V
...
.method private cancelConnectionWaiterLocked(Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;)V
    ...
    iget-object v0, p0, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    .line 798
    invoke-direct {p0}, wakeConnectionWaitersLocked()V
    ...
    iput-object v2, p0, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
...
.method private closeAvailableConnectionsAndLogExceptionsLocked()V
    ...
    .prologue
    .line 563
    invoke-direct {p0}, closeAvailableNonPrimaryConnectionsAndLogExceptionsLocked()V

    .line 565
    iget-object v0, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    invoke-direct {p0, v0}, closeConnectionAndLogExceptionsLocked(Landroid/database/sqlite/SQLiteConnection;)V

    .line 567
    const/4 v0, 0x0

    iput-object v0, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
...
.method private closeAvailableNonPrimaryConnectionsAndLogExceptionsLocked()V
    ...
    .prologue
    .line 573
    iget-object v2, p0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v2}, closeConnectionAndLogExceptionsLocked(Landroid/database/sqlite/SQLiteConnection;)V
...
.method private closeExcessConnectionsAndLogExceptionsLocked()V
    ...
    .prologue
    .line 582
    iget-object v3, p0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
    ...
    iget v3, p0, mMaxConnectionPoolSize:I
...
.method private discardAcquiredConnectionsLocked()V
    ...
    invoke-direct {p0, v0}, markAcquiredConnectionsLocked(Landroid/database/sqlite/SQLiteConnectionPool$AcquiredConnectionStatus;)V
...
.method private dispose(Z)V
    ...
    .line 252
    :try_start_15
    invoke-direct {p0}, throwIfClosedLocked()V
    ...
    .line 256
    invoke-direct {p0}, closeAvailableConnectionsAndLogExceptionsLocked()V

    .line 258
    iget-object v1, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    invoke-direct {p0, v4}, changeLabel(Ljava/lang/String;)Ljava/lang/String;
...
.method private finishAcquireConnectionLocked(Landroid/database/sqlite/SQLiteConnection;I)V
    ...
    .line 976
    iget-object v2, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    .line 980
    invoke-direct {p0, p1}, closeConnectionAndLogExceptionsLocked(Landroid/database/sqlite/SQLiteConnection;)V
...
.method private isSessionBlockingImportantConnectionWaitersLocked(ZI)Z
    ...
    .prologue
    .line 987
    iget-object v1, p0, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    .line 989
    invoke-static {p2}, getPriority(I)I
...
.method private logConnectionPoolBusyLocked(JI)V
    ...
    iget-object v11, p0, mConfiguration:Landroid/database/sqlite/SQLiteDatabaseConfiguration;

    iget-object v11, v11, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->label:Ljava/lang/String;

    invoke-direct {p0, v11}, changeLabel(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v10, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    :cond_90
    iget-object v10, p0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
...
.method private markAcquiredConnectionsLocked(Landroid/database/sqlite/SQLiteConnectionPool$AcquiredConnectionStatus;)V
    ...
    .prologue
    .line 637
    iget-object v6, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
...
.method private obtainConnectionWaiterLocked(Ljava/lang/Thread;JIZLjava/lang/String;I)Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    .line 1034
    iget-object v0, p0, mConnectionWaiterPool:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    iput-object v1, p0, mConnectionWaiterPool:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
...
.method public static open(Landroid/database/sqlite/SQLiteDatabaseConfiguration;)Landroid/database/sqlite/SQLiteConnectionPool;
    ...
    invoke-direct {v0, p0}, <init>(Landroid/database/sqlite/SQLiteDatabaseConfiguration;)V
...
.method private open()V
    ...
    invoke-direct {p0, v0, v1}, openConnectionLocked(Landroid/database/sqlite/SQLiteDatabaseConfiguration;Z)Landroid/database/sqlite/SQLiteConnection;
...
.method private openConnectionLocked(Landroid/database/sqlite/SQLiteDatabaseConfiguration;Z)Landroid/database/sqlite/SQLiteConnection;
    ...
    .prologue
    .line 511
    iget v0, p0, mNextConnectionId:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, mNextConnectionId:I
...
.method public static openSecure(Landroid/database/sqlite/SQLiteDatabaseConfiguration;[B)Landroid/database/sqlite/SQLiteConnectionPool;
    ...
    .line 198
    .local v0, "pool":Landroid/database/sqlite/SQLiteConnectionPool;
    invoke-direct {v0, p1}, openSecure([B)V
...
.method private openSecure([B)V
    ...
    invoke-direct {p0, v0, v1, p1}, openSecureConnectionLocked(Landroid/database/sqlite/SQLiteDatabaseConfiguration;Z[B)Landroid/database/sqlite/SQLiteConnection;
...
.method private reconfigureAllConnectionsLocked()V
    ...
    .prologue
    .line 607
    iget-object v5, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    :cond_b
    :goto_b
    iget-object v5, p0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    invoke-direct {p0, v5}, closeConnectionAndLogExceptionsLocked(Landroid/database/sqlite/SQLiteConnection;)V

    .line 614
    const/4 v5, 0x0

    iput-object v5, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    invoke-direct {p0, v5}, markAcquiredConnectionsLocked(Landroid/database/sqlite/SQLiteConnectionPool$AcquiredConnectionStatus;)V
...
.method private recycleConnectionWaiterLocked(Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;)V
    ...
    .line 1057
    iput-object p1, p0, mConnectionWaiterPool:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
...
.method private setMaxConnectionPoolSizeLocked()V
    ...
    iput v0, p0, mMaxConnectionPoolSize:I
...
.method private tryAcquireNonPrimaryConnectionLocked(Ljava/lang/String;I)Landroid/database/sqlite/SQLiteConnection;
    ...
    .prologue
    .line 936
    iget-object v4, p0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
    ...
    .line 944
    invoke-direct {p0, v1, p2}, finishAcquireConnectionLocked(Landroid/database/sqlite/SQLiteConnection;I)V
    ...
    .end local v1    # "connection":Landroid/database/sqlite/SQLiteConnection;
    :cond_38
    iget-object v4, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    iget-object v4, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    .line 961
    :cond_44
    iget v4, p0, mMaxConnectionPoolSize:I
    ...
    invoke-direct {p0, v4, v5}, openConnectionLocked(Landroid/database/sqlite/SQLiteDatabaseConfiguration;Z)Landroid/database/sqlite/SQLiteConnection;
...
.method private tryAcquirePrimaryConnectionLocked(I)Landroid/database/sqlite/SQLiteConnection;
    ...
    .line 909
    iget-object v1, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    .line 911
    iput-object v3, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;

    .line 912
    invoke-direct {p0, v1, p1}, finishAcquireConnectionLocked(Landroid/database/sqlite/SQLiteConnection;I)V
    ...
    invoke-direct {p0, v3, v4}, openConnectionLocked(Landroid/database/sqlite/SQLiteDatabaseConfiguration;Z)Landroid/database/sqlite/SQLiteConnection;
...
.method private waitForConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)Landroid/database/sqlite/SQLiteConnection;
    ...
    .line 664
    :try_start_c
    invoke-direct/range {p0 .. p0}, throwIfClosedLocked()V
    ...
    .line 674
    invoke-direct/range {p0 .. p2}, tryAcquireNonPrimaryConnectionLocked(Ljava/lang/String;I)Landroid/database/sqlite/SQLiteConnection;
    ...
    invoke-direct {v0, v1}, tryAcquirePrimaryConnectionLocked(I)Landroid/database/sqlite/SQLiteConnection;
    ...
    :cond_2b
    invoke-static/range {p2 .. p2}, getPriority(I)I
    ...
    invoke-direct/range {v4 .. v11}, obtainConnectionWaiterLocked(Ljava/lang/Thread;JIZLjava/lang/String;I)Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    iget-object v0, v0, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    iget-object v4, v0, mConnectionLeaked:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 730
    :try_start_91
    invoke-direct/range {p0 .. p0}, wakeConnectionWaitersLocked()V
    ...
    invoke-direct {v0, v1}, recycleConnectionWaiterLocked(Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;)V
    ...
    iput-object v0, v1, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    invoke-direct {v0, v10, v11, v1}, logConnectionPoolBusyLocked(JI)V
    :try_end_107
...
.method private wakeConnectionWaitersLocked()V
    ...
    iget-object v7, p0, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    invoke-direct {p0, v8, v9}, tryAcquireNonPrimaryConnectionLocked(Ljava/lang/String;I)Landroid/database/sqlite/SQLiteConnection;
    ...
    invoke-direct {p0, v8}, tryAcquirePrimaryConnectionLocked(I)Landroid/database/sqlite/SQLiteConnection;
    ...
    :cond_4e
    iput-object v5, p0, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
...
.method public acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)Landroid/database/sqlite/SQLiteConnection;
    ...
    .prologue
    .line 397
    invoke-direct {p0, p1, p2, p3}, waitForConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)Landroid/database/sqlite/SQLiteConnection;
...
.method public collectDbStats(Ljava/util/ArrayList;)V
    ...
    .line 494
    :try_start_3
    iget-object v2, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
...
.method public dump(Landroid/util/Printer;Z)V
    ...
    iget-object v13, v0, mConfiguration:Landroid/database/sqlite/SQLiteDatabaseConfiguration;
    ...
    iget v13, v0, mMaxConnectionPoolSize:I
    ...
    iget-object v11, v0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    iget-object v11, v0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
    ...
    iget-object v11, v0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    iget-object v11, v0, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
    ...
    iget-object v10, v0, mConnectionWaiterQueue:Landroid/database/sqlite/SQLiteConnectionPool$ConnectionWaiter;
...
.method public exportDB(Ljava/lang/String;)V
    ...
    .line 364
    iget-object v0, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    iget-object v0, p0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
...
.method onConnectionLeaked()V
    ...
    invoke-direct {p0, v2}, changeLabel(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 549
    iget-object v0, p0, mConnectionLeaked:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public reconfigure(Landroid/database/sqlite/SQLiteDatabaseConfiguration;)V
    ...
    .line 297
    iget-object v5, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    .line 307
    sget-boolean v5, $assertionsDisabled:Z
    ...
    .line 316
    iget-object v3, p0, mAcquiredConnections:Ljava/util/WeakHashMap;
    ...
    invoke-direct {p0, p1, v3}, openConnectionLocked(Landroid/database/sqlite/SQLiteDatabaseConfiguration;Z)Landroid/database/sqlite/SQLiteConnection;
    ...
    .line 340
    invoke-direct {p0}, discardAcquiredConnectionsLocked()V

    .line 342
    iput-object v1, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    .line 350
    invoke-direct {p0}, closeExcessConnectionsAndLogExceptionsLocked()V

    .line 351
    invoke-direct {p0}, reconfigureAllConnectionsLocked()V
    :try_end_9c
...
.method public releaseConnection(Landroid/database/sqlite/SQLiteConnection;)V
    ...
    .line 424
    invoke-direct {p0, p1, v0}, recycleConnectionLocked(Landroid/database/sqlite/SQLiteConnection;Landroid/database/sqlite/SQLiteConnectionPool$AcquiredConnectionStatus;)Z
    ...
    .line 426
    :cond_3b
    iput-object p1, p0, mAvailablePrimaryConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    .line 429
    :cond_41
    iget-object v1, p0, mAvailableNonPrimaryConnections:Ljava/util/ArrayList;
...
.method public shouldYieldConnection(Landroid/database/sqlite/SQLiteConnection;I)Z
    ...
    invoke-direct {p0, v0, p2}, isSessionBlockingImportantConnectionWaitersLocked(ZI)Z
