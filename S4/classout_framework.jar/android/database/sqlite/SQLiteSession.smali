...
.method public constructor <init>(Landroid/database/sqlite/SQLiteConnectionPool;)V
    ...
    .line 232
    :cond_d
    iput-object p1, p0, mConnectionPool:Landroid/database/sqlite/SQLiteConnectionPool;
...
.method private acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)V
    ...
    .prologue
    .line 903
    iget-object v0, p0, mConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    iget v0, p0, mConnectionUseCount:I
    ...
    .line 905
    :cond_12
    iget-object v0, p0, mConnectionPool:Landroid/database/sqlite/SQLiteConnectionPool;
    ...
    iput-object v0, p0, mConnection:Landroid/database/sqlite/SQLiteConnection;

    .line 907
    iput p2, p0, mConnectionFlags:I
    ...
    iput v0, p0, mConnectionUseCount:I
...
.method private beginTransactionUnchecked(ILandroid/database/sqlite/SQLiteTransactionListener;ILandroid/os/CancellationSignal;)V
    ...
    .line 309
    :cond_6
    iget-object v2, p0, mTransactionStack:Landroid/database/sqlite/SQLiteSession$Transaction;

    if-nez v2, :cond_d

    .line 310
    invoke-direct {p0, v3, p3, p4}, acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)V
    ...
    .line 327
    iget-object v2, p0, mConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    :cond_21
    :try_start_21
    invoke-direct {p0, p1, p2}, obtainTransaction(ILandroid/database/sqlite/SQLiteTransactionListener;)Landroid/database/sqlite/SQLiteSession$Transaction;
    ...
    .line 347
    iput-object v1, p0, mTransactionStack:Landroid/database/sqlite/SQLiteSession$Transaction;
    :try_end_2b
    ...
    .line 350
    invoke-direct {p0}, releaseConnection()V
    ...
    iget-object v3, p0, mTransactionStack:Landroid/database/sqlite/SQLiteSession$Transaction;
...
.method private endTransactionUnchecked(Landroid/os/CancellationSignal;Z)V
    ...
    .line 409
    :cond_6
    iget-object v4, p0, mTransactionStack:Landroid/database/sqlite/SQLiteSession$Transaction;
    ...
    iput-object v6, p0, mTransactionStack:Landroid/database/sqlite/SQLiteSession$Transaction;

    .line 428
    invoke-direct {p0, v4}, recycleTransaction(Landroid/database/sqlite/SQLiteSession$Transaction;)V

    .line 430
    iget-object v6, p0, mTransactionStack:Landroid/database/sqlite/SQLiteSession$Transaction;
    ...
    .line 437
    :try_start_3d
    iget-object v5, p0, mConnection:Landroid/database/sqlite/SQLiteConnection;
...
.method private executeSpecial(Ljava/lang/String;[Ljava/lang/Object;ILandroid/os/CancellationSignal;)Z
    ...
    invoke-virtual {p0, v2, v3, p3, p4}, beginTransaction(ILandroid/database/sqlite/SQLiteTransactionListener;ILandroid/os/CancellationSignal;)V

    goto :goto_e

    .line 890
    :pswitch_15
    invoke-virtual {p0}, setTransactionSuccessful()V

    .line 891
    invoke-virtual {p0, p4}, endTransaction(Landroid/os/CancellationSignal;)V
...
.method private obtainTransaction(ILandroid/database/sqlite/SQLiteTransactionListener;)Landroid/database/sqlite/SQLiteSession$Transaction;
    ...
    .line 947
    iget-object v0, p0, mTransactionPool:Landroid/database/sqlite/SQLiteSession$Transaction;
    ...
    iput-object v1, p0, mTransactionPool:Landroid/database/sqlite/SQLiteSession$Transaction;
...
.method private recycleTransaction(Landroid/database/sqlite/SQLiteSession$Transaction;)V
    ...
    .line 964
    iput-object p1, p0, mTransactionPool:Landroid/database/sqlite/SQLiteSession$Transaction;
...
.method private releaseConnection()V
    ...
    iget-object v1, p0, mConnection:Landroid/database/sqlite/SQLiteConnection;
    ...
    .line 919
    iput-object v2, p0, mConnection:Landroid/database/sqlite/SQLiteConnection;
...
.method private throwIfNestedTransaction()V
    ...
    .prologue
    .line 940
    invoke-virtual {p0}, hasNestedTransaction()Z
...
.method private throwIfNoTransaction()V
    ...
    .prologue
    .line 925
    iget-object v0, p0, mTransactionStack:Landroid/database/sqlite/SQLiteSession$Transaction;
...
.method private yieldTransactionUnchecked(JLandroid/os/CancellationSignal;)Z
    ...
    .line 530
    :cond_6
    iget-object v4, p0, mConnectionPool:Landroid/database/sqlite/SQLiteConnectionPool;

    iget-object v5, p0, mConnection:Landroid/database/sqlite/SQLiteConnection;

    iget v6, p0, mConnectionFlags:I
    ...
    .line 536
    .local v1, "listener":Landroid/database/sqlite/SQLiteTransactionListener;
    iget v0, p0, mConnectionFlags:I

    .line 537
    .local v0, "connectionFlags":I
    invoke-direct {p0, p3, v3}, endTransactionUnchecked(Landroid/os/CancellationSignal;Z)V
    ...
    :cond_2a
    :goto_2a
    invoke-direct {p0, v2, v1, v0, p3}, beginTransactionUnchecked(ILandroid/database/sqlite/SQLiteTransactionListener;ILandroid/os/CancellationSignal;)V
...
.method public beginTransaction(ILandroid/database/sqlite/SQLiteTransactionListener;ILandroid/os/CancellationSignal;)V
    ...
    .prologue
    .line 297
    invoke-direct {p0}, throwIfTransactionMarkedSuccessful()V

    .line 298
    invoke-direct {p0, p1, p2, p3, p4}, beginTransactionUnchecked(ILandroid/database/sqlite/SQLiteTransactionListener;ILandroid/os/CancellationSignal;)V
...
.method public changePassword([B)V
    ...
    invoke-direct {p0, v1, v0, v1}, acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)V
...
.method public endTransaction(Landroid/os/CancellationSignal;)V
    ...
    .prologue
    .line 398
    invoke-direct {p0}, throwIfNoTransaction()V
    ...
    invoke-direct {p0, p1, v0}, endTransactionUnchecked(Landroid/os/CancellationSignal;Z)V
...
.method public execute(Ljava/lang/String;[Ljava/lang/Object;ILandroid/os/CancellationSignal;)V
    ...
    .line 613
    :cond_b
    invoke-direct {p0, p1, p2, p3, p4}, executeSpecial(Ljava/lang/String;[Ljava/lang/Object;ILandroid/os/CancellationSignal;)Z
    ...
    .line 617
    :cond_12
    invoke-direct {p0, p1, p3, p4}, acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)V
...
.method public executeForCursorWindow(Ljava/lang/String;[Ljava/lang/Object;Landroid/database/CursorWindow;IIZILandroid/os/CancellationSignal;)I
    ...
    invoke-direct {p0, p1, p2, v0, v1}, executeSpecial(Ljava/lang/String;[Ljava/lang/Object;ILandroid/os/CancellationSignal;)Z
    ...
    invoke-direct {p0, p1, v0, v1}, acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)V
...
.method public prepare(Ljava/lang/String;ILandroid/os/CancellationSignal;Landroid/database/sqlite/SQLiteStatementInfo;)V
    ...
    .line 586
    :cond_10
    invoke-direct {p0, p1, p2, p3}, acquireConnection(Ljava/lang/String;ILandroid/os/CancellationSignal;)V
...
.method public yieldTransaction(JZLandroid/os/CancellationSignal;)Z
    ...
    .line 507
    invoke-direct {p0}, throwIfNestedTransaction()V
    ...
    .line 509
    :cond_1a
    iget-object v1, p0, mTransactionStack:Landroid/database/sqlite/SQLiteSession$Transaction;
    ...
    .line 520
    invoke-direct {p0, p1, p2, p4}, yieldTransactionUnchecked(JLandroid/os/CancellationSignal;)Z
