...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)V
    ...
    .line 91
    iput-object p3, p0, mFactory:Landroid/database/sqlite/SQLiteDatabase$CursorFactory;

    .line 92
    iput p4, p0, mNewVersion:I

    .line 93
    iput-object p5, p0, mErrorHandler:Landroid/database/DatabaseErrorHandler;
...
.method private getDatabaseLocked(Z)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 180
    iget-object v4, p0, mDatabase:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 183
    iput-object v6, p0, mDatabase:Landroid/database/sqlite/SQLiteDatabase;

    .line 190
    :cond_10
    iget-boolean v4, p0, mIsInitializing:Z
    ...
    .line 186
    :cond_26
    iget-object v0, p0, mDatabase:Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_2c
    iput-boolean v4, p0, mIsInitializing:Z
    ...
    :cond_3b
    :goto_3b
    invoke-virtual {p0, v0}, onConfigure(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iget-object v7, p0, mName:Ljava/lang/String;
    ...
    iput-boolean v5, p0, mIsInitializing:Z

    .line 266
    if-eqz v0, :cond_8f

    iget-object v5, p0, mDatabase:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-boolean v4, p0, mEnableWriteAheadLogging:Z
    ...
    :goto_a4
    iget-object v8, p0, mFactory:Landroid/database/sqlite/SQLiteDatabase$CursorFactory;

    iget-object v9, p0, mErrorHandler:Landroid/database/DatabaseErrorHandler;
    ...
    iget-object v4, p0, mFactory:Landroid/database/sqlite/SQLiteDatabase$CursorFactory;

    const/4 v6, 0x1

    iget-object v7, p0, mErrorHandler:Landroid/database/DatabaseErrorHandler;
    ...
    .line 240
    :try_start_ef
    invoke-virtual {p0, v0}, onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 255
    :cond_fd
    invoke-virtual {p0, v0}, onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .end local v3    # "version":I
    :cond_126
    iput-object v0, p0, mDatabase:Landroid/database/sqlite/SQLiteDatabase;
    :try_end_128
    ...
    invoke-virtual {p0, v0, v3, v4}, onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    :try_end_13e
    ...
    invoke-virtual {p0, v0, v3, v4}, onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    :try_end_149
...
.method private getDatabaseLocked(ZZ[B)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 285
    iget-object v6, p0, mDatabase:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 288
    iput-object v8, p0, mDatabase:Landroid/database/sqlite/SQLiteDatabase;

    .line 295
    :cond_12
    iget-boolean v6, p0, mIsInitializing:Z
    ...
    :try_start_2e
    iput-boolean v6, p0, mIsInitializing:Z
    ...
    iget-object v9, p0, mName:Ljava/lang/String;
    ...
    iput-boolean v7, p0, mIsInitializing:Z

    .line 392
    if-eqz v0, :cond_93

    iget-object v7, p0, mDatabase:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-boolean v9, p0, mEnableWriteAheadLogging:Z

    if-eqz v9, :cond_e0

    :goto_d6
    iget-object v9, p0, mFactory:Landroid/database/sqlite/SQLiteDatabase$CursorFactory;

    iget-object v10, p0, mErrorHandler:Landroid/database/DatabaseErrorHandler;
    ...
    iget-boolean v6, p0, mEnableWriteAheadLogging:Z
    ...
    .line 346
    :cond_10b
    iget-object v6, p0, mFactory:Landroid/database/sqlite/SQLiteDatabase$CursorFactory;
    ...
    invoke-virtual {p0, v0, v5, v6}, onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    :try_end_16d
    ...
    invoke-virtual {p0, v0, v5, v6}, onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    :try_end_178
...
.method public declared-synchronized close()V
    ...
    :try_start_1
    iget-boolean v0, p0, mIsInitializing:Z
...
.method public getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_2
    invoke-direct {p0, v0}, getDatabaseLocked(Z)Landroid/database/sqlite/SQLiteDatabase;
...
.method public getReadableDatabase([B)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_3
    invoke-direct {p0, v0, v1, p1}, getDatabaseLocked(ZZ[B)Landroid/database/sqlite/SQLiteDatabase;
...
.method public setWriteAheadLoggingEnabled(Z)V
    ...
    .line 117
    :try_start_1
    iget-boolean v0, p0, mEnableWriteAheadLogging:Z
    ...
    :cond_20
    :goto_20
    iput-boolean p1, p0, mEnableWriteAheadLogging:Z
