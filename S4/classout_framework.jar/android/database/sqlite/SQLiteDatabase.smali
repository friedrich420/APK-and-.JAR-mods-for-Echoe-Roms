...
.method static constructor <clinit>()V
    ...
    sput-object v0, sActiveDatabases:Ljava/util/WeakHashMap;
    ...
    sput-object v0, CONFLICT_VALUES:[Ljava/lang/String;
...
.method private constructor <init>(Ljava/lang/String;ILandroid/database/sqlite/SQLiteDatabase$CursorFactory;Landroid/database/DatabaseErrorHandler;)V
    ...
    iput-object v0, p0, mThreadSession:Ljava/lang/ThreadLocal;

    .line 99
    const/4 v0, 0x0

    iput-object v0, p0, mIntegrityErrorString:Ljava/lang/String;
    ...
    iput-object v0, p0, mCloseGuardLocked:Ldalvik/system/CloseGuard;

    .line 2143
    const/4 v0, 0x0

    iput v0, p0, mCorrupt_code:I

    .line 261
    iput-object p3, p0, mCursorFactory:Landroid/database/sqlite/SQLiteDatabase$CursorFactory;
    ...
    :goto_21
    iput-object p4, p0, mErrorHandler:Landroid/database/DatabaseErrorHandler;
    ...
    iput-object v0, p0, mConfigurationLocked:Landroid/database/sqlite/SQLiteDatabaseConfiguration;
...
.method private beginTransaction(Landroid/database/sqlite/SQLiteTransactionListener;Z)V
    ...
    .prologue
    .line 508
    invoke-virtual {p0}, acquireReference()V

    .line 510
    :try_start_3
    invoke-virtual {p0}, getThreadSession()Landroid/database/sqlite/SQLiteSession;
    ...
    invoke-virtual {p0, v2}, getThreadDefaultConnectionFlags(Z)I
    ...
    .line 516
    invoke-virtual {p0}, releaseReference()V
...
.method private collectDbStats(Ljava/util/ArrayList;)V
    ...
    .line 2175
    :try_start_3
    iget-object v0, p0, mConnectionPoolLocked:Landroid/database/sqlite/SQLiteConnectionPool;
...
.method public static convert2PlainDB(Ljava/io/File;[BLjava/io/File;)V
    ...
    invoke-static {v3, v7, v6, v4, p1}, openSecureDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;[B)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 754
    invoke-virtual {v1}, getVersion()I

    move-result v2

    .line 755
    .local v2, "sourceDbVer":I
    invoke-virtual {v1}, close()V
    ...
    invoke-static {v3, v7, v4, v5}, openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {v0, v3}, execSQL(Ljava/lang/String;)V

    .line 758
    const-string/jumbo v3, "secureDb"

    invoke-direct {v0, v3}, exportDB(Ljava/lang/String;)V
    ...
    .line 760
    invoke-virtual {v0, v2}, setVersion(I)V
...
.method public static convert2SecureDB(Ljava/io/File;Ljava/io/File;[B)V
    ...
    invoke-static {v3, v7, v6, v4}, openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v3, v7, v4, v5, p2}, openSecureDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;[B)Landroid/database/sqlite/SQLiteDatabase;
...
.method public static create(Landroid/database/sqlite/SQLiteDatabase$CursorFactory;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0, p0, v1}, openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)Landroid/database/sqlite/SQLiteDatabase;
...
.method public static createSecureDatabase(Landroid/database/sqlite/SQLiteDatabase$CursorFactory;[B)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0, p0, v1, v2, p1}, openSecureDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;[B)Landroid/database/sqlite/SQLiteDatabase;
...
.method private dispose(Z)V
    ...
    .line 283
    :try_start_3
    iget-object v1, p0, mCloseGuardLocked:Ldalvik/system/CloseGuard;
    ...
    iput-object v1, p0, mConnectionPoolLocked:Landroid/database/sqlite/SQLiteConnectionPool;
    ...
    .line 295
    sget-object v2, sActiveDatabases:Ljava/util/WeakHashMap;

    monitor-enter v2

    .line 296
    :try_start_1e
    sget-object v1, sActiveDatabases:Ljava/util/WeakHashMap;
...
.method static dumpAll(Landroid/util/Printer;Z)V
    ...
    .prologue
    .line 2194
    invoke-static {}, getActiveDatabases()Ljava/util/ArrayList;
    ...
    invoke-direct {v0, p0, p1}, dump(Landroid/util/Printer;Z)V
...
.method private executeSql(Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 1788
    :try_start_e
    iget-boolean v2, p0, mHasAttachedDbsLocked:Z
    ...
    iput-boolean v2, p0, mHasAttachedDbsLocked:Z
    ...
    .line 1794
    :try_start_19
    invoke-virtual {p0}, disableWriteAheadLogging()V
...
.method private exportDB(Ljava/lang/String;)V
    ...
    .line 917
    :try_start_3
    invoke-direct {p0}, throwIfNotOpenLocked()V
...
.method static getDbStats()Ljava/util/ArrayList;
    ...
    .line 2168
    .local v0, "db":Landroid/database/sqlite/SQLiteDatabase;
    invoke-direct {v0, v1}, collectDbStats(Ljava/util/ArrayList;)V
...
.method private isReadOnlyLocked()Z
    ...
    .line 1821
    iget-object v1, p0, mConfigurationLocked:Landroid/database/sqlite/SQLiteDatabaseConfiguration;
...
.method private open()V
    ...
    invoke-virtual {p0, v1}, onCorruption(I)V
    ...
    invoke-virtual {p0}, getLabel()Ljava/lang/String;
...
.method public static openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {p0, p1, p2, v0}, openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public static openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v0, p0, p2, p1, p3}, <init>(Ljava/lang/String;ILandroid/database/sqlite/SQLiteDatabase$CursorFactory;Landroid/database/DatabaseErrorHandler;)V
...
.method private openInner()V
    ...
    :cond_14
    :try_start_14
    iget-object v0, p0, mConfigurationLocked:Landroid/database/sqlite/SQLiteDatabaseConfiguration;
    ...
    iput-object v0, p0, mConnectionPoolLocked:Landroid/database/sqlite/SQLiteConnectionPool;

    .line 895
    iget-object v0, p0, mCloseGuardLocked:Ldalvik/system/CloseGuard;
    ...
    .line 899
    :try_start_27
    sget-object v0, sActiveDatabases:Ljava/util/WeakHashMap;
...
.method public static openOrCreateDatabase(Ljava/io/File;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0, p1}, openOrCreateDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public static openOrCreateDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {p0, p1, v0, v1}, openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public static openOrCreateDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;Landroid/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {p0, p1, v0, p2}, openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public static openSecureDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;[B)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 746
    .local v0, "db":Landroid/database/sqlite/SQLiteDatabase;
    invoke-direct {v0, p4}, openSecureDatabase([B)V
...
.method private openSecureDatabase([B)V
    ...
    .line 879
    :try_start_0
    invoke-direct {p0, p1}, openInnerSecureDatabase([B)V
    :try_end_3
    .catch Landroid/database/sqlite/SQLiteDatabaseCorruptException; {:try_start_0 .. :try_end_3} :catch_4
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_3} :catch_10
...
.method private throwIfNotOpenLocked()V
    ...
    iget-object v2, p0, mConfigurationLocked:Landroid/database/sqlite/SQLiteDatabaseConfiguration;
...
.method public addCustomFunction(Ljava/lang/String;ILandroid/database/sqlite/SQLiteDatabase$CustomFunction;)V
    ...
    .line 974
    :try_start_12
    iget-object v2, p0, mConnectionPoolLocked:Landroid/database/sqlite/SQLiteConnectionPool;

    iget-object v4, p0, mConfigurationLocked:Landroid/database/sqlite/SQLiteDatabaseConfiguration;
...
.method public beginTransaction()V
    ...
    invoke-direct {p0, v0, v1}, beginTransaction(Landroid/database/sqlite/SQLiteTransactionListener;Z)V
...
.method public beginTransactionWithListener(Landroid/database/sqlite/SQLiteTransactionListener;)V
    ...
    invoke-direct {p0, p1, v0}, beginTransaction(Landroid/database/sqlite/SQLiteTransactionListener;Z)V
...
.method public disableWriteAheadLogging()V
    ...
    .line 2110
    :try_start_1b
    iget-object v1, p0, mConnectionPoolLocked:Landroid/database/sqlite/SQLiteConnectionPool;

    iget-object v3, p0, mConfigurationLocked:Landroid/database/sqlite/SQLiteDatabaseConfiguration;
...
.method public enableWriteAheadLogging()Z
    ...
    .line 2059
    :cond_13
    invoke-direct {p0}, isReadOnlyLocked()Z
    ...
    .line 2072
    :cond_2e
    iget-boolean v4, p0, mHasAttachedDbsLocked:Z
    ...
    iget-object v5, p0, mConfigurationLocked:Landroid/database/sqlite/SQLiteDatabaseConfiguration;
...
.method public execSQL(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, executeSql(Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public execSQL(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 1779
    :cond_a
    invoke-direct {p0, p1, p2}, executeSql(Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public getAttachedDbs()Ljava/util/List;
    ...
    .line 2218
    :try_start_9
    iget-object v4, p0, mConnectionPoolLocked:Landroid/database/sqlite/SQLiteConnectionPool;
    ...
    invoke-virtual {p0, v2, v3}, rawQuery(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
...
.method public getIntegrityErrorInfo()Ljava/lang/String;
    ...
    .prologue
    .line 2321
    iget-object v0, p0, mIntegrityErrorString:Ljava/lang/String;
...
.method public getMaximumSize()J
    ...
    invoke-virtual {p0}, getPageSize()J
...
.method getThreadSession()Landroid/database/sqlite/SQLiteSession;
    ...
    .prologue
    .line 364
    iget-object v0, p0, mThreadSession:Ljava/lang/ThreadLocal;
...
.method public insert(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    :try_start_1
    invoke-virtual {p0, p1, p2, p3, v1}, insertWithOnConflict(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;I)J
    :try_end_4
...
.method public insertOrThrow(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, insertWithOnConflict(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;I)J
...
.method public insertWithOnConflict(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;I)J
    ...
    .line 1567
    sget-object v8, CONFLICT_VALUES:[Ljava/lang/String;
...
.method public isDatabaseIntegrityOk()Z
    ...
    :try_start_4
    invoke-virtual {p0}, getAttachedDbs()Ljava/util/List;
    ...
    invoke-virtual {p0}, getPath()Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, compileStatement(Ljava/lang/String;)Landroid/database/sqlite/SQLiteStatement;
    ...
    iput-object v7, p0, mIntegrityErrorString:Ljava/lang/String;
    ...
    .line 2302
    iput-object v6, p0, mIntegrityErrorString:Ljava/lang/String;
...
.method onCorruption()V
    ...
    .line 343
    iget-object v0, p0, mErrorHandler:Landroid/database/DatabaseErrorHandler;
...
.method public query(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual/range {v0 .. v9}, query(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public query(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual/range {v0 .. v11}, queryWithFactory(Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method public queryWithFactory(Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-static {p3}, findEditTable(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v5}, rawQueryWithFactory(Landroid/database/sqlite/SQLiteDatabase$CursorFactory;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    :try_end_1e
...
.method public rawQueryWithFactory(Landroid/database/sqlite/SQLiteDatabase$CursorFactory;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    :cond_12
    :try_start_12
    iget-object p1, p0, mCursorFactory:Landroid/database/sqlite/SQLiteDatabase$CursorFactory;
    :try_end_14
...
.method public setPageSize(J)V
    ...
    invoke-virtual {p0, v0}, execSQL(Ljava/lang/String;)V
...
.method public update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual/range {v0 .. v5}, updateWithOnConflict(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;I)I
...
.method public updateWithOnConflict(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;I)I
    ...
    .line 1673
    sget-object v9, CONFLICT_VALUES:[Ljava/lang/String;
...
.method public yieldIfContended()Z
    ...
    invoke-direct {p0, v0, v2, v3}, yieldIfContendedHelper(ZJ)Z
...
.method public yieldIfContendedSafely(J)Z
    ...
    invoke-direct {p0, v0, p1, p2}, yieldIfContendedHelper(ZJ)Z
