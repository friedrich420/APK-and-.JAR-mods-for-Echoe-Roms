...
.method public constructor <init>(Landroid/database/Cursor;[Ljava/lang/String;Landroid/database/Cursor;[Ljava/lang/String;)V
    ...
    .line 84
    :cond_2d
    iput-object p1, p0, mCursorLeft:Landroid/database/Cursor;

    .line 85
    iput-object p3, p0, mCursorRight:Landroid/database/Cursor;

    .line 87
    iget-object v0, p0, mCursorLeft:Landroid/database/Cursor;

    invoke-interface {v0}, Landroid/database/Cursor;->moveToFirst()Z

    .line 88
    iget-object v0, p0, mCursorRight:Landroid/database/Cursor;
    ...
    iput-boolean v0, p0, mCompareResultIsValid:Z

    .line 92
    invoke-direct {p0, p1, p2}, buildColumnIndiciesArray(Landroid/database/Cursor;[Ljava/lang/String;)[I

    move-result-object v0

    iput-object v0, p0, mColumnsLeft:[I

    .line 93
    invoke-direct {p0, p3, p4}, buildColumnIndiciesArray(Landroid/database/Cursor;[Ljava/lang/String;)[I

    move-result-object v0

    iput-object v0, p0, mColumnsRight:[I

    .line 95
    iget-object v0, p0, mColumnsLeft:[I
    ...
    iput-object v0, p0, mValues:[Ljava/lang/String;
...
.method private incrementCursors()V
    ...
    .prologue
    .line 217
    iget-boolean v0, p0, mCompareResultIsValid:Z
    ...
    iget-object v1, p0, mCompareResult:Landroid/database/CursorJoiner$Result;
...
.method public hasNext()Z
    ...
    .line 121
    iget-boolean v2, p0, mCompareResultIsValid:Z
    ...
    iget-object v3, p0, mCompareResult:Landroid/database/CursorJoiner$Result;
    ...
    iget-object v2, p0, mCompareResult:Landroid/database/CursorJoiner$Result;
    ...
    .line 124
    :pswitch_2e
    iget-object v2, p0, mCursorLeft:Landroid/database/Cursor;
    ...
    iget-object v2, p0, mCursorRight:Landroid/database/Cursor;
...
.method public next()Landroid/database/CursorJoiner$Result;
    ...
    .line 160
    :cond_11
    invoke-direct {p0}, incrementCursors()V
    ...
    .line 163
    :cond_24
    iget-object v4, p0, mCursorLeft:Landroid/database/Cursor;
    ...
    .local v0, "hasLeft":Z
    :goto_2d
    iget-object v4, p0, mCursorRight:Landroid/database/Cursor;
    ...
    .line 167
    iget-object v4, p0, mValues:[Ljava/lang/String;

    iget-object v5, p0, mCursorLeft:Landroid/database/Cursor;

    iget-object v6, p0, mColumnsLeft:[I

    invoke-static {v4, v5, v6, v3}, populateValues([Ljava/lang/String;Landroid/database/Cursor;[II)V

    .line 168
    iget-object v3, p0, mValues:[Ljava/lang/String;

    iget-object v4, p0, mCursorRight:Landroid/database/Cursor;

    iget-object v5, p0, mColumnsRight:[I

    invoke-static {v3, v4, v5, v2}, populateValues([Ljava/lang/String;Landroid/database/Cursor;[II)V

    .line 169
    iget-object v3, p0, mValues:[Ljava/lang/String;

    invoke-static {v3}, compareStrings([Ljava/lang/String;)I
    ...
    .line 186
    :goto_55
    iput-boolean v2, p0, mCompareResultIsValid:Z
    ...
    iput-object v3, p0, mCompareResult:Landroid/database/CursorJoiner$Result;
...
.method public bridge synthetic next()Ljava/lang/Object;
    ...
    .prologue
    .line 45
    invoke-virtual {p0}, next()Landroid/database/CursorJoiner$Result;
