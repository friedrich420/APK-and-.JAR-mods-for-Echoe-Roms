...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mObserverBridge:Landroid/database/AbstractCursor$SelfContentObserver;
...
.method private throwIfCursorIsClosed()V
    ...
    .prologue
    .line 63
    iget-object v0, p0, mBulkCursor:Landroid/database/IBulkCursor;
...
.method public close()V
    ...
    .line 120
    iget-object v1, p0, mBulkCursor:Landroid/database/IBulkCursor;
    ...
    .line 126
    iput-object v3, p0, mBulkCursor:Landroid/database/IBulkCursor;
...
.method public getObserver()Landroid/database/IContentObserver;
    ...
    .prologue
    .line 59
    iget-object v0, p0, mObserverBridge:Landroid/database/AbstractCursor$SelfContentObserver;
...
.method public initialize(Landroid/database/BulkCursorDescriptor;)V
    ...
    iput-object v0, p0, mBulkCursor:Landroid/database/IBulkCursor;
    ...
    iput-boolean v0, p0, mWantsAllOnMoveCalls:Z
    ...
    invoke-virtual {p0, v0}, setWindow(Landroid/database/CursorWindow;)V
...
.method public onMove(II)Z
    ...
    .line 83
    :cond_1f
    iget-object v2, p0, mBulkCursor:Landroid/database/IBulkCursor;

    invoke-interface {v2, p2}, Landroid/database/IBulkCursor;->getWindow(I)Landroid/database/CursorWindow;

    move-result-object v2

    invoke-virtual {p0, v2}, setWindow(Landroid/database/CursorWindow;)V
    :try_end_28
    ...
    :cond_2d
    :try_start_2d
    iget-boolean v2, p0, mWantsAllOnMoveCalls:Z
...
.method public requery()Z
    ...
    invoke-virtual {p0}, getObserver()Landroid/database/IContentObserver;
