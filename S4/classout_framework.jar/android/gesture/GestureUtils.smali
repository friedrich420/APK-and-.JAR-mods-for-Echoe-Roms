...
.method public static computeOrientedBoundingBox(Ljava/util/ArrayList;)Landroid/gesture/OrientedBoundingBox;
    ...
    :cond_20
    invoke-static {v5}, computeCentroid([F)[F

    move-result-object v3

    .line 480
    .local v3, "meanVector":[F
    invoke-static {v5, v3}, computeOrientedBoundingBox([F[F)Landroid/gesture/OrientedBoundingBox;
...
.method public static computeOrientedBoundingBox([F)Landroid/gesture/OrientedBoundingBox;
    ...
    .line 495
    :cond_d
    invoke-static {v2}, computeCentroid([F)[F

    move-result-object v1

    .line 496
    .local v1, "meanVector":[F
    invoke-static {v2, v1}, computeOrientedBoundingBox([F[F)Landroid/gesture/OrientedBoundingBox;
...
.method private static computeOrientedBoundingBox([F[F)Landroid/gesture/OrientedBoundingBox;
    ...
    invoke-static {p0, v0, v1}, translate([FFF)[F

    .line 502
    invoke-static {p0}, computeCoVariance([F)[[F

    move-result-object v7

    .line 503
    .local v7, "array":[[F
    invoke-static {v7}, computeOrientation([[F)[F
    ...
    invoke-static {p0, v0}, rotate([FF)[F
...
.method static computeStraightness([F)F
    ...
    .prologue
    .line 388
    invoke-static {p0}, computeTotalLength([F)F
...
.method public static spatialSampling(Landroid/gesture/Gesture;I)[F
    ...
    invoke-static {p0, p1, v0}, spatialSampling(Landroid/gesture/Gesture;IZ)[F
...
.method public static spatialSampling(Landroid/gesture/Gesture;IZ)[F
    ...
    invoke-static {v0, v1, v2, v3}, plot(FF[FI)V
