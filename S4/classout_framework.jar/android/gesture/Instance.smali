...
.method private constructor <init>(J[FLjava/lang/String;)V
    ...
    .line 46
    iput-object p3, p0, vector:[F

    .line 47
    iput-object p4, p0, label:Ljava/lang/String;
...
.method static createInstance(IILandroid/gesture/Gesture;Ljava/lang/String;)Landroid/gesture/Instance;
    ...
    .line 76
    invoke-static {p1, p2}, temporalSampler(ILandroid/gesture/Gesture;)[F
    ...
    invoke-direct {v0, v2, v3, v1, p3}, <init>(J[FLjava/lang/String;)V

    .line 78
    .local v0, "instance":Landroid/gesture/Instance;
    invoke-direct {v0}, normalize()V
    ...
    .end local v1    # "pts":[F
    :cond_14
    invoke-static {p2}, spatialSampler(Landroid/gesture/Gesture;)[F
