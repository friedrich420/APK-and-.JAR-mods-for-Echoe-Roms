...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, mIsAmericano:Z
...
.method static synthetic access$200(Landroid/widget/ProgressBar;IFZZZ)V
    ...
    .prologue
    .line 201
    invoke-direct/range {p0 .. p5}, doRefreshProgress(IFZZZ)V
...
.method private declared-synchronized doRefreshProgress(IFZZ)V
    ...
    :try_start_7
    invoke-direct/range {v0 .. v5}, doRefreshProgress(IFZZZ)V
    :try_end_a
...
.method private declared-synchronized doRefreshProgress(IFZZZ)V
    ...
    :try_start_1
    invoke-direct {p0, p2}, getScale(F)F
    ...
    .line 1322
    invoke-virtual {p0, v4, p3}, onAnimatePosition(FZ)V
    :try_end_39
    ...
    .line 1324
    :try_start_46
    invoke-virtual {p0, v4, p3}, onProgressRefresh(FZ)V
    :try_end_49
...
.method private declared-synchronized refreshProgress(IFZ)V
    ...
    :try_start_2
    invoke-direct {p0, p1, p2, p3, v0}, refreshProgress(IFZZ)V
    :try_end_5
...
.method private declared-synchronized refreshProgress(IFZZ)V
    ...
    iput-object v0, p0, mRefreshProgressRunnable:Landroid/widget/ProgressBar$RefreshProgressRunnable;
    ...
    iget-boolean v0, p0, mRefreshIsPosted:Z
    ...
    iput-boolean v0, p0, mRefreshIsPosted:Z
    :try_end_3f
...
.method protected onAttachedToWindow()V
    ...
    invoke-direct {p0, v3, v4, v5, v6}, doRefreshProgress(IFZZ)V
    ...
    iput-boolean v3, p0, mAttached:Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 1924
    iput-boolean v2, p0, mRefreshIsPosted:Z
...
.method onProgressRefresh(FZ)V
    ...
    invoke-direct {p0, v0, v1, v2}, refreshProgress(IFZ)V
...
.method setAnimationPosition(F)V
    ...
    .line 1350
    iput p1, p0, mAnimationPosition:F

    .line 1351
    const v0, 0x102000d

    invoke-direct {p0, v0, p1, v1, v1}, refreshProgress(IFZZ)V
...
.method public declared-synchronized setProgress(I)V
    ...
    :try_start_2
    invoke-virtual {p0, p1, v0}, setProgress(IZ)V
    :try_end_5
    .catchall {:try_start_2 .. :try_end_5} :catchall_7
...
.method declared-synchronized setProgress(IZ)V
    ...
    invoke-direct {p0, v0, v1, p2}, refreshProgress(IFZ)V
    :try_end_22
...
.method public setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, v2, v3, v4, v4}, doRefreshProgress(IFZZ)V
...
.method setProgressValueOnly(I)V
    ...
    invoke-direct {p0, v0}, getScale(F)F

    move-result v0

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, onProgressRefresh(FZ)V
...
.method protected tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, v2}, tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v0, mSampleTile:Landroid/graphics/Bitmap;
    ...
    iput-object v15, v0, mSampleTile:Landroid/graphics/Bitmap;

    .line 502
    :cond_a5
    new-instance v14, Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual/range {p0 .. p0}, getDrawableShape()Landroid/graphics/drawable/shapes/Shape;
