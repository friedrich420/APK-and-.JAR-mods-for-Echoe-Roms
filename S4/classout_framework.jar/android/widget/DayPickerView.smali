...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/DatePickerController;)V
    ...
    iput-object v0, p0, mYearFormat:Ljava/text/SimpleDateFormat;

    .line 56
    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, mFriction:F
    ...
    iput-object v0, p0, mSelectedDay:Ljava/util/Calendar;
    ...
    iput-object v0, p0, mTempDay:Ljava/util/Calendar;

    .line 67
    iput v3, p0, mPreviousScrollState:I

    .line 69
    iput v3, p0, mCurrentScrollState:I
    ...
    iput-object v0, p0, mScrollStateChangedRunnable:Landroid/widget/DayPickerView$ScrollStateRunnable;

    .line 78
    invoke-virtual {p0}, init()V

    .line 79
    invoke-virtual {p0, p2}, setController(Landroid/widget/DatePickerController;)V
...
.method private getMonthAndYearString(Ljava/util/Calendar;)Ljava/lang/String;
    ...
    .line 441
    iget-object v1, p0, mYearFormat:Ljava/text/SimpleDateFormat;
...
.method private getPositionFromDay(Ljava/util/Calendar;)I
    ...
    .prologue
    .line 147
    iget-object v2, p0, mController:Landroid/widget/DatePickerController;

    invoke-interface {v2}, Landroid/widget/DatePickerController;->getMinDate()Ljava/util/Calendar;

    move-result-object v2

    iget-object v3, p0, mController:Landroid/widget/DatePickerController;
    ...
    invoke-direct {p0, v2, p1}, getDiffMonths(Ljava/util/Calendar;Ljava/util/Calendar;)I
...
.method public goTo(Ljava/util/Calendar;ZZZ)Z
    ...
    .line 179
    iget-object v6, p0, mSelectedDay:Ljava/util/Calendar;
    ...
    .line 182
    :cond_b
    iget-object v6, p0, mTempDay:Ljava/util/Calendar;
    ...
    .line 183
    invoke-direct {p0, p1}, getPositionFromDay(Ljava/util/Calendar;)I
    ...
    .line 200
    invoke-virtual {p0, v0}, getPositionForView(Landroid/view/View;)I
    ...
    .line 206
    iget-object v6, p0, mAdapter:Landroid/widget/SimpleMonthAdapter;

    iget-object v7, p0, mSelectedDay:Ljava/util/Calendar;
    ...
    invoke-virtual {p0, v6}, setMonthDisplayed(Ljava/util/Calendar;)V

    .line 213
    const/4 v6, 0x2

    iput v6, p0, mPreviousScrollState:I

    .line 214
    if-eqz p2, :cond_52

    .line 215
    sget v6, LIST_TOP_OFFSET:I

    const/16 v7, 0xfa

    invoke-virtual {p0, v3, v6, v7}, smoothScrollToPositionFromTop(III)V
    ...
    .line 219
    :cond_52
    invoke-virtual {p0, v3}, postSetSelection(I)V
...
.method public init()V
    ...
    invoke-virtual {p0, v0}, setDrawSelectorOnTop(Z)V

    .line 97
    invoke-virtual {p0}, setUpListView()V
...
.method protected layoutChildren()V
    ...
    .prologue
    .line 417
    invoke-direct {p0}, findAccessibilityFocus()Ljava/util/Calendar;
    ...
    .line 419
    iget-boolean v1, p0, mPerformingScroll:Z
    ...
    iput-boolean v1, p0, mPerformingScroll:Z
    ...
    .line 422
    :cond_f
    invoke-direct {p0, v0}, restoreAccessibilityFocus(Ljava/util/Calendar;)Z
...
.method public onChange()V
    ...
    .prologue
    .line 101
    invoke-virtual {p0}, setUpAdapter()V

    .line 102
    iget-object v0, p0, mAdapter:Landroid/widget/SimpleMonthAdapter;

    invoke-virtual {p0, v0}, setAdapter(Landroid/widget/ListAdapter;)V
...
.method public onDateChanged()V
    ...
    .line 366
    iget-object v0, p0, mController:Landroid/widget/DatePickerController;
    ...
    invoke-virtual {p0, v0, v1, v2, v2}, goTo(Ljava/util/Calendar;ZZZ)Z
...
.method public onScroll(Landroid/widget/AbsListView;III)V
    ...
    .line 251
    :cond_a
    iget v1, p0, mCurrentScrollState:I

    iput v1, p0, mPreviousScrollState:I
...
.method public onScrollStateChanged(Landroid/widget/AbsListView;I)V
    ...
    .prologue
    .line 269
    iget-object v0, p0, mScrollStateChangedRunnable:Landroid/widget/DayPickerView$ScrollStateRunnable;
...
.method public performAccessibilityAction(ILandroid/os/Bundle;)Z
    ...
    iget-object v7, p0, mController:Landroid/widget/DatePickerController;
    ...
    :cond_3b
    :goto_3b
    invoke-direct {p0, v0}, getMonthAndYearString(Ljava/util/Calendar;)Ljava/lang/String;
    ...
    .line 497
    invoke-virtual {p0, v0, v5, v10, v5}, goTo(Ljava/util/Calendar;ZZZ)Z

    .line 498
    iput-boolean v5, p0, mPerformingScroll:Z
...
.method public postSetSelection(I)V
    ...
    invoke-virtual {p0, p0, v0}, onScrollStateChanged(Landroid/widget/AbsListView;I)V
...
.method public setController(Landroid/widget/DatePickerController;)V
    ...
    .line 86
    :cond_9
    iput-object p1, p0, mController:Landroid/widget/DatePickerController;
    ...
    .line 90
    invoke-virtual {p0}, onDateChanged()V
...
.method protected setMonthDisplayed(Ljava/util/Calendar;)V
    ...
    .line 259
    iget v0, p0, mCurrentMonthDisplayed:I
    ...
    iput v0, p0, mCurrentMonthDisplayed:I

    .line 261
    invoke-virtual {p0}, invalidateViews()V
...
.method protected setUpAdapter()V
    ...
    iput-object v0, p0, mAdapter:Landroid/widget/SimpleMonthAdapter;
...
.method protected setUpListView()V
    ...
    invoke-virtual {p0, v0}, setDivider(Landroid/graphics/drawable/Drawable;)V

    .line 130
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, setItemsCanFocus(Z)V

    .line 132
    invoke-virtual {p0, v1}, setFastScrollEnabled(Z)V

    .line 133
    invoke-virtual {p0, v1}, setVerticalScrollBarEnabled(Z)V

    .line 134
    invoke-virtual {p0, p0}, setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V

    .line 135
    invoke-virtual {p0, v1}, setFadingEdgeLength(I)V
    ...
    invoke-virtual {p0, v0}, setFriction(F)V
