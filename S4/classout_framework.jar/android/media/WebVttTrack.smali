...
.method constructor <init>(Landroid/media/WebVttRenderingWidget;Landroid/media/MediaFormat;)V
    ...
    iput-object v0, p0, mParser:Landroid/media/WebVttParser;
    ...
    iput-object v0, p0, mExtractor:Landroid/media/UnstyledTextExtractor;

    .line 995
    new-instance v0, Landroid/media/Tokenizer;

    iget-object v1, p0, mExtractor:Landroid/media/UnstyledTextExtractor;

    invoke-direct {v0, v1}, Landroid/media/Tokenizer;-><init>(Landroid/media/Tokenizer$OnTokenListener;)V

    iput-object v0, p0, mTokenizer:Landroid/media/Tokenizer;
    ...
    iput-object v0, p0, mTimestamps:Ljava/util/Vector;
    ...
    iput-object v0, p0, mRegions:Ljava/util/Map;

    .line 1006
    iput-object p1, p0, mRenderingWidget:Landroid/media/WebVttRenderingWidget;
...
.method public bridge synthetic getRenderingWidget()Landroid/media/SubtitleTrack$RenderingWidget;
    ...
    .prologue
    .line 989
    invoke-virtual {p0}, getRenderingWidget()Landroid/media/WebVttRenderingWidget;
...
.method public getRenderingWidget()Landroid/media/WebVttRenderingWidget;
    ...
    .prologue
    .line 1011
    iget-object v0, p0, mRenderingWidget:Landroid/media/WebVttRenderingWidget;
...
.method public onCueParsed(Landroid/media/TextTrackCue;)V
    ...
    iget-object v13, v0, mParser:Landroid/media/WebVttParser;
    ...
    iget-object v12, v0, mRegions:Ljava/util/Map;
    ...
    iget-object v12, v0, mTokenizer:Landroid/media/Tokenizer;
    ...
    iget-object v12, v0, mExtractor:Landroid/media/UnstyledTextExtractor;
    ...
    iget-object v12, v0, mTimestamps:Ljava/util/Vector;
    ...
    iget-object v12, v0, mCurrentRunID:Ljava/lang/Long;
    ...
    .line 1085
    invoke-virtual/range {p0 .. p1}, addCue(Landroid/media/SubtitleTrack$Cue;)Z
...
.method public onData([BZJ)V
    ...
    iget-object v3, p0, mParser:Landroid/media/WebVttParser;
    ...
    .line 1027
    iget-object v2, p0, mParser:Landroid/media/WebVttParser;
    ...
    .line 1031
    iget-object v2, p0, mRegions:Ljava/util/Map;
...
.method public onRegionParsed(Landroid/media/TextTrackRegion;)V
    ...
    .prologue
    .line 1090
    iget-object v1, p0, mParser:Landroid/media/WebVttParser;

    monitor-enter v1

    .line 1091
    :try_start_3
    iget-object v0, p0, mRegions:Ljava/util/Map;
...
.method public updateView(Ljava/util/Vector;)V
    ...
    :cond_36
    :goto_36
    iget-object v1, p0, mRenderingWidget:Landroid/media/WebVttRenderingWidget;
