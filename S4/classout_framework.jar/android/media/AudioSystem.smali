...
.method private static errorCallbackFromNative(I)V
    ...
    .line 258
    :try_start_4
    sget-object v1, mErrorCallback:Landroid/media/AudioSystem$ErrorCallback;

    if-eqz v1, :cond_a

    .line 259
    sget-object v0, mErrorCallback:Landroid/media/AudioSystem$ErrorCallback;
...
.method public static getOutputDeviceName(I)Ljava/lang/String;
    ...
    .sparse-switch
        ...
        0x2000000 -> :sswitch_58
        0x8000000 -> :sswitch_55
    .end sparse-switch
.end method
...
.method public static setErrorCallback(Landroid/media/AudioSystem$ErrorCallback;)V
    ...
    .line 240
    :try_start_3
    sput-object p0, mErrorCallback:Landroid/media/AudioSystem$ErrorCallback;

    .line 241
    if-eqz p0, :cond_e

    .line 242
    invoke-static {}, checkAudioFlinger()I
    ...
    .line 250
    invoke-static {}, isMediaServerStarted()Z
