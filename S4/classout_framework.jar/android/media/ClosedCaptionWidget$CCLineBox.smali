...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 1228
    iput v3, p0, mTextColor:I

    .line 1229
    const/high16 v1, -0x1000000

    iput v1, p0, mBgColor:I

    .line 1230
    iput v2, p0, mEdgeType:I

    .line 1231
    iput v2, p0, mEdgeColor:I

    .line 1235
    const/16 v1, 0x11

    invoke-virtual {p0, v1}, setGravity(I)V

    .line 1236
    invoke-virtual {p0, v2}, setBackgroundColor(I)V

    .line 1237
    invoke-virtual {p0, v3}, setTextColor(I)V

    .line 1238
    sget-object v1, Landroid/graphics/Typeface;->MONOSPACE:Landroid/graphics/Typeface;

    invoke-virtual {p0, v1}, setTypeface(Landroid/graphics/Typeface;)V
...
.method private drawEdgeOutline(Landroid/graphics/Canvas;)V
    ...
    iget v4, p0, mEdgeColor:I

    invoke-virtual {p0, v4}, setTextColor(I)V
    ...
    invoke-direct {p0, v4}, setBackgroundSpans(I)V

    .line 1329
    invoke-super {p0, p1}, Landroid/widget/TextView;->onDraw(Landroid/graphics/Canvas;)V

    .line 1331
    iget v4, p0, mBgColor:I
...
.method private drawEdgeRaisedOrDepressed(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, mEdgeColor:I

    .line 1343
    .local v0, "colorDown":I
    :cond_1c
    iget v7, p0, mShadowRadius:F
    ...
    invoke-virtual {p0, v7, v8, v9, v1}, setShadowLayer(FFFI)V

    .line 1347
    invoke-super {p0, p1}, Landroid/widget/TextView;->onDraw(Landroid/graphics/Canvas;)V

    .line 1350
    invoke-direct {p0, v6}, setBackgroundSpans(I)V

    .line 1353
    iget v6, p0, mShadowRadius:F

    invoke-virtual {p0, v6, v2, v2, v0}, setShadowLayer(FFFI)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1298
    invoke-direct {p0, p1}, drawEdgeOutline(Landroid/graphics/Canvas;)V

    goto :goto_11

    .line 1301
    :cond_1b
    invoke-direct {p0, p1}, drawEdgeRaisedOrDepressed(Landroid/graphics/Canvas;)V
...
.method protected onMeasure(II)V
    ...
    .line 1271
    .local v1, "fontSize":F
    invoke-virtual {p0, v7, v1}, setTextSize(IF)V
    ...
    iput v3, p0, mShadowRadius:F

    .line 1275
    iget v3, p0, mShadowRadius:F

    iput v3, p0, mShadowOffset:F

    .line 1278
    invoke-virtual {p0, v5}, setScaleX(F)V
    ...
    invoke-virtual {p0, v3}, setScaleX(F)V
...
.method setCaptionStyle(Landroid/view/accessibility/CaptioningManager$CaptionStyle;)V
    ...
    iput v0, p0, mBgColor:I

    .line 1255
    iget v0, p1, Landroid/view/accessibility/CaptioningManager$CaptionStyle;->edgeType:I

    iput v0, p0, mEdgeType:I

    .line 1256
    iget v0, p1, Landroid/view/accessibility/CaptioningManager$CaptionStyle;->edgeColor:I

    iput v0, p0, mEdgeColor:I
    ...
    iget v1, p0, mShadowOffset:F

    iget v2, p0, mShadowOffset:F

    iget v3, p0, mEdgeColor:I

    invoke-virtual {p0, v0, v1, v2, v3}, setShadowLayer(FFFI)V
    ...
    invoke-virtual {p0, v2, v2, v2, v0}, setShadowLayer(FFFI)V
