...
.method public constructor <init>(IIIIII)V
    ...
    invoke-direct/range {v0 .. v7}, <init>(IIIIIII)V
...
.method public constructor <init>(IIIIIII)V
    ...
    invoke-direct/range {v0 .. v5}, <init>(Landroid/media/AudioAttributes;Landroid/media/AudioFormat;III)V
...
.method public constructor <init>(Landroid/media/AudioAttributes;Landroid/media/AudioFormat;III)V
    ...
    iput-object v3, v0, mPlayStateLock:Ljava/lang/Object;
    ...
    iput v3, v0, mNativeBufferSizeInBytes:I
    ...
    iput v3, v0, mNativeBufferSizeInFrames:I
    ...
    iput v3, v0, mChannelConfiguration:I
    ...
    invoke-direct {v0, v1, v13, v14, v2}, audioParamCheck(IIII)V
    ...
    invoke-direct {v0, v1}, audioBuffSizeCheck(I)V
    ...
    iput-object v0, v1, mInitializationLooper:Landroid/os/Looper;
    ...
    iput-object v3, v0, mAppOps:Lcom/android/internal/app/IAppOpsService;
    ...
    iput-object v3, v0, mAttributes:Landroid/media/AudioAttributes;
    ...
    iget-object v5, v0, mAttributes:Landroid/media/AudioAttributes;

    move-object/from16 v0, p0

    iget v6, v0, mSampleRate:I

    move-object/from16 v0, p0

    iget v7, v0, mChannels:I

    move-object/from16 v0, p0

    iget v8, v0, mAudioFormat:I

    move-object/from16 v0, p0

    iget v9, v0, mNativeBufferSizeInBytes:I

    move-object/from16 v0, p0

    iget v10, v0, mDataLoadMode:I

    move-object/from16 v3, p0

    invoke-direct/range {v3 .. v11}, native_setup(Ljava/lang/Object;Ljava/lang/Object;IIIII[I)I
...
.method static synthetic access$000(Landroid/media/AudioTrack;)Landroid/os/Looper;
    ...
    .prologue
    .line 78
    iget-object v0, p0, mInitializationLooper:Landroid/os/Looper;
...
.method private audioBuffSizeCheck(I)V
    ...
    .line 603
    :cond_23
    iput p1, p0, mNativeBufferSizeInBytes:I

    .line 604
    div-int v1, p1, v0

    iput v1, p0, mNativeBufferSizeInFrames:I
...
.method private audioParamCheck(IIII)V
    ...
    .line 491
    :cond_23
    iput p1, p0, mSampleRate:I

    .line 495
    iput p2, p0, mChannelConfiguration:I

    .line 497
    sparse-switch p2, :sswitch_data_7a

    .line 510
    invoke-static {p2}, isMultichannelConfigSupported(I)Z
    ...
    .line 501
    :sswitch_38
    iput v1, p0, mChannelCount:I

    .line 502
    const/4 v0, 0x4

    iput v0, p0, mChannels:I
...
.method public static getMinBufferSize(III)I
    ...
    .line 843
    :cond_49
    invoke-static {p0, v0, p2}, native_get_min_buff_size(III)I
...
.method public static getNativeOutputSampleRate(I)I
    ...
    .prologue
    .line 788
    invoke-static {p0}, native_get_output_sample_rate(I)I
...
.method private static postEventFromNative(Ljava/lang/Object;IIILjava/lang/Object;)V
    ...
    .line 1615
    :cond_b
    iget-object v0, v3, mEventHandlerDelegate:Landroid/media/AudioTrack$NativeEventHandlerDelegate;
...
.method public attachAuxEffect(I)I
    ...
    :cond_6
    invoke-direct {p0, p1}, native_attachAuxEffect(I)I
...
.method public flush()V
    ...
    .line 1218
    invoke-direct {p0}, native_flush()V
...
.method public getChannelConfiguration()I
    ...
    .prologue
    .line 692
    iget v0, p0, mChannelConfiguration:I
...
.method public getLatency()I
    ...
    .prologue
    .line 781
    invoke-direct {p0}, native_get_latency()I
...
.method protected getNativeFrameCount()I
    ...
    .prologue
    .line 740
    invoke-direct {p0}, native_get_native_frame_count()I
...
.method public getNotificationMarkerPosition()I
    ...
    .prologue
    .line 749
    invoke-direct {p0}, native_get_marker_pos()I
...
.method public getPlayState()I
    ...
    .prologue
    .line 721
    iget-object v1, p0, mPlayStateLock:Ljava/lang/Object;

    monitor-enter v1

    .line 722
    :try_start_3
    iget v0, p0, mPlayState:I
...
.method public getPlaybackHeadPosition()I
    ...
    .prologue
    .line 769
    invoke-direct {p0}, native_get_position()I
...
.method public getPlaybackRate()I
    ...
    .prologue
    .line 664
    invoke-direct {p0}, native_get_playback_rate()I
...
.method public getPositionNotificationPeriod()I
    ...
    .prologue
    .line 757
    invoke-direct {p0}, native_get_pos_update_period()I
...
.method public getTimestamp(Landroid/media/AudioTimestamp;)Z
    ...
    invoke-direct {p0, v0}, native_get_timestamp([J)I
...
.method public pause()V
    ...
    .line 1200
    :try_start_11
    invoke-direct {p0}, native_pause()V

    .line 1201
    const/4 v0, 0x2

    iput v0, p0, mPlayState:I
...
.method public play()V
    ...
    invoke-virtual {p0, v0}, setVolume(F)I
    ...
    .line 1147
    :try_start_1b
    invoke-direct {p0}, native_start()V
...
.method public reloadStaticData()I
    ...
    :cond_b
    invoke-direct {p0}, native_reload_static()I
...
.method public setAuxEffectSendLevel(F)I
    ...
    .line 1518
    :cond_e
    invoke-static {p1}, clampGainOrLevel(F)F

    move-result p1

    .line 1519
    invoke-direct {p0, p1}, native_setAuxEffectSendLevel(F)I
...
.method public setLoopPoints(III)I
    ...
    invoke-virtual {p0}, getPlayState()I
    ...
    .line 1113
    :cond_14
    invoke-direct {p0, p1, p2, p3}, native_set_loop(III)I
    ...
    iget v0, p0, mNativeBufferSizeInFrames:I
...
.method public setNotificationMarkerPosition(I)I
    ...
    :cond_6
    invoke-direct {p0, p1}, native_set_marker_pos(I)I
...
.method public setPlaybackHeadPosition(I)I
    ...
    .line 1080
    :cond_1a
    invoke-direct {p0, p1}, native_set_position(I)I
...
.method public setPlaybackPositionUpdateListener(Landroid/media/AudioTrack$OnPlaybackPositionUpdateListener;)V
    ...
    invoke-virtual {p0, p1, v0}, setPlaybackPositionUpdateListener(Landroid/media/AudioTrack$OnPlaybackPositionUpdateListener;Landroid/os/Handler;)V
...
.method public setPlaybackPositionUpdateListener(Landroid/media/AudioTrack$OnPlaybackPositionUpdateListener;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, mEventHandlerDelegate:Landroid/media/AudioTrack$NativeEventHandlerDelegate;
...
.method public setPlaybackRate(I)I
    ...
    .line 1028
    :cond_b
    invoke-direct {p0, p1}, native_set_playback_rate(I)I
...
.method public setPositionNotificationPeriod(I)I
    ...
    :cond_6
    invoke-direct {p0, p1}, native_set_pos_update_period(I)I
...
.method public setStereoVolume(FF)I
    ...
    .line 980
    invoke-static {p2}, clampGainOrLevel(F)F

    move-result p2

    .line 982
    invoke-direct {p0, p1, p2}, native_setVolume(FF)V
...
.method public setVolume(F)I
    ...
    .prologue
    .line 1003
    invoke-virtual {p0, p1, p1}, setStereoVolume(FF)I
...
.method public stop()V
    ...
    .line 1179
    :try_start_11
    invoke-direct {p0}, native_stop()V
...
.method public write(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-direct/range {v0 .. v5}, native_write_native_bytes(Ljava/lang/Object;IIIZ)I
    ...
    invoke-direct/range {v0 .. v5}, native_write_byte([BIIIZ)I
...
.method public write([FIII)I
    ...
    invoke-direct/range {v0 .. v5}, native_write_float([FIIIZ)I
...
.method public write([SII)I
    ...
    invoke-direct {p0, p1, p2, p3, v1}, native_write_short([SIII)I

    move-result v0

    .line 1301
    .local v0, "ret":I
    iget v1, p0, mDataLoadMode:I
