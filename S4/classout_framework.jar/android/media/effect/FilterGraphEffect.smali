...
.method public constructor <init>(Landroid/media/effect/EffectContext;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    .line 61
    iput-object p4, p0, mInputName:Ljava/lang/String;

    .line 62
    iput-object p5, p0, mOutputName:Ljava/lang/String;

    .line 63
    iput-object p6, p0, mSchedulerClass:Ljava/lang/Class;

    .line 64
    invoke-direct {p0, p3}, createGraph(Ljava/lang/String;)V
...
.method private createGraph(Ljava/lang/String;)V
    ...
    iput-object v2, p0, mGraph:Landroid/filterfw/core/FilterGraph;
    :try_end_b
    .catch Landroid/filterfw/io/GraphIOException; {:try_start_5 .. :try_end_b} :catch_17

    .line 76
    iget-object v2, p0, mGraph:Landroid/filterfw/core/FilterGraph;
    ...
    invoke-virtual {p0}, getFilterContext()Landroid/filterfw/core/FilterContext;

    move-result-object v3

    iget-object v4, p0, mGraph:Landroid/filterfw/core/FilterGraph;

    iget-object v5, p0, mSchedulerClass:Ljava/lang/Class;
    ...
    iput-object v2, p0, mRunner:Landroid/filterfw/core/GraphRunner;
...
.method public apply(IIII)V
    ...
    .prologue
    .line 84
    invoke-virtual {p0}, beginGLEffect()V

    .line 85
    iget-object v3, p0, mGraph:Landroid/filterfw/core/FilterGraph;

    iget-object v4, p0, mInputName:Ljava/lang/String;
    ...
    iget-object v4, p0, mOutputName:Ljava/lang/String;
    ...
    .line 100
    :try_start_3e
    iget-object v3, p0, mRunner:Landroid/filterfw/core/GraphRunner;
    ...
    .line 104
    invoke-virtual {p0}, endGLEffect()V
...
.method public release()V
    ...
    .prologue
    .line 113
    iget-object v0, p0, mGraph:Landroid/filterfw/core/FilterGraph;
    ...
    iput-object v0, p0, mGraph:Landroid/filterfw/core/FilterGraph;
