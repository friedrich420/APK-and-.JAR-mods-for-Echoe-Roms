...
.method static constructor <clinit>()V
    ...
    sput-object v0, sInitLock:Ljava/lang/Object;
...
.method public constructor <init>(I)V
    ...
    .line 159
    invoke-static {}, initCodecList()V

    .line 160
    if-nez p1, :cond_d

    .line 161
    sget-object v0, sRegularCodecInfos:[Landroid/media/MediaCodecInfo;

    iput-object v0, p0, mCodecInfos:[Landroid/media/MediaCodecInfo;
    ...
    .line 163
    :cond_d
    sget-object v0, sAllCodecInfos:[Landroid/media/MediaCodecInfo;
...
.method private findCodecForFormat(ZLandroid/media/MediaFormat;)Ljava/lang/String;
    ...
    iget-object v0, p0, mCodecInfos:[Landroid/media/MediaCodecInfo;
...
.method public static getInfoFor(Ljava/lang/String;)Landroid/media/MediaCodecInfo;
    ...
    invoke-static {p0}, findCodecByName(Ljava/lang/String;)I
...
.method private static getNewCodecInfoAt(I)Landroid/media/MediaCodecInfo;
    ...
    .prologue
    .line 97
    invoke-static {p0}, getSupportedTypes(I)[Ljava/lang/String;
    ...
    invoke-static {p0, v5}, getCodecCapabilities(ILjava/lang/String;)Landroid/media/MediaCodecInfo$CodecCapabilities;
    ...
    invoke-static {p0}, getCodecName(I)Ljava/lang/String;

    move-result-object v9

    invoke-static {p0}, isEncoder(I)Z
...
.method private static final initCodecList()V
    ...
    .prologue
    .line 71
    sget-object v7, sInitLock:Ljava/lang/Object;

    monitor-enter v7

    .line 72
    :try_start_3
    sget-object v6, sRegularCodecInfos:[Landroid/media/MediaCodecInfo;

    if-nez v6, :cond_53

    .line 73
    invoke-static {}, native_getCodecCount()I
    ...
    .line 78
    :try_start_18
    invoke-static {v3}, getNewCodecInfoAt(I)Landroid/media/MediaCodecInfo;
    ...
    sput-object v6, sRegularCodecInfos:[Landroid/media/MediaCodecInfo;
    ...
    sput-object v6, sAllCodecInfos:[Landroid/media/MediaCodecInfo;
...
.method public final findDecoderForFormat(Landroid/media/MediaFormat;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, p1}, findCodecForFormat(ZLandroid/media/MediaFormat;)Ljava/lang/String;
...
.method public final getCodecInfos()[Landroid/media/MediaCodecInfo;
    ...
    iget-object v1, p0, mCodecInfos:[Landroid/media/MediaCodecInfo;
