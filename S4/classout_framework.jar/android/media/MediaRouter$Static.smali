...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, mCallbacks:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v1, p0, mRoutes:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, mCategories:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, mCurAudioRoutesInfo:Landroid/media/AudioRoutesInfo;
    ...
    iput-object v1, p0, mAudioRoutesObserver:Landroid/media/IAudioRoutesObserver$Stub;

    .line 108
    iput-object p1, p0, mAppContext:Landroid/content/Context;
    ...
    iput-object v1, p0, mAudioService:Landroid/media/IAudioService;
    ...
    iput-object v1, p0, mDisplayService:Landroid/hardware/display/DisplayManager;
    ...
    iput-object v1, p0, mMediaRouterService:Landroid/media/IMediaRouterService;
    ...
    iput-object v1, p0, mSystemCategory:Landroid/media/MediaRouter$RouteCategory;

    .line 123
    iget-object v1, p0, mSystemCategory:Landroid/media/MediaRouter$RouteCategory;
    ...
    :goto_81
    iput-boolean v1, p0, mCanConfigureWifiDisplays:Z
...
.method public getAllPresentationDisplays()[Landroid/view/Display;
    ...
    .prologue
    .line 318
    iget-object v0, p0, mDisplayService:Landroid/hardware/display/DisplayManager;
...
.method isBluetoothA2dpOn()Z
    ...
    .line 228
    :try_start_0
    iget-object v1, p0, mAudioService:Landroid/media/IAudioService;
...
.method makeGlobalRoute(Landroid/media/MediaRouterClientState$RouteInfo;)Landroid/media/MediaRouter$RouteInfo;
    ...
    iget-object v1, v1, mSystemCategory:Landroid/media/MediaRouter$RouteCategory;
...
.method public onDisplayAdded(I)V
    ...
    .prologue
    .line 304
    invoke-direct {p0, p1}, updatePresentationDisplays(I)V
...
.method publishClientDiscoveryRequest()V
    ...
    .prologue
    .line 367
    iget-object v1, p0, mClient:Landroid/media/IMediaRouterClient;

    if-eqz v1, :cond_f

    .line 369
    :try_start_4
    iget-object v1, p0, mMediaRouterService:Landroid/media/IMediaRouterService;

    iget-object v2, p0, mClient:Landroid/media/IMediaRouterClient;

    iget v3, p0, mDiscoveryRequestRouteTypes:I

    iget-boolean v4, p0, mDiscoverRequestActiveScan:Z
...
.method publishClientSelectedRoute(Z)V
    ...
    .line 380
    :try_start_4
    iget-object v2, p0, mMediaRouterService:Landroid/media/IMediaRouterService;

    iget-object v3, p0, mClient:Landroid/media/IMediaRouterClient;

    iget-object v1, p0, mSelectedRoute:Landroid/media/MediaRouter$RouteInfo;
...
.method rebindAsUser(I)V
    ...
    iput-object v2, p0, mClient:Landroid/media/IMediaRouterClient;
    ...
    iget-object v3, p0, mAppContext:Landroid/content/Context;
    ...
    .line 355
    iput-object v0, p0, mClient:Landroid/media/IMediaRouterClient;
    :try_end_2c
    ...
    :goto_2c
    invoke-virtual {p0}, publishClientDiscoveryRequest()V

    .line 361
    const/4 v2, 0x0

    invoke-virtual {p0, v2}, publishClientSelectedRoute(Z)V

    .line 362
    invoke-virtual {p0}, updateClientState()V
...
.method setSelectedRoute(Landroid/media/MediaRouter$RouteInfo;Z)V
    ...
    .prologue
    .line 334
    iput-object p1, p0, mSelectedRoute:Landroid/media/MediaRouter$RouteInfo;

    .line 335
    invoke-virtual {p0, p2}, publishClientSelectedRoute(Z)V
...
.method startMonitoringRoutes(Landroid/content/Context;)V
    ...
    iget-object v2, p0, mSystemCategory:Landroid/media/MediaRouter$RouteCategory;

    invoke-direct {v1, v2}, Landroid/media/MediaRouter$RouteInfo;-><init>(Landroid/media/MediaRouter$RouteCategory;)V

    iput-object v1, p0, mDefaultAudioVideo:Landroid/media/MediaRouter$RouteInfo;

    .line 136
    iget-object v1, p0, mDefaultAudioVideo:Landroid/media/MediaRouter$RouteInfo;
    ...
    .line 142
    iget-object v1, p0, mDisplayService:Landroid/hardware/display/DisplayManager;
    ...
    iget-object v2, p0, mAudioRoutesObserver:Landroid/media/IAudioRoutesObserver$Stub;
    ...
    .line 160
    invoke-virtual {p0, v0}, updateAudioRoutes(Landroid/media/AudioRoutesInfo;)V
    ...
    invoke-virtual {p0, v1}, rebindAsUser(I)V
...
.method updateAudioRoutes(Landroid/media/AudioRoutesInfo;)V
    ...
    iget-object v5, p0, mCurAudioRoutesInfo:Landroid/media/AudioRoutesInfo;
    ...
    .line 175
    iget-object v4, p0, mCurAudioRoutesInfo:Landroid/media/AudioRoutesInfo;
    ...
    iget-object v4, v4, mDefaultAudioVideo:Landroid/media/MediaRouter$RouteInfo;
    ...
    iget-object v4, v4, mBluetoothA2dpRoute:Landroid/media/MediaRouter$RouteInfo;
    ...
    iget-object v4, v4, mSystemCategory:Landroid/media/MediaRouter$RouteCategory;
    ...
    iget-object v4, v4, mResources:Landroid/content/res/Resources;
    ...
    iput-object v1, v4, mBluetoothA2dpRoute:Landroid/media/MediaRouter$RouteInfo;
    ...
    :cond_77
    :goto_77
    iget-object v4, p0, mBluetoothA2dpRoute:Landroid/media/MediaRouter$RouteInfo;

    if-eqz v4, :cond_8e

    .line 215
    invoke-virtual {p0}, isBluetoothA2dpOn()Z
    ...
    iget-object v4, p0, mSelectedRoute:Landroid/media/MediaRouter$RouteInfo;

    iget-object v5, p0, mBluetoothA2dpRoute:Landroid/media/MediaRouter$RouteInfo;
    ...
    .line 218
    iget-object v4, p0, mDefaultAudioVideo:Landroid/media/MediaRouter$RouteInfo;
    ...
    iput-object v5, v4, mBluetoothA2dpRoute:Landroid/media/MediaRouter$RouteInfo;
    ...
    iget-object v5, p0, mDefaultAudioVideo:Landroid/media/MediaRouter$RouteInfo;
...
.method updateClientState()V
    ...
    .line 391
    iput-object v10, p0, mClientState:Landroid/media/MediaRouterClientState;

    .line 392
    iget-object v12, p0, mClient:Landroid/media/IMediaRouterClient;

    if-eqz v12, :cond_12

    .line 394
    :try_start_8
    iget-object v12, p0, mMediaRouterService:Landroid/media/IMediaRouterService;

    iget-object v13, p0, mClient:Landroid/media/IMediaRouterClient;
    ...
    iput-object v12, p0, mClientState:Landroid/media/MediaRouterClientState;
    :try_end_12
    ...
    :cond_12
    :goto_12
    iget-object v12, p0, mClientState:Landroid/media/MediaRouterClientState;
    ...
    iget-object v10, p0, mClientState:Landroid/media/MediaRouterClientState;
    ...
    invoke-virtual {p0, v10}, findGlobalRoute(Ljava/lang/String;)Landroid/media/MediaRouter$RouteInfo;
    ...
    .line 410
    invoke-virtual {p0, v1}, makeGlobalRoute(Landroid/media/MediaRouterClientState$RouteInfo;)Landroid/media/MediaRouter$RouteInfo;
    ...
    :cond_52
    invoke-virtual {p0, v9, v1}, updateGlobalRoute(Landroid/media/MediaRouter$RouteInfo;Landroid/media/MediaRouterClientState$RouteInfo;)V
    ...
    .line 419
    invoke-virtual {p0, v5}, findGlobalRoute(Ljava/lang/String;)Landroid/media/MediaRouter$RouteInfo;
    ...
    :cond_76
    :goto_76
    iget-object v10, p0, mRoutes:Ljava/util/ArrayList;
    ...
    .restart local v6    # "i":I
    :cond_a0
    iget-object v10, p0, mSelectedRoute:Landroid/media/MediaRouter$RouteInfo;
    ...
    iget-object v12, p0, mSelectedRoute:Landroid/media/MediaRouter$RouteInfo;
...
.method updateDiscoveryRequest()V
    ...
    iget-object v7, p0, mCallbacks:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 273
    :cond_42
    iget-boolean v7, p0, mCanConfigureWifiDisplays:Z

    if-eqz v7, :cond_62

    .line 274
    iget-object v7, p0, mSelectedRoute:Landroid/media/MediaRouter$RouteInfo;
    ...
    .line 281
    iget-boolean v7, p0, mActivelyScanningWifiDisplays:Z
    ...
    iput-boolean v7, p0, mActivelyScanningWifiDisplays:Z

    .line 283
    iget-object v7, p0, mDisplayService:Landroid/hardware/display/DisplayManager;
    ...
    :cond_62
    :goto_62
    iget v7, p0, mDiscoveryRequestRouteTypes:I

    if-ne v6, v7, :cond_6a

    iget-boolean v7, p0, mDiscoverRequestActiveScan:Z

    if-eq v0, v7, :cond_71

    .line 296
    :cond_6a
    iput v6, p0, mDiscoveryRequestRouteTypes:I

    .line 297
    iput-boolean v0, p0, mDiscoverRequestActiveScan:Z
