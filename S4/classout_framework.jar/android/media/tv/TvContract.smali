...
.method public static final buildChannelLogoUri(J)Landroid/net/Uri;
    ...
    .prologue
    .line 138
    invoke-static {p0, p1}, buildChannelUri(J)Landroid/net/Uri;

    move-result-object v0

    invoke-static {v0}, buildChannelLogoUri(Landroid/net/Uri;)Landroid/net/Uri;
...
.method public static final buildChannelLogoUri(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .prologue
    .line 147
    invoke-static {p0}, isChannelUriForTunerInput(Landroid/net/Uri;)Z
...
.method public static final buildChannelsUriForInput(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0, v0}, buildChannelsUriForInput(Ljava/lang/String;Z)Landroid/net/Uri;
...
.method public static final buildChannelsUriForInput(Ljava/lang/String;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    .line 199
    invoke-static {p0, p2}, buildChannelsUriForInput(Ljava/lang/String;Z)Landroid/net/Uri;
...
.method public static final buildProgramsUriForChannel(JJJ)Landroid/net/Uri;
    ...
    .prologue
    .line 251
    invoke-static {p0, p1}, buildProgramsUriForChannel(J)Landroid/net/Uri;
...
.method public static final buildProgramsUriForChannel(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-static {v0, v1}, buildProgramsUriForChannel(J)Landroid/net/Uri;
...
.method public static final buildProgramsUriForChannel(Landroid/net/Uri;JJ)Landroid/net/Uri;
    ...
    invoke-static/range {v0 .. v5}, buildProgramsUriForChannel(JJJ)Landroid/net/Uri;
...
.method public static final isChannelUri(Landroid/net/Uri;)Z
    ...
    invoke-static {p0}, isChannelUriForPassthroughInput(Landroid/net/Uri;)Z
...
.method public static final isChannelUriForPassthroughInput(Landroid/net/Uri;)Z
    ...
    .prologue
    .line 316
    invoke-static {p0}, isTvUri(Landroid/net/Uri;)Z
    ...
    invoke-static {p0, v0}, isTwoSegmentUriStartingWith(Landroid/net/Uri;Ljava/lang/String;)Z
