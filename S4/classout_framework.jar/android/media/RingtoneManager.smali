...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    .line 255
    iput-boolean v1, p0, mStopPreviousRingtone:Z
...
.method private static checkDefaultRingtoneProperUri(Landroid/content/Context;I)V
    ...
    .prologue
    .line 831
    invoke-static/range {p1 .. p1}, getDefaultSoundUriField(I)Ljava/lang/String;

    move-result-object v17

    .line 832
    .local v17, "soundUri":Ljava/lang/String;
    invoke-static/range {p1 .. p1}, getDefaultSoundConstantPathField(I)Ljava/lang/String;
    ...
    invoke-static {v2, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_94
    .catch Ljava/lang/Exception; {:try_start_5c .. :try_end_94} :catch_138
    .catchall {:try_start_5c .. :try_end_94} :catchall_182
    ...
    :try_end_124
    .catch Ljava/lang/Exception; {:try_start_a0 .. :try_end_124} :catch_138
    .catchall {:try_start_a0 .. :try_end_124} :catchall_182
    ...
    invoke-static {v2, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_137
    .catch Ljava/lang/Exception; {:try_start_130 .. :try_end_137} :catch_138
    .catchall {:try_start_130 .. :try_end_137} :catchall_182
    ...
    invoke-static {v2, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_176
    .catchall {:try_start_139 .. :try_end_176} :catchall_182
...
.method public static getActualDefaultRingtoneUri(Landroid/content/Context;I)Landroid/net/Uri;
    ...
    .line 761
    invoke-static {p0, p1}, checkDefaultRingtoneProperUri(Landroid/content/Context;I)V
...
.method private getInternalRingtones()Landroid/database/Cursor;
    ...
    sget-object v2, INTERNAL_COLUMNS:[Ljava/lang/String;

    iget-object v0, p0, mFilterColumns:Ljava/util/List;

    invoke-static {v0}, constructBooleanTrueWhereClause(Ljava/util/List;)Ljava/lang/String;
...
.method public static getRingtone(Landroid/content/Context;Landroid/net/Uri;)Landroid/media/Ringtone;
    ...
    invoke-static {p0, p1, v0}, getRingtone(Landroid/content/Context;Landroid/net/Uri;I)Landroid/media/Ringtone;
...
.method public static getValidRingtoneUri(Landroid/content/Context;)Landroid/net/Uri;
    ...
    invoke-direct {v0}, getInternalRingtones()Landroid/database/Cursor;

    move-result-object v2

    invoke-static {p0, v2}, getValidRingtoneUriFromCursorAndClose(Landroid/content/Context;Landroid/database/Cursor;)Landroid/net/Uri;
    ...
    .line 512
    invoke-direct {v0}, getMediaRingtones()Landroid/database/Cursor;
...
.method private static getValidRingtoneUriFromCursorAndClose(Landroid/content/Context;Landroid/database/Cursor;)Landroid/net/Uri;
    ...
    .line 523
    invoke-static {p1}, getUriFromCursor(Landroid/database/Cursor;)Landroid/net/Uri;
...
.method public static isDefault(Landroid/net/Uri;)Z
    ...
    .prologue
    .line 1074
    invoke-static {p0}, getDefaultType(Landroid/net/Uri;)I
...
.method public static setActualDefaultRingtoneUri(Landroid/content/Context;ILandroid/net/Uri;)V
    ...
    invoke-static {p0, p1, p2, v0}, setActualDefaultRingtoneUri(Landroid/content/Context;ILandroid/net/Uri;I)V
...
.method public static setActualDefaultRingtoneUri(Landroid/content/Context;ILandroid/net/Uri;I)V
    ...
    invoke-static {p1}, getDefaultSoundConstantPathField(I)Ljava/lang/String;
...
.method public getCursor()Landroid/database/Cursor;
    ...
    invoke-direct {p0}, getMediaRingtones()Landroid/database/Cursor;
    ...
    iput-object v2, p0, mCursor:Landroid/database/Cursor;
...
.method public getRingtone(I)Landroid/media/Ringtone;
    ...
    .prologue
    .line 418
    iget-boolean v0, p0, mStopPreviousRingtone:Z

    if-eqz v0, :cond_d

    iget-object v0, p0, mPreviousRingtone:Landroid/media/Ringtone;
    ...
    invoke-virtual {p0, p1}, getRingtoneUri(I)Landroid/net/Uri;

    move-result-object v1

    invoke-virtual {p0}, inferStreamType()I

    move-result v2

    invoke-static {v0, v1, v2}, getRingtone(Landroid/content/Context;Landroid/net/Uri;I)Landroid/media/Ringtone;

    move-result-object v0

    iput-object v0, p0, mPreviousRingtone:Landroid/media/Ringtone;
...
.method public getRingtone(II)Landroid/media/Ringtone;
    ...
    invoke-static {v0, v1, v2, p2}, getRingtone(Landroid/content/Context;Landroid/net/Uri;II)Landroid/media/Ringtone;
...
.method public getRingtoneUri(I)Landroid/net/Uri;
    ...
    invoke-static {v2}, getUriFromCursor(Landroid/database/Cursor;)Landroid/net/Uri;
    :try_end_1b
...
.method public setStopPreviousRingtone(Z)V
    ...
    .prologue
    .line 332
    iput-boolean p1, p0, mStopPreviousRingtone:Z
