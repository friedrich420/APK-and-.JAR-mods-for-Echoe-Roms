...
.method public constructor <init>(Landroid/media/session/MediaSessionLegacyHelper;Landroid/media/session/MediaSession;Landroid/app/PendingIntent;)V
    ...
    .prologue
    .line 569
    iput-object p1, p0, this$0:Landroid/media/session/MediaSessionLegacyHelper;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 570
    iput-object p2, p0, mSession:Landroid/media/session/MediaSession;

    .line 571
    iput-object p3, p0, mPi:Landroid/app/PendingIntent;
...
.method public update()V
    ...
    .line 575
    iget-object v1, p0, mMediaButtonListener:Landroid/media/session/MediaSessionLegacyHelper$MediaButtonListener;

    if-nez v1, :cond_21

    iget-object v1, p0, mRccListener:Landroid/media/session/MediaSession$Callback;
    ...
    .line 578
    iput-object v2, p0, mCb:Landroid/media/session/MediaSessionLegacyHelper$SessionHolder$SessionCallback;

    .line 579
    iget-object v1, p0, this$0:Landroid/media/session/MediaSessionLegacyHelper;
    ...
    iget-object v2, p0, mPi:Landroid/app/PendingIntent;
    ...
    .line 580
    :cond_21
    iget-object v1, p0, mCb:Landroid/media/session/MediaSessionLegacyHelper$SessionHolder$SessionCallback;
    ...
    iput-object v1, p0, mCb:Landroid/media/session/MediaSessionLegacyHelper$SessionHolder$SessionCallback;
    ...
    iget-object v2, p0, mCb:Landroid/media/session/MediaSessionLegacyHelper$SessionHolder$SessionCallback;
