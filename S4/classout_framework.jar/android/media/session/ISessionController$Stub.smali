...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_35
    invoke-virtual {p0, v0, v2, v3}, sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    :goto_53
    invoke-virtual {p0, v0}, sendMediaButton(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v0}, registerCallbackListener(Landroid/media/session/ISessionControllerCallback;)V
    ...
    invoke-virtual {p0, v0}, unregisterCallbackListener(Landroid/media/session/ISessionControllerCallback;)V
    ...
    .line 108
    invoke-virtual {p0}, isTransportControlEnabled()Z
    ...
    .line 124
    invoke-virtual {p0}, getTag()Ljava/lang/String;
    ...
    .line 132
    invoke-virtual {p0}, getLaunchPendingIntent()Landroid/app/PendingIntent;
    ...
    .line 154
    invoke-virtual {p0}, getVolumeAttributes()Landroid/media/session/ParcelableVolumeInfo;
    ...
    invoke-virtual {p0, v0, v2, v3}, adjustVolume(IILjava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, setVolumeTo(IILjava/lang/String;)V
    ...
    .local v2, "_arg1":Landroid/os/Bundle;
    :goto_15f
    invoke-virtual {p0, v0, v2}, playFromMediaId(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .restart local v2    # "_arg1":Landroid/os/Bundle;
    :goto_180
    invoke-virtual {p0, v0, v2}, playFromSearch(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 235
    .local v0, "_arg0":J
    invoke-virtual {p0, v0, v1}, skipToQueueItem(J)V
    ...
    .line 270
    invoke-virtual {p0}, fastForward()V
    ...
    invoke-virtual {p0, v0, v1}, seekTo(J)V
    ...
    .line 304
    .local v2, "_arg1":I
    invoke-virtual {p0, v0, v1, v2}, setRemoteControlClientPlayItem(JI)V
    ...
    :goto_23c
    invoke-virtual {p0, v0}, rate(Landroid/media/Rating;)V
    ...
    .local v2, "_arg1":Landroid/os/Bundle;
    :goto_25d
    invoke-virtual {p0, v0, v2}, sendCustomAction(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 348
    invoke-virtual {p0}, getMetadata()Landroid/media/MediaMetadata;
    ...
    .line 362
    invoke-virtual {p0}, getPlaybackState()Landroid/media/session/PlaybackState;
    ...
    .line 376
    invoke-virtual {p0}, getQueue()Landroid/content/pm/ParceledListSlice;
    ...
    .line 390
    invoke-virtual {p0}, getQueueTitle()Ljava/lang/CharSequence;
    ...
    .line 418
    invoke-virtual {p0}, getRatingType()I
