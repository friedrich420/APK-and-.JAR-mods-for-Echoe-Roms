...
.method public constructor <init>(Landroid/content/Context;Landroid/media/session/ISessionController;)V
    ...
    iput-object v0, p0, mCbStub:Landroid/media/session/MediaController$CallbackStub;
    ...
    iput-boolean v0, p0, mCbRegistered:Z
    ...
    .line 99
    :cond_2f
    iput-object p2, p0, mSessionBinder:Landroid/media/session/ISessionController;
    ...
    iput-object v0, p0, mTransportControls:Landroid/media/session/MediaController$TransportControls;
    ...
    iput-object v0, p0, mToken:Landroid/media/session/MediaSession$Token;
...
.method public constructor <init>(Landroid/content/Context;Landroid/media/session/MediaSession$Token;)V
    ...
    invoke-direct {p0, p1, v0}, <init>(Landroid/content/Context;Landroid/media/session/ISessionController;)V
...
.method static synthetic access$200(Landroid/media/session/MediaController;)Landroid/media/session/ISessionController;
    ...
    .prologue
    .line 56
    iget-object v0, p0, mSessionBinder:Landroid/media/session/ISessionController;
...
.method static synthetic access$300(Landroid/media/session/MediaController;ILjava/lang/Object;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 56
    invoke-direct {p0, p1, p2, p3}, postMessage(ILjava/lang/Object;Landroid/os/Bundle;)V
...
.method private addCallbackLocked(Landroid/media/session/MediaController$Callback;Landroid/os/Handler;)V
    ...
    .prologue
    .line 450
    invoke-direct {p0, p1}, getHandlerForCallbackLocked(Landroid/media/session/MediaController$Callback;)Landroid/media/session/MediaController$MessageHandler;
    ...
    .line 457
    iget-boolean v2, p0, mCbRegistered:Z

    if-nez v2, :cond_d

    .line 459
    :try_start_20
    iget-object v2, p0, mSessionBinder:Landroid/media/session/ISessionController;

    iget-object v3, p0, mCbStub:Landroid/media/session/MediaController$CallbackStub;
    ...
    iput-boolean v2, p0, mCbRegistered:Z
    :try_end_2a
...
.method private removeCallbackLocked(Landroid/media/session/MediaController$Callback;)Z
    ...
    .line 469
    .local v3, "success":Z
    iget-object v4, p0, mCallbacks:Ljava/util/ArrayList;
    ...
    :cond_22
    iget-boolean v4, p0, mCbRegistered:Z
    ...
    .line 478
    :try_start_2e
    iget-object v4, p0, mSessionBinder:Landroid/media/session/ISessionController;

    iget-object v5, p0, mCbStub:Landroid/media/session/MediaController$CallbackStub;
    ...
    iput-boolean v4, p0, mCbRegistered:Z
...
.method public adjustVolume(II)V
    ...
    .line 329
    :try_start_0
    iget-object v1, p0, mSessionBinder:Landroid/media/session/ISessionController;
...
.method public controlsSameSession(Landroid/media/session/MediaController;)Z
    ...
    invoke-virtual {p1}, getSessionBinder()Landroid/media/session/ISessionController;
...
.method public getSessionToken()Landroid/media/session/MediaSession$Token;
    ...
    .prologue
    .line 292
    iget-object v0, p0, mToken:Landroid/media/session/MediaSession$Token;
...
.method public getTag()Ljava/lang/String;
    ...
    iput-object v1, p0, mTag:Ljava/lang/String;
    :try_end_c
    .catch Landroid/os/RemoteException; {:try_start_4 .. :try_end_c} :catch_f
...
.method public getTransportControls()Landroid/media/session/MediaController$TransportControls;
    ...
    .prologue
    .line 122
    iget-object v0, p0, mTransportControls:Landroid/media/session/MediaController$TransportControls;
...
.method public registerCallback(Landroid/media/session/MediaController$Callback;)V
    ...
    invoke-virtual {p0, p1, v0}, registerCallback(Landroid/media/session/MediaController$Callback;Landroid/os/Handler;)V
...
.method public registerCallback(Landroid/media/session/MediaController$Callback;Landroid/os/Handler;)V
    ...
    .line 361
    :try_start_14
    invoke-direct {p0, p1, p2}, addCallbackLocked(Landroid/media/session/MediaController$Callback;Landroid/os/Handler;)V
...
.method public unregisterCallback(Landroid/media/session/MediaController$Callback;)V
    ...
    .line 376
    :try_start_d
    invoke-direct {p0, p1}, removeCallbackLocked(Landroid/media/session/MediaController$Callback;)Z
