...
.method public addCustomAction(Ljava/lang/String;Ljava/lang/String;I)Landroid/media/session/PlaybackState$Builder;
    ...
    invoke-virtual {p0, v0}, addCustomAction(Landroid/media/session/PlaybackState$CustomAction;)Landroid/media/session/PlaybackState$Builder;
...
.method public build()Landroid/media/session/PlaybackState;
    ...
    iget-wide v4, v0, mPosition:J

    move-object/from16 v0, p0

    iget-wide v6, v0, mUpdateTime:J
    ...
    iget-wide v9, v0, mBufferedPosition:J

    move-object/from16 v0, p0

    iget-wide v11, v0, mActions:J

    move-object/from16 v0, p0

    iget-object v13, v0, mCustomActions:Ljava/util/List;

    move-object/from16 v0, p0

    iget-wide v14, v0, mActiveItemId:J

    move-object/from16 v0, p0

    iget-object v0, v0, mErrorMessage:Ljava/lang/CharSequence;
...
.method public setActiveQueueItemId(J)Landroid/media/session/PlaybackState$Builder;
    ...
    .prologue
    .line 933
    iput-wide p1, p0, mActiveItemId:J
...
.method public setBufferedPosition(J)Landroid/media/session/PlaybackState$Builder;
    ...
    .prologue
    .line 921
    iput-wide p1, p0, mBufferedPosition:J
...
.method public setErrorMessage(Ljava/lang/CharSequence;)Landroid/media/session/PlaybackState$Builder;
    ...
    .prologue
    .line 945
    iput-object p1, p0, mErrorMessage:Ljava/lang/CharSequence;
...
.method public setState(IJF)Landroid/media/session/PlaybackState$Builder;
    ...
    invoke-virtual/range {v0 .. v6}, setState(IJFJ)Landroid/media/session/PlaybackState$Builder;
