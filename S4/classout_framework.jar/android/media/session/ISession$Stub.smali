...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_27
    invoke-virtual {p0, v0, v1}, sendEvent(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 68
    invoke-virtual {p0}, getController()Landroid/media/session/ISessionController;
    ...
    :goto_7e
    invoke-virtual {p0, v0}, setMediaButtonReceiver(Landroid/app/PendingIntent;)V
    ...
    .restart local v0    # "_arg0":Landroid/app/PendingIntent;
    :goto_9a
    invoke-virtual {p0, v0}, setLaunchPendingIntent(Landroid/app/PendingIntent;)V
    ...
    :goto_c4
    invoke-virtual {p0, v0}, setMetadata(Landroid/media/MediaMetadata;)V
    ...
    :goto_e1
    invoke-virtual {p0, v0}, setPlaybackState(Landroid/media/session/PlaybackState;)V
    ...
    :goto_fe
    invoke-virtual {p0, v0}, setQueue(Landroid/content/pm/ParceledListSlice;)V
    ...
    :goto_11b
    invoke-virtual {p0, v0}, setQueueTitle(Ljava/lang/CharSequence;)V
    ...
    :goto_138
    invoke-virtual {p0, v0}, setExtras(Landroid/os/Bundle;)V
    ...
    .line 201
    .local v0, "_arg0":I
    invoke-virtual {p0, v0}, setRatingType(I)V
    ...
    .local v0, "_arg0":Z
    :cond_15f
    invoke-virtual {p0, v0}, playItemResponse(Z)V
    ...
    .line 219
    .local v0, "_arg0":[J
    invoke-virtual {p0, v0}, updateNowPlayingEntries([J)V
    ...
    .line 228
    .local v0, "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v0}, updateFolderInfoBrowsedPlayer(Ljava/lang/String;)V
    ...
    .line 235
    invoke-virtual {p0}, updateNowPlayingContentChange()V
    ...
    :goto_1a9
    invoke-virtual {p0, v0}, setPlaybackToLocal(Landroid/media/AudioAttributes;)V
    ...
    .line 260
    .local v1, "_arg1":I
    invoke-virtual {p0, v0, v1}, setPlaybackToRemote(II)V
    ...
    invoke-virtual {p0, v0}, setCurrentVolume(I)V
