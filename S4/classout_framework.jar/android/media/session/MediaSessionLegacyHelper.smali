...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mSessions:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mSessionManager:Landroid/media/session/MediaSessionManager;
...
.method static synthetic access$400(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    .line 57
    invoke-static {p0, p1, p2}, sendKeyEvent(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/content/Intent;)V
...
.method static synthetic access$500(Landroid/media/session/MediaSessionLegacyHelper;)Landroid/util/ArrayMap;
    ...
    .prologue
    .line 57
    iget-object v0, p0, mSessions:Landroid/util/ArrayMap;
...
.method public static getHelper(Landroid/content/Context;)Landroid/media/session/MediaSessionLegacyHelper;
    ...
    .line 97
    :try_start_1f
    sget-object v0, sInstance:Landroid/media/session/MediaSessionLegacyHelper;
    ...
    sput-object v0, sInstance:Landroid/media/session/MediaSessionLegacyHelper;
...
.method private getHolder(Landroid/app/PendingIntent;Z)Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;
    ...
    .prologue
    .line 471
    iget-object v2, p0, mSessions:Landroid/util/ArrayMap;
...
.method public static getOldMetadata(Landroid/media/MediaMetadata;II)Landroid/os/Bundle;
    ...
    invoke-static {v0, p1, p2}, scaleBitmapIfTooBig(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method private handleVolumeKeyLongPress(IIZ)V
    ...
    .line 269
    iget-object v0, p0, mVolumeKeyLongPressControlThread:Landroid/media/session/MediaSessionLegacyHelper$VolumeKeyLongPressControlThread;
    ...
    iput-object v0, p0, mVolumeKeyLongPressControlThread:Landroid/media/session/MediaSessionLegacyHelper$VolumeKeyLongPressControlThread;
    ...
    .line 277
    iput-object v1, p0, mVolumeKeyLongPressControlThread:Landroid/media/session/MediaSessionLegacyHelper$VolumeKeyLongPressControlThread;
...
.method public addMediaButtonListener(Landroid/app/PendingIntent;Landroid/content/ComponentName;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1}, getHolder(Landroid/app/PendingIntent;Z)Landroid/media/session/MediaSessionLegacyHelper$SessionHolder;
...
.method public getSession(Landroid/app/PendingIntent;)Landroid/media/session/MediaSession;
    ...
    .prologue
    .line 191
    iget-object v1, p0, mSessions:Landroid/util/ArrayMap;
...
.method public sendVolumeKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    iget-object v4, p0, mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    .line 328
    invoke-direct {p0, v0, v2, v1}, handleVolumeKeyLongPress(IIZ)V

    .line 331
    :cond_4c
    iget-object v4, p0, mSessionManager:Landroid/media/session/MediaSessionManager;
