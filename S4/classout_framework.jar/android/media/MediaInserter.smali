...
.method public constructor <init>(Landroid/content/IContentProvider;Ljava/lang/String;I)V
    ...
    iput-object v0, p0, mRowMap:Ljava/util/HashMap;
    ...
    iput-object v0, p0, mPriorityRowMap:Ljava/util/HashMap;
    ...
    .line 47
    iput-object p1, p0, mProvider:Landroid/content/IContentProvider;

    .line 48
    iput-object p2, p0, mPackageName:Ljava/lang/String;

    .line 49
    iput p3, p0, mBufferSizePerUri:I
...
.method private flush(Landroid/net/Uri;Ljava/util/List;)V
    ...
    iget-object v1, p0, mProvider:Landroid/content/IContentProvider;
...
.method private flushAllPriority()V
    ...
    .prologue
    .line 92
    iget-object v3, p0, mPriorityRowMap:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v2, v1}, flush(Landroid/net/Uri;Ljava/util/List;)V
...
.method private insert(Landroid/net/Uri;Landroid/content/ContentValues;Z)V
    ...
    iget-object v1, p0, mPriorityRowMap:Ljava/util/HashMap;
    ...
    iget v3, p0, mBufferSizePerUri:I

    if-lt v2, v3, :cond_2a

    .line 69
    invoke-direct {p0}, flushAllPriority()V

    .line 70
    invoke-direct {p0, p1, v0}, flush(Landroid/net/Uri;Ljava/util/List;)V
    ...
    :cond_2b
    iget-object v1, p0, mRowMap:Ljava/util/HashMap;
...
.method public clear()V
    ...
    .prologue
    .line 85
    iget-object v0, p0, mRowMap:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    .line 86
    iget-object v0, p0, mPriorityRowMap:Ljava/util/HashMap;
...
.method public flushAll()V
    ...
    .line 76
    iget-object v3, p0, mRowMap:Ljava/util/HashMap;
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)V
    ...
    invoke-direct {p0, p1, p2, v0}, insert(Landroid/net/Uri;Landroid/content/ContentValues;Z)V
