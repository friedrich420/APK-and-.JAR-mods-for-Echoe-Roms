...
.method protected constructor <init>(IIII)V
    ...
    .line 125
    :cond_37
    invoke-direct {p0}, getNumPlanesFromFormat()I

    move-result v0

    iput v0, p0, mNumPlanes:I
    ...
    invoke-direct/range {v0 .. v5}, nativeInit(Ljava/lang/Object;IIII)V

    .line 129
    invoke-direct {p0}, nativeGetSurface()Landroid/view/Surface;
...
.method static synthetic access$400(Landroid/media/ImageReader;)Landroid/media/ImageReader$OnImageAvailableListener;
    ...
    .prologue
    .line 50
    iget-object v0, p0, mListener:Landroid/media/ImageReader$OnImageAvailableListener;
...
.method static synthetic access$500(Landroid/media/ImageReader;Landroid/media/Image;)V
    ...
    .prologue
    .line 50
    invoke-direct {p0, p1}, releaseImage(Landroid/media/Image;)V
...
.method private acquireNextSurfaceImage(Landroid/media/ImageReader$SurfaceImage;)I
    ...
    .prologue
    .line 297
    invoke-direct {p0, p1}, nativeImageSetup(Landroid/media/Image;)I
...
.method public static newInstance(IIII)Landroid/media/ImageReader;
    ...
    invoke-direct {v0, p0, p1, p2, p3}, <init>(IIII)V
...
.method private static postEventFromNative(Ljava/lang/Object;)V
    ...
    .line 507
    :cond_c
    iget-object v4, v1, mListenerLock:Ljava/lang/Object;

    monitor-enter v4

    .line 508
    :try_start_f
    iget-object v0, v1, mListenerHandler:Landroid/media/ImageReader$ListenerHandler;
...
.method private releaseImage(Landroid/media/Image;)V
    ...
    .line 375
    invoke-direct {p0, p1}, nativeReleaseImage(Landroid/media/Image;)V
...
.method public acquireLatestImage()Landroid/media/Image;
    ...
    .prologue
    .line 247
    invoke-virtual {p0}, acquireNextImage()Landroid/media/Image;
    ...
    :cond_c
    invoke-virtual {p0}, acquireNextImageNoThrowISE()Landroid/media/Image;
    :try_end_f
...
.method public acquireNextImage()Landroid/media/Image;
    ...
    .line 343
    .local v0, "si":Landroid/media/ImageReader$SurfaceImage;
    invoke-direct {p0, v0}, acquireNextSurfaceImage(Landroid/media/ImageReader$SurfaceImage;)I
...
.method public close()V
    ...
    .line 444
    invoke-virtual {p0, v0, v0}, setOnImageAvailableListener(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V

    .line 445
    invoke-direct {p0}, nativeClose()V
...
.method public setOnImageAvailableListener(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V
    ...
    .prologue
    .line 392
    iget-object v2, p0, mListenerLock:Ljava/lang/Object;
    ...
    :cond_1d
    iget-object v1, p0, mListenerHandler:Landroid/media/ImageReader$ListenerHandler;
    ...
    iput-object v1, p0, mListenerHandler:Landroid/media/ImageReader$ListenerHandler;

    .line 402
    :cond_30
    iput-object p1, p0, mListener:Landroid/media/ImageReader$OnImageAvailableListener;
    ...
    iput-object v1, p0, mListener:Landroid/media/ImageReader$OnImageAvailableListener;
