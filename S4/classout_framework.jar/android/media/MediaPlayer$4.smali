...
.method constructor <init>(Landroid/media/MediaPlayer;Ljava/io/FileDescriptor;JJLandroid/media/SubtitleTrack;Landroid/os/HandlerThread;)V
    ...
    iput-object p2, p0, val$fd3:Ljava/io/FileDescriptor;

    iput-wide p3, p0, val$offset2:J

    iput-wide p5, p0, val$length2:J

    iput-object p7, p0, val$track:Landroid/media/SubtitleTrack;

    iput-object p8, p0, val$thread:Landroid/os/HandlerThread;
...
.method private addTrack()I
    ...
    iget-object v8, p0, val$fd3:Ljava/io/FileDescriptor;

    iget-wide v10, p0, val$offset2:J
    ...
    iget-wide v10, p0, val$length2:J
    ...
    .line 2802
    .local v5, "remain":I
    iget-object v7, p0, val$fd3:Ljava/io/FileDescriptor;
    ...
    :cond_30
    iget-object v7, p0, val$track:Landroid/media/SubtitleTrack;
...
.method public run()V
    ...
    .prologue
    .line 2827
    invoke-direct {p0}, addTrack()I

    move-result v1

    .line 2828
    .local v1, "res":I
    iget-object v2, p0, this$0:Landroid/media/MediaPlayer;
    ...
    :cond_23
    iget-object v2, p0, val$thread:Landroid/os/HandlerThread;
