...
.method static constructor <clinit>()V
    ...
    sput-object v0, sThumbFiles:Ljava/util/Hashtable;
...
.method public constructor <init>(Landroid/net/Uri;)V
    ...
    iput-object v0, p0, mIndexBuffer:Ljava/nio/ByteBuffer;
...
.method private indexFile()Ljava/io/RandomAccessFile;
    ...
    .prologue
    .line 156
    iget-object v4, p0, mIndexFile:Ljava/io/RandomAccessFile;

    if-nez v4, :cond_58

    .line 157
    invoke-direct {p0}, removeOldIndexFile()V

    .line 158
    const/4 v4, 0x3

    invoke-direct {p0, v4}, indexFilePath(I)Ljava/lang/String;
    ...
    iput-object v4, p0, mIndexFile:Ljava/io/RandomAccessFile;
    :try_end_4c
    ...
    iput-object v4, p0, mIndexChannel:Ljava/nio/channels/FileChannel;
...
.method public static declared-synchronized instance(Landroid/net/Uri;)Landroid/media/MiniThumbFile;
    ...
    sget-object v2, sThumbFiles:Ljava/util/Hashtable;
    ...
    invoke-direct {v0, v2}, <init>(Landroid/net/Uri;)V
...
.method private miniThumbDataFile()Ljava/io/RandomAccessFile;
    ...
    .prologue
    .line 107
    iget-object v4, p0, mMiniThumbFile:Ljava/io/RandomAccessFile;

    if-nez v4, :cond_58

    .line 108
    invoke-direct {p0}, removeOldFile()V

    .line 109
    const/4 v4, 0x3

    invoke-direct {p0, v4}, randomAccessFilePath(I)Ljava/lang/String;
    ...
    iput-object v4, p0, mMiniThumbFile:Ljava/io/RandomAccessFile;
    :try_end_4c
    .catch Ljava/io/IOException; {:try_start_42 .. :try_end_4c} :catch_5b
    ...
    iput-object v4, p0, mChannel:Ljava/nio/channels/FileChannel;
...
.method private removeOldFile()V
    ...
    invoke-direct {p0, v2}, randomAccessFilePath(I)Ljava/lang/String;
...
.method private removeOldIndexFile()V
    ...
    invoke-direct {p0, v2}, indexFilePath(I)Ljava/lang/String;
...
.method public static declared-synchronized reset()V
    ...
    .line 69
    .local v0, "file":Landroid/media/MiniThumbFile;
    invoke-virtual {v0}, deactivate()V
    :try_end_1c
...
.method public declared-synchronized deactivate()V
    ...
    :try_start_1
    iget-object v0, p0, mMiniThumbFile:Ljava/io/RandomAccessFile;
    :try_end_3
    ...
    iput-object v0, p0, mMiniThumbFile:Ljava/io/RandomAccessFile;
    :try_end_d
    ...
    :goto_d
    :try_start_d
    iget-object v0, p0, mIndexFile:Ljava/io/RandomAccessFile;
    :try_end_f
    ...
    iput-object v0, p0, mIndexFile:Ljava/io/RandomAccessFile;
    :try_end_19
...
.method public declared-synchronized getMagic(J)J
    ...
    :try_start_1
    invoke-direct/range {p0 .. p0}, miniThumbDataFile()Ljava/io/RandomAccessFile;

    move-result-object v16

    .line 218
    .local v16, "r":Ljava/io/RandomAccessFile;
    invoke-direct/range {p0 .. p0}, indexFile()Ljava/io/RandomAccessFile;
    :try_end_8
    ...
    iget-object v3, v0, mIndexBuffer:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v0, mIndexChannel:Ljava/nio/channels/FileChannel;
    ...
    iget-object v6, v0, mIndexBuffer:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v0, mBuffer:Ljava/nio/ByteBuffer;
    ...
    iget-object v7, v0, mChannel:Ljava/nio/channels/FileChannel;
    ...
    iget-object v3, v0, mChannel:Ljava/nio/channels/FileChannel;

    move-object/from16 v0, p0

    iget-object v6, v0, mBuffer:Ljava/nio/ByteBuffer;
...
.method public declared-synchronized saveMiniThumbToFile([BJJ)V
    ...
    iget-object v3, v0, mMiniThumbFile:Ljava/io/RandomAccessFile;
