...
.method static constructor <clinit>()V
    ...
    sput-object v0, decoderFeatures:[Landroid/media/MediaCodecInfo$Feature;
...
.method constructor <init>([Landroid/media/MediaCodecInfo$CodecProfileLevel;[IZILandroid/media/MediaFormat;Landroid/media/MediaFormat;)V
    ...
    iput-object p1, p0, profileLevels:[Landroid/media/MediaCodecInfo$CodecProfileLevel;

    .line 454
    iput-object p2, p0, colorFormats:[I

    .line 455
    iput p4, p0, mFlagsVerified:I

    .line 456
    iput-object p5, p0, mDefaultFormat:Landroid/media/MediaFormat;

    .line 457
    iput-object p6, p0, mCapabilitiesInfo:Landroid/media/MediaFormat;

    .line 458
    iget-object v7, p0, mDefaultFormat:Landroid/media/MediaFormat;
    ...
    iput-object v7, p0, mMime:Ljava/lang/String;

    .line 460
    iget-object v7, p0, mMime:Ljava/lang/String;
    ...
    iput-object v7, p0, mAudioCaps:Landroid/media/MediaCodecInfo$AudioCapabilities;

    .line 462
    iget-object v7, p0, mAudioCaps:Landroid/media/MediaCodecInfo$AudioCapabilities;

    iget-object v8, p0, mDefaultFormat:Landroid/media/MediaFormat;
    ...
    iput-object v7, p0, mEncoderCaps:Landroid/media/MediaCodecInfo$EncoderCapabilities;

    .line 468
    iget-object v7, p0, mEncoderCaps:Landroid/media/MediaCodecInfo$EncoderCapabilities;
    ...
    .line 471
    :cond_46
    invoke-direct {p0}, getValidFeatures()[Landroid/media/MediaCodecInfo$Feature;
    ...
    iput-object v7, p0, mVideoCaps:Landroid/media/MediaCodecInfo$VideoCapabilities;
    ...
    .line 478
    iget v7, p0, mFlagsRequired:I

    iget v8, v1, Landroid/media/MediaCodecInfo$Feature;->mValue:I

    or-int/2addr v7, v8

    iput v7, p0, mFlagsRequired:I

    .line 480
    :cond_93
    iget v7, p0, mFlagsSupported:I

    iget v8, v1, Landroid/media/MediaCodecInfo$Feature;->mValue:I

    or-int/2addr v7, v8

    iput v7, p0, mFlagsSupported:I
...
.method constructor <init>([Landroid/media/MediaCodecInfo$CodecProfileLevel;[IZILjava/util/Map;Ljava/util/Map;)V
    ...
    invoke-direct/range {v0 .. v6}, <init>([Landroid/media/MediaCodecInfo$CodecProfileLevel;[IZILandroid/media/MediaFormat;Landroid/media/MediaFormat;)V
...
.method private getValidFeatures()[Landroid/media/MediaCodecInfo$Feature;
    ...
    .line 280
    sget-object v0, decoderFeatures:[Landroid/media/MediaCodecInfo$Feature;
...
.method private isAudio()Z
    ...
    .prologue
    .line 371
    iget-object v0, p0, mAudioCaps:Landroid/media/MediaCodecInfo$AudioCapabilities;
...
.method private isEncoder()Z
    ...
    .prologue
    .line 382
    iget-object v0, p0, mEncoderCaps:Landroid/media/MediaCodecInfo$EncoderCapabilities;
...
.method private isVideo()Z
    ...
    .prologue
    .line 393
    iget-object v0, p0, mVideoCaps:Landroid/media/MediaCodecInfo$VideoCapabilities;
...
.method public dup()Landroid/media/MediaCodecInfo$CodecCapabilities;
    ...
    iget-object v1, p0, profileLevels:[Landroid/media/MediaCodecInfo$CodecProfileLevel;

    iget-object v2, p0, profileLevels:[Landroid/media/MediaCodecInfo$CodecProfileLevel;
    ...
    iget-object v2, p0, colorFormats:[I

    iget-object v3, p0, colorFormats:[I
    ...
    iget v4, p0, mFlagsVerified:I

    iget-object v5, p0, mDefaultFormat:Landroid/media/MediaFormat;

    iget-object v6, p0, mCapabilitiesInfo:Landroid/media/MediaFormat;
...
.method public getDefaultFormat()Landroid/media/MediaFormat;
    ...
    .prologue
    .line 360
    iget-object v0, p0, mDefaultFormat:Landroid/media/MediaFormat;
...
.method public getMimeType()Ljava/lang/String;
    ...
    .prologue
    .line 367
    iget-object v0, p0, mMime:Ljava/lang/String;
...
.method public final isFeatureRequired(Ljava/lang/String;)Z
    ...
    .prologue
    .line 259
    iget v0, p0, mFlagsRequired:I

    invoke-direct {p0, p1, v0}, checkFeature(Ljava/lang/String;I)Z
...
.method public final isFormatSupported(Landroid/media/MediaFormat;)Z
    ...
    iget-object v9, p0, mMime:Ljava/lang/String;
    ...
    invoke-virtual {p0, v9}, isFeatureSupported(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v9}, isFeatureRequired(Ljava/lang/String;)Z
    ...
    .end local v6    # "yesNo":Ljava/lang/Integer;
    :cond_61
    iget-object v9, p0, mAudioCaps:Landroid/media/MediaCodecInfo$AudioCapabilities;
    ...
    .line 335
    :cond_6d
    iget-object v9, p0, mVideoCaps:Landroid/media/MediaCodecInfo$VideoCapabilities;
    ...
    .line 338
    :cond_79
    iget-object v9, p0, mEncoderCaps:Landroid/media/MediaCodecInfo$EncoderCapabilities;
...
.method public isRegular()Z
    ...
    invoke-virtual {p0, v4}, isFeatureRequired(Ljava/lang/String;)Z
