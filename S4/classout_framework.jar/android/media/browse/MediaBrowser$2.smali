...
.method constructor <init>(Landroid/media/browse/MediaBrowser;Landroid/service/media/IMediaBrowserServiceCallbacks;Ljava/lang/String;Landroid/media/session/MediaSession$Token;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 387
    iput-object p1, p0, this$0:Landroid/media/browse/MediaBrowser;

    iput-object p2, p0, val$callback:Landroid/service/media/IMediaBrowserServiceCallbacks;

    iput-object p3, p0, val$root:Ljava/lang/String;

    iput-object p4, p0, val$session:Landroid/media/session/MediaSession$Token;
...
.method public run()V
    ...
    .prologue
    .line 392
    iget-object v3, p0, this$0:Landroid/media/browse/MediaBrowser;

    iget-object v4, p0, val$callback:Landroid/service/media/IMediaBrowserServiceCallbacks;
    ...
    iget-object v5, p0, this$0:Landroid/media/browse/MediaBrowser;
    ...
    iget-object v4, p0, val$root:Ljava/lang/String;
    ...
    iget-object v4, p0, val$session:Landroid/media/session/MediaSession$Token;
    ...
    iget-object v4, p0, this$0:Landroid/media/browse/MediaBrowser;
