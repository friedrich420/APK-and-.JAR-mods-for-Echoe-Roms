...
.method private static computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    .prologue
    .line 254
    invoke-static {p0, p1, p2}, computeInitialSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
...
.method public static createImageThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v11, v5, v8}, createThumbnailFromEXIF(Ljava/lang/String;IILandroid/media/ThumbnailUtils$SizedThumbnailBitmap;)V
    ...
    :cond_6b
    :try_start_6b
    invoke-static {v7, v11, v5}, computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    invoke-static {v1, v13, v14, v15}, extractThumbnail(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method private static createThumbnailFromEXIF(Ljava/lang/String;IILandroid/media/ThumbnailUtils$SizedThumbnailBitmap;)V
    ...
    .line 498
    invoke-static {v3, p1, p2}, computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    .line 505
    invoke-static {v5, p1, p2}, computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
...
.method public static createVideoThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v13, v13, v9}, extractThumbnail(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public static extractThumbnail(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p2, v0}, extractThumbnail(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public static extractThumbnail(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p0, p1, p2, v3}, transform(Landroid/graphics/Matrix;Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method private static makeBitmap(IILandroid/net/Uri;Landroid/content/ContentResolver;Landroid/os/ParcelFileDescriptor;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :try_start_5
    invoke-static {p2, p3}, makeInputStream(Landroid/net/Uri;Landroid/content/ContentResolver;)Landroid/os/ParcelFileDescriptor;
    :try_end_8
    ...
    .line 332
    invoke-static {p4}, closeSilently(Landroid/os/ParcelFileDescriptor;)V
    ...
    :cond_35
    :try_start_35
    invoke-static {p5, p0, p1}, computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
