...
.method constructor <init>(Landroid/media/Tokenizer$OnTokenListener;)V
    ...
    iput-object v0, p0, mDataTokenizer:Landroid/media/Tokenizer$TokenizerPhase;
    ...
    iput-object v0, p0, mTagTokenizer:Landroid/media/Tokenizer$TokenizerPhase;

    .line 320
    invoke-virtual {p0}, reset()V

    .line 321
    iput-object p1, p0, mListener:Landroid/media/Tokenizer$OnTokenListener;
...
.method static synthetic access$000(Landroid/media/Tokenizer;)Ljava/lang/String;
    ...
    .prologue
    .line 179
    iget-object v0, p0, mLine:Ljava/lang/String;
...
.method static synthetic access$202(Landroid/media/Tokenizer;Landroid/media/Tokenizer$TokenizerPhase;)Landroid/media/Tokenizer$TokenizerPhase;
    ...
    .prologue
    .line 179
    iput-object p1, p0, mPhase:Landroid/media/Tokenizer$TokenizerPhase;
...
.method static synthetic access$300(Landroid/media/Tokenizer;)Landroid/media/Tokenizer$TokenizerPhase;
    ...
    .prologue
    .line 179
    iget-object v0, p0, mTagTokenizer:Landroid/media/Tokenizer$TokenizerPhase;
...
.method static synthetic access$400(Landroid/media/Tokenizer;)Landroid/media/Tokenizer$OnTokenListener;
    ...
    .prologue
    .line 179
    iget-object v0, p0, mListener:Landroid/media/Tokenizer$OnTokenListener;
...
.method static synthetic access$500(Landroid/media/Tokenizer;)Landroid/media/Tokenizer$TokenizerPhase;
    ...
    .prologue
    .line 179
    iget-object v0, p0, mDataTokenizer:Landroid/media/Tokenizer$TokenizerPhase;
...
.method reset()V
    ...
    iput-object v0, p0, mPhase:Landroid/media/Tokenizer$TokenizerPhase;
...
.method tokenize(Ljava/lang/String;)V
    ...
    .line 330
    iput-object p1, p0, mLine:Ljava/lang/String;

    .line 331
    :goto_5
    iget v0, p0, mHandledLen:I

    iget-object v1, p0, mLine:Ljava/lang/String;
    ...
    .line 332
    iget-object v0, p0, mPhase:Landroid/media/Tokenizer$TokenizerPhase;
