...
.method constructor <init>(Landroid/media/CCParser$DisplayListener;)V
    ...
    iput-object v0, p0, mDisplay:Landroid/media/CCParser$CCMemory;
    ...
    iput-object v0, p0, mNonDisplay:Landroid/media/CCParser$CCMemory;
    ...
    iput-object v0, p0, mTextMem:Landroid/media/CCParser$CCMemory;

    .line 163
    iput-object p1, p0, mListener:Landroid/media/CCParser$DisplayListener;
...
.method private getMemory()Landroid/media/CCParser$CCMemory;
    ...
    .line 205
    iget-object v0, p0, mDisplay:Landroid/media/CCParser$CCMemory;
    ...
    .line 194
    :pswitch_23
    iget-object v0, p0, mNonDisplay:Landroid/media/CCParser$CCMemory;

    goto :goto_22

    .line 198
    :pswitch_26
    iget-object v0, p0, mTextMem:Landroid/media/CCParser$CCMemory;
...
.method private handleCtrlCode(Landroid/media/CCParser$CCData;)Z
    ...
    .line 269
    :pswitch_10
    invoke-direct {p0}, getMemory()Landroid/media/CCParser$CCMemory;
    ...
    .line 280
    iget-object v2, p0, mDisplay:Landroid/media/CCParser$CCMemory;

    invoke-virtual {v2}, Landroid/media/CCParser$CCMemory;->erase()V

    .line 281
    iget-object v2, p0, mNonDisplay:Landroid/media/CCParser$CCMemory;
    ...
    .line 295
    iget-object v2, p0, mTextMem:Landroid/media/CCParser$CCMemory;
    ...
    .line 303
    invoke-direct {p0}, updateDisplay()V
...
.method private swapMemory()V
    ...
    iget-object v1, p0, mNonDisplay:Landroid/media/CCParser$CCMemory;

    iput-object v1, p0, mDisplay:Landroid/media/CCParser$CCMemory;
...
.method private updateDisplay()V
    ...
    .prologue
    .line 337
    iget-object v1, p0, mListener:Landroid/media/CCParser$DisplayListener;
...
.method parse([B)V
    ...
    invoke-direct {p0, v2}, handleCtrlCode(Landroid/media/CCParser$CCData;)Z
    ...
    invoke-direct {p0, v2}, handleTabOffsets(Landroid/media/CCParser$CCData;)Z
    ...
    invoke-direct {p0, v2}, handlePACCode(Landroid/media/CCParser$CCData;)Z
    ...
    invoke-direct {p0, v2}, handleMidRowCode(Landroid/media/CCParser$CCData;)Z
    ...
    invoke-direct {p0, v2}, handleDisplayableChars(Landroid/media/CCParser$CCData;)Z
