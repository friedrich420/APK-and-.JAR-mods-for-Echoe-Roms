...
.method public constructor <init>(Ljava/util/UUID;)V
    ...
    iput-object v1, p0, mEventHandler:Landroid/media/MediaDrm$EventHandler;
    ...
    invoke-static {p1}, getByteArrayFromUUID(Ljava/util/UUID;)[B

    move-result-object v2

    invoke-direct {p0, v1, v2}, native_setup(Ljava/lang/Object;[B)V
...
.method static synthetic access$100(Landroid/media/MediaDrm;)Landroid/media/MediaDrm$OnEventListener;
    ...
    .prologue
    .line 97
    iget-object v0, p0, mOnEventListener:Landroid/media/MediaDrm$OnEventListener;
...
.method static synthetic access$200(Landroid/media/MediaDrm;[BLjava/lang/String;)V
    ...
    .prologue
    .line 97
    invoke-static {p0, p1, p2}, setCipherAlgorithmNative(Landroid/media/MediaDrm;[BLjava/lang/String;)V
...
.method static synthetic access$300(Landroid/media/MediaDrm;[BLjava/lang/String;)V
    ...
    .prologue
    .line 97
    invoke-static {p0, p1, p2}, setMacAlgorithmNative(Landroid/media/MediaDrm;[BLjava/lang/String;)V
...
.method static synthetic access$400(Landroid/media/MediaDrm;[B[B[B[B)[B
    ...
    .prologue
    .line 97
    invoke-static {p0, p1, p2, p3, p4}, encryptNative(Landroid/media/MediaDrm;[B[B[B[B)[B
...
.method static synthetic access$500(Landroid/media/MediaDrm;[B[B[B[B)[B
    ...
    .prologue
    .line 97
    invoke-static {p0, p1, p2, p3, p4}, decryptNative(Landroid/media/MediaDrm;[B[B[B[B)[B
...
.method static synthetic access$600(Landroid/media/MediaDrm;[B[B[B)[B
    ...
    .prologue
    .line 97
    invoke-static {p0, p1, p2, p3}, signNative(Landroid/media/MediaDrm;[B[B[B)[B
...
.method static synthetic access$700(Landroid/media/MediaDrm;[B[B[B[B)Z
    ...
    .prologue
    .line 97
    invoke-static {p0, p1, p2, p3, p4}, verifyNative(Landroid/media/MediaDrm;[B[B[B[B)Z
...
.method public static final isCryptoSchemeSupported(Ljava/util/UUID;)Z
    ...
    .prologue
    .line 128
    invoke-static {p0}, getByteArrayFromUUID(Ljava/util/UUID;)[B

    move-result-object v0

    const/4 v1, 0x0

    invoke-static {v0, v1}, isCryptoSchemeSupportedNative([BLjava/lang/String;)Z
...
.method public static final isCryptoSchemeSupported(Ljava/util/UUID;Ljava/lang/String;)Z
    ...
    invoke-static {v0, p1}, isCryptoSchemeSupportedNative([BLjava/lang/String;)Z
...
.method private static postEventFromNative(Ljava/lang/Object;IILjava/lang/Object;)V
    ...
    .line 339
    :cond_b
    iget-object v2, v1, mEventHandler:Landroid/media/MediaDrm$EventHandler;
...
.method public getCertificateRequest(ILjava/lang/String;)Landroid/media/MediaDrm$CertificateRequest;
    ...
    .prologue
    .line 811
    invoke-direct {p0, p1, p2}, getProvisionRequestNative(ILjava/lang/String;)Landroid/media/MediaDrm$ProvisionRequest;
...
.method public getProvisionRequest()Landroid/media/MediaDrm$ProvisionRequest;
    ...
    invoke-direct {p0, v0, v1}, getProvisionRequestNative(ILjava/lang/String;)Landroid/media/MediaDrm$ProvisionRequest;
...
.method public provideCertificateResponse([B)Landroid/media/MediaDrm$Certificate;
    ...
    .prologue
    .line 859
    invoke-direct {p0, p1}, provideProvisionResponseNative([B)Landroid/media/MediaDrm$Certificate;
...
.method public setOnEventListener(Landroid/media/MediaDrm$OnEventListener;)V
    ...
    .prologue
    .line 234
    iput-object p1, p0, mOnEventListener:Landroid/media/MediaDrm$OnEventListener;
...
.method public signRSA([BLjava/lang/String;[B[B)[B
    ...
    .prologue
    .line 878
    invoke-static {p0, p1, p2, p3, p4}, signRSANative(Landroid/media/MediaDrm;[BLjava/lang/String;[B[B)[B
