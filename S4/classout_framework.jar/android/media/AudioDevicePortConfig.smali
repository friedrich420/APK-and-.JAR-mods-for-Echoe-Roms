...
.method constructor <init>(Landroid/media/AudioDevicePortConfig;)V
    ...
    .prologue
    .line 35
    invoke-virtual {p1}, port()Landroid/media/AudioDevicePort;

    move-result-object v1

    invoke-virtual {p1}, samplingRate()I

    move-result v2

    invoke-virtual {p1}, channelMask()I

    move-result v3

    invoke-virtual {p1}, format()I

    move-result v4

    invoke-virtual {p1}, gain()Landroid/media/AudioGainConfig;

    move-result-object v5

    move-object v0, p0

    invoke-direct/range {v0 .. v5}, <init>(Landroid/media/AudioDevicePort;IIILandroid/media/AudioGainConfig;)V
...
.method public bridge synthetic port()Landroid/media/AudioPort;
    ...
    .prologue
    .line 28
    invoke-virtual {p0}, port()Landroid/media/AudioDevicePort;
