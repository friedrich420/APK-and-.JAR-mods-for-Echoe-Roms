...
.method static constructor <clinit>()V
    ...
    sput-object v0, ALERT_NONE:Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    sput-object v0, ALERT_OVER_VOLTAGE:Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    sput-object v0, ALERT_OVER_CURRENT:Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    sput-object v0, ALERT_OVER_TEMPERATURE:Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    sput-object v0, ALERT_SELF_PROTECTION:Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    sput-object v0, ALERT_CHARGE_COMPLETE:Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    sput-object v0, ALERT_WIRED_CHARGER_DETECTED:Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    sput-object v0, ALERT_CHARGE_PORT:Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    sget-object v1, ALERT_NONE:Landroid/wipower/WipowerManager$WipowerAlert;

    aput-object v1, v0, v3

    sget-object v1, ALERT_OVER_VOLTAGE:Landroid/wipower/WipowerManager$WipowerAlert;

    aput-object v1, v0, v4

    sget-object v1, ALERT_OVER_CURRENT:Landroid/wipower/WipowerManager$WipowerAlert;

    aput-object v1, v0, v5

    sget-object v1, ALERT_OVER_TEMPERATURE:Landroid/wipower/WipowerManager$WipowerAlert;

    aput-object v1, v0, v6

    sget-object v1, ALERT_SELF_PROTECTION:Landroid/wipower/WipowerManager$WipowerAlert;

    aput-object v1, v0, v7

    const/4 v1, 0x5

    sget-object v2, ALERT_CHARGE_COMPLETE:Landroid/wipower/WipowerManager$WipowerAlert;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, ALERT_WIRED_CHARGER_DETECTED:Landroid/wipower/WipowerManager$WipowerAlert;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, ALERT_CHARGE_PORT:Landroid/wipower/WipowerManager$WipowerAlert;

    aput-object v2, v0, v1

    sput-object v0, $VALUES:[Landroid/wipower/WipowerManager$WipowerAlert;
...
.method public static values()[Landroid/wipower/WipowerManager$WipowerAlert;
    ...
    .prologue
    .line 73
    sget-object v0, $VALUES:[Landroid/wipower/WipowerManager$WipowerAlert;
