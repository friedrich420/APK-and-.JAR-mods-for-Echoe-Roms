...
.method public constructor <init>(Landroid/content/Context;Landroid/print/PrintAttributes;)V
    ...
    iget v7, p0, mPageWidth:I

    sub-int/2addr v7, v2

    iget v8, p0, mPageHeight:I

    sub-int/2addr v8, v0

    invoke-direct {v6, v1, v3, v7, v8}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v6, p0, mContentRect:Landroid/graphics/Rect;
...
.method public startPage(I)Landroid/graphics/pdf/PdfDocument$Page;
    ...
    iget v2, p0, mPageWidth:I

    iget v3, p0, mPageHeight:I
    ...
    invoke-virtual {p0, v0}, startPage(Landroid/graphics/pdf/PdfDocument$PageInfo;)Landroid/graphics/pdf/PdfDocument$Page;
