...
.method constructor <init>(Landroid/print/IPrintManager;Landroid/content/Context;I)V
    ...
    iput-object v1, p0, mPrinters:Ljava/util/LinkedHashMap;

    .line 64
    iput-object p1, p0, mPrintManager:Landroid/print/IPrintManager;
    ...
    iput-object v1, p0, mObserver:Landroid/print/IPrinterDiscoveryObserver;

    .line 69
    :try_start_20
    iget-object v1, p0, mPrintManager:Landroid/print/IPrintManager;

    iget-object v2, p0, mObserver:Landroid/print/IPrinterDiscoveryObserver;
...
.method static synthetic access$000(Landroid/print/PrinterDiscoverySession;Ljava/util/List;)V
    ...
    .prologue
    .line 37
    invoke-direct {p0, p1}, handlePrintersAdded(Ljava/util/List;)V
...
.method static synthetic access$100(Landroid/print/PrinterDiscoverySession;Ljava/util/List;)V
    ...
    .prologue
    .line 37
    invoke-direct {p0, p1}, handlePrintersRemoved(Ljava/util/List;)V
...
.method private destroyNoCheck()V
    ...
    .line 185
    invoke-virtual {p0}, stopPrinterDiscovery()V
    ...
    .line 191
    iput-object v4, p0, mObserver:Landroid/print/IPrinterDiscoveryObserver;

    .line 192
    iget-object v1, p0, mPrinters:Ljava/util/LinkedHashMap;
    ...
    .line 192
    iget-object v2, p0, mPrinters:Ljava/util/LinkedHashMap;
...
.method private handlePrintersAdded(Ljava/util/List;)V
    ...
    .line 202
    :cond_7
    iget-object v7, p0, mPrinters:Ljava/util/LinkedHashMap;
    ...
    :cond_28
    invoke-direct {p0}, notifyOnPrintersChanged()V
...
.method private handlePrintersRemoved(Ljava/util/List;)V
    ...
    iget-object v4, p0, mPrinters:Ljava/util/LinkedHashMap;
...
.method private isDestroyedNoCheck()Z
    ...
    .prologue
    .line 181
    iget-object v0, p0, mObserver:Landroid/print/IPrinterDiscoveryObserver;
...
.method private notifyOnPrintersChanged()V
    ...
    .prologue
    .line 254
    iget-object v0, p0, mListener:Landroid/print/PrinterDiscoverySession$OnPrintersChangeListener;
...
.method public final destroy()V
    ...
    .line 145
    :cond_d
    invoke-direct {p0}, destroyNoCheck()V
...
.method protected final finalize()V
    ...
    .prologue
    .line 173
    invoke-direct {p0}, isDestroyedNoCheck()Z
...
.method public final isDestroyed()Z
    ...
    .prologue
    .line 157
    invoke-static {}, throwIfNotCalledOnMainThread()V
...
.method public final isPrinterDiscoveryStarted()Z
    ...
    .line 163
    iget-boolean v0, p0, mIsPrinterDiscoveryStarted:Z
...
.method public final setOnPrintersChangeListener(Landroid/print/PrinterDiscoverySession$OnPrintersChangeListener;)V
    ...
    .line 168
    iput-object p1, p0, mListener:Landroid/print/PrinterDiscoverySession$OnPrintersChangeListener;
...
.method public final startPrinterDiscovery(Ljava/util/List;)V
    ...
    .line 80
    :cond_e
    iget-boolean v1, p0, mIsPrinterDiscoveryStarted:Z
    ...
    iput-boolean v1, p0, mIsPrinterDiscoveryStarted:Z
