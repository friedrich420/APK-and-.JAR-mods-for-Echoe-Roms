...
.method static constructor <clinit>()V
    ...
    .line 543
    sput-boolean v0, avStreamingPending:Z

    .line 544
    sput-boolean v0, avStreamingFlag:Z
...
.method constructor <init>(Landroid/bluetooth/IBluetoothManager;)V
    ...
    iput v1, p0, BLUETOOTH_SHUTDOWN:I
    ...
    iput-object v1, p0, mManagerCallback:Landroid/bluetooth/IBluetoothManagerCallback;
    ...
    iput-object v1, p0, mProxyServiceStateCallbacks:Ljava/util/ArrayList;
    ...
    :cond_26
    :try_start_26
    iget-object v1, p0, mManagerCallback:Landroid/bluetooth/IBluetoothManagerCallback;
    ...
    iput-object v1, p0, mService:Landroid/bluetooth/IBluetooth;
    :try_end_2e
    .catch Landroid/os/RemoteException; {:try_start_26 .. :try_end_2e} :catch_38

    .line 580
    :goto_2e
    iput-object p1, p0, mManagerService:Landroid/bluetooth/IBluetoothManager;
    ...
    iput-object v1, p0, mLeScanClients:Ljava/util/Map;
...
.method static synthetic access$000(Landroid/bluetooth/BluetoothAdapter;)Landroid/bluetooth/IBluetoothManagerCallback;
    ...
    .prologue
    .line 91
    iget-object v0, p0, mManagerCallback:Landroid/bluetooth/IBluetoothManagerCallback;
...
.method static synthetic access$102(Landroid/bluetooth/BluetoothAdapter;Landroid/bluetooth/IBluetooth;)Landroid/bluetooth/IBluetooth;
    ...
    .prologue
    .line 91
    iput-object p1, p0, mService:Landroid/bluetooth/IBluetooth;
...
.method static synthetic access$200(Landroid/bluetooth/BluetoothAdapter;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 91
    iget-object v0, p0, mProxyServiceStateCallbacks:Ljava/util/ArrayList;
...
.method static synthetic access$300(Landroid/bluetooth/BluetoothAdapter;)Ljava/util/Map;
    ...
    .prologue
    .line 91
    iget-object v0, p0, mLeScanClients:Ljava/util/Map;
...
.method static synthetic access$400()Landroid/bluetooth/le/BluetoothLeAdvertiser;
    ...
    .prologue
    .line 91
    sget-object v0, sBluetoothLeAdvertiser:Landroid/bluetooth/le/BluetoothLeAdvertiser;
...
.method static synthetic access$500()Landroid/bluetooth/le/BluetoothLeScanner;
    ...
    .prologue
    .line 91
    sget-object v0, sBluetoothLeScanner:Landroid/bluetooth/le/BluetoothLeScanner;
...
.method public static declared-synchronized getDefaultAdapter()Landroid/bluetooth/BluetoothAdapter;
    ...
    :try_start_3
    sget-object v2, sAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    invoke-direct {v2, v1}, <init>(Landroid/bluetooth/IBluetoothManager;)V

    sput-object v2, sAdapter:Landroid/bluetooth/BluetoothAdapter;
...
.method public callBtCommonApi(ILandroid/os/Bundle;)Z
    ...
    .line 2332
    :try_start_0
    iget-object v2, p0, mManagerCallback:Landroid/bluetooth/IBluetoothManagerCallback;
    ...
    .line 2334
    iget-object v1, p0, mService:Landroid/bluetooth/IBluetooth;
...
.method public cancelDiscovery()Z
    ...
    :cond_a
    :try_start_a
    iget-object v3, p0, mManagerCallback:Landroid/bluetooth/IBluetoothManagerCallback;
    ...
    .line 1158
    :try_start_d
    iget-object v2, p0, mService:Landroid/bluetooth/IBluetooth;
...
.method public disable()Z
    ...
    .line 795
    :try_start_7
    iget-object v1, p0, mManagerService:Landroid/bluetooth/IBluetoothManager;
...
.method public getBluetoothLeAdvertiser()Landroid/bluetooth/le/BluetoothLeAdvertiser;
    ...
    .prologue
    .line 631
    invoke-virtual {p0}, isMultipleAdvertisementSupported()Z
    ...
    iget-object v2, p0, mManagerService:Landroid/bluetooth/IBluetoothManager;

    invoke-direct {v0, v2}, Landroid/bluetooth/le/BluetoothLeAdvertiser;-><init>(Landroid/bluetooth/IBluetoothManager;)V

    sput-object v0, sBluetoothLeAdvertiser:Landroid/bluetooth/le/BluetoothLeAdvertiser;
...
.method public getBluetoothLeScanner()Landroid/bluetooth/le/BluetoothLeScanner;
    ...
    sput-object v0, sBluetoothLeScanner:Landroid/bluetooth/le/BluetoothLeScanner;
...
.method getBluetoothManager()Landroid/bluetooth/IBluetoothManager;
    ...
    .prologue
    .line 2100
    iget-object v0, p0, mManagerService:Landroid/bluetooth/IBluetoothManager;
...
.method getBluetoothService(Landroid/bluetooth/IBluetoothManagerCallback;)Landroid/bluetooth/IBluetooth;
    ...
    .line 2113
    iget-object v0, p0, mService:Landroid/bluetooth/IBluetooth;
...
.method public getBondedDevices()Ljava/util/Set;
    ...
    invoke-direct {p0, v1}, toDeviceSet([Landroid/bluetooth/BluetoothDevice;)Ljava/util/Set;
...
.method public getControllerActivityEnergyInfo(I)Landroid/bluetooth/BluetoothActivityEnergyInfo;
    ...
    :cond_b
    :try_start_b
    iget-object v3, p0, mService:Landroid/bluetooth/IBluetooth;
...
.method public listenUsingEncryptedRfcommWithServiceRecord(Ljava/lang/String;Ljava/util/UUID;)Landroid/bluetooth/BluetoothServerSocket;
    ...
    invoke-direct {p0, p1, p2, v0, v1}, createNewRfcommSocketAndRecord(Ljava/lang/String;Ljava/util/UUID;ZZ)Landroid/bluetooth/BluetoothServerSocket;
...
.method public listenUsingInsecureRfcommWithServiceRecord(Ljava/lang/String;Ljava/util/UUID;)Landroid/bluetooth/BluetoothServerSocket;
    ...
    .line 1529
    invoke-direct {p0, p1, p2, v0, v0}, createNewRfcommSocketAndRecord(Ljava/lang/String;Ljava/util/UUID;ZZ)Landroid/bluetooth/BluetoothServerSocket;
...
.method public setScanMode(I)Z
    ...
    invoke-virtual {p0, p1, v0}, setScanMode(II)Z
...
.method public startLeScan(Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)Z
    ...
    invoke-virtual {p0, v0, p1}, startLeScan([Ljava/util/UUID;Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)Z
...
.method public startLeScan([Ljava/util/UUID;Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)Z
    ...
    .line 2182
    :cond_26
    invoke-virtual {p0}, getBluetoothLeScanner()Landroid/bluetooth/le/BluetoothLeScanner;
    ...
    .line 2188
    :cond_35
    iget-object v9, p0, mLeScanClients:Ljava/util/Map;

    monitor-enter v9

    .line 2189
    :try_start_38
    iget-object v10, p0, mLeScanClients:Ljava/util/Map;
    ...
    :cond_4c
    :try_start_4c
    iget-object v10, p0, mManagerService:Landroid/bluetooth/IBluetoothManager;
...
.method public stopLeScan(Landroid/bluetooth/BluetoothAdapter$LeScanCallback;)V
    ...
    .line 2268
    :cond_f
    iget-object v3, p0, mLeScanClients:Ljava/util/Map;

    monitor-enter v3

    .line 2269
    :try_start_12
    iget-object v2, p0, mLeScanClients:Ljava/util/Map;
