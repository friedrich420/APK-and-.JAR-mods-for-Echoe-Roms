...
.method public constructor <init>(Landroid/bluetooth/IBluetoothManager;)V
    ...
    iput-object v0, p0, mLeAdvertisers:Ljava/util/Map;

    .line 73
    iput-object p1, p0, mBluetoothManager:Landroid/bluetooth/IBluetoothManager;
    ...
    iput-object v0, p0, mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;
...
.method static synthetic access$000(Landroid/bluetooth/le/BluetoothLeAdvertiser;)Ljava/util/Map;
    ...
    .prologue
    .line 48
    iget-object v0, p0, mLeAdvertisers:Ljava/util/Map;
...
.method static synthetic access$100(Landroid/bluetooth/le/BluetoothLeAdvertiser;Landroid/bluetooth/le/AdvertiseCallback;I)V
    ...
    .prologue
    .line 48
    invoke-direct {p0, p1, p2}, postStartFailure(Landroid/bluetooth/le/AdvertiseCallback;I)V
...
.method static synthetic access$200(Landroid/bluetooth/le/BluetoothLeAdvertiser;Landroid/bluetooth/le/AdvertiseCallback;Landroid/bluetooth/le/AdvertiseSettings;)V
    ...
    .prologue
    .line 48
    invoke-direct {p0, p1, p2}, postStartSuccess(Landroid/bluetooth/le/AdvertiseCallback;Landroid/bluetooth/le/AdvertiseSettings;)V
...
.method private totalBytes(Landroid/bluetooth/le/AdvertiseData;Z)I
    ...
    invoke-direct {p0, v7}, byteLength([B)I
    ...
    iget-object v7, p0, mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;
...
.method public startAdvertising(Landroid/bluetooth/le/AdvertiseSettings;Landroid/bluetooth/le/AdvertiseData;Landroid/bluetooth/le/AdvertiseCallback;)V
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, startAdvertising(Landroid/bluetooth/le/AdvertiseSettings;Landroid/bluetooth/le/AdvertiseData;Landroid/bluetooth/le/AdvertiseData;Landroid/bluetooth/le/AdvertiseCallback;)V
...
.method public startAdvertising(Landroid/bluetooth/le/AdvertiseSettings;Landroid/bluetooth/le/AdvertiseData;Landroid/bluetooth/le/AdvertiseData;Landroid/bluetooth/le/AdvertiseCallback;)V
    ...
    .line 109
    iget-object v8, p0, mLeAdvertisers:Ljava/util/Map;
    ...
    :cond_12
    :try_start_12
    iget-object v1, p0, mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    invoke-direct {p0, p4, v1}, postStartFailure(Landroid/bluetooth/le/AdvertiseCallback;I)V
    ...
    invoke-direct {p0, p2, v1}, totalBytes(Landroid/bluetooth/le/AdvertiseData;Z)I
    ...
    invoke-direct {p0, p3, v1}, totalBytes(Landroid/bluetooth/le/AdvertiseData;Z)I
    ...
    .line 125
    :cond_3c
    iget-object v1, p0, mLeAdvertisers:Ljava/util/Map;
    ...
    :cond_4a
    :try_start_4a
    iget-object v1, p0, mBluetoothManager:Landroid/bluetooth/IBluetoothManager;
...
.method public stopAdvertising(Landroid/bluetooth/le/AdvertiseCallback;)V
    ...
    .prologue
    .line 153
    iget-object v2, p0, mLeAdvertisers:Ljava/util/Map;
