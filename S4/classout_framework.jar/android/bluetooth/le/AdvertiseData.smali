...
.method private constructor <init>(Ljava/util/List;Landroid/util/SparseArray;Ljava/util/Map;ZZ)V
    ...
    .line 56
    iput-object p1, p0, mServiceUuids:Ljava/util/List;

    .line 57
    iput-object p2, p0, mManufacturerSpecificData:Landroid/util/SparseArray;

    .line 58
    iput-object p3, p0, mServiceData:Ljava/util/Map;

    .line 59
    iput-boolean p4, p0, mIncludeTxPowerLevel:Z

    .line 60
    iput-boolean p5, p0, mIncludeDeviceName:Z
...
.method synthetic constructor <init>(Ljava/util/List;Landroid/util/SparseArray;Ljava/util/Map;ZZLandroid/bluetooth/le/AdvertiseData$1;)V
    ...
    .prologue
    .line 41
    invoke-direct/range {p0 .. p5}, <init>(Ljava/util/List;Landroid/util/SparseArray;Ljava/util/Map;ZZ)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, mServiceUuids:Ljava/util/List;

    iget-object v4, v0, mServiceUuids:Ljava/util/List;
    ...
    iget-object v3, p0, mManufacturerSpecificData:Landroid/util/SparseArray;

    iget-object v4, v0, mManufacturerSpecificData:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, mServiceData:Ljava/util/Map;

    iget-object v4, v0, mServiceData:Ljava/util/Map;
    ...
    iget-boolean v3, p0, mIncludeDeviceName:Z

    iget-boolean v4, v0, mIncludeDeviceName:Z

    if-ne v3, v4, :cond_40

    iget-boolean v3, p0, mIncludeTxPowerLevel:Z

    iget-boolean v4, v0, mIncludeTxPowerLevel:Z
...
.method public getIncludeDeviceName()Z
    ...
    .prologue
    .line 97
    iget-boolean v0, p0, mIncludeDeviceName:Z
...
.method public getIncludeTxPowerLevel()Z
    ...
    .prologue
    .line 90
    iget-boolean v0, p0, mIncludeTxPowerLevel:Z
...
.method public getManufacturerSpecificData()Landroid/util/SparseArray;
    ...
    .prologue
    .line 76
    iget-object v0, p0, mManufacturerSpecificData:Landroid/util/SparseArray;
...
.method public getServiceData()Ljava/util/Map;
    ...
    .prologue
    .line 83
    iget-object v0, p0, mServiceData:Ljava/util/Map;
...
.method public getServiceUuids()Ljava/util/List;
    ...
    .prologue
    .line 68
    iget-object v0, p0, mServiceUuids:Ljava/util/List;
...
.method public hashCode()I
    ...
    iget-object v2, p0, mServiceUuids:Ljava/util/List;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    iget-object v2, p0, mManufacturerSpecificData:Landroid/util/SparseArray;

    aput-object v2, v0, v1

    const/4 v1, 0x2

    iget-object v2, p0, mServiceData:Ljava/util/Map;

    aput-object v2, v0, v1

    const/4 v1, 0x3

    iget-boolean v2, p0, mIncludeDeviceName:Z
    ...
    iget-boolean v2, p0, mIncludeTxPowerLevel:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, mServiceUuids:Ljava/util/List;
    ...
    iget-object v1, p0, mManufacturerSpecificData:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, mServiceData:Ljava/util/Map;
    ...
    iget-boolean v1, p0, mIncludeTxPowerLevel:Z
    ...
    iget-boolean v1, p0, mIncludeDeviceName:Z
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 144
    iget-object v4, p0, mServiceUuids:Ljava/util/List;

    invoke-virtual {p1, v4}, Landroid/os/Parcel;->writeList(Ljava/util/List;)V

    .line 147
    iget-object v4, p0, mManufacturerSpecificData:Landroid/util/SparseArray;
    ...
    .end local v0    # "data":[B
    :cond_3d
    iget-object v4, p0, mServiceData:Ljava/util/Map;
    ...
    :cond_78
    invoke-virtual {p0}, getIncludeTxPowerLevel()Z
    ...
    .line 172
    invoke-virtual {p0}, getIncludeDeviceName()Z
