...
.method public constructor <init>(Landroid/bluetooth/IBluetoothManager;)V
    ...
    iput-object v0, p0, mLeScanClients:Ljava/util/Map;
...
.method static synthetic access$000(Landroid/bluetooth/le/BluetoothLeScanner;Landroid/bluetooth/le/ScanCallback;I)V
    ...
    .prologue
    .line 50
    invoke-direct {p0, p1, p2}, postCallbackError(Landroid/bluetooth/le/ScanCallback;I)V
...
.method private isSettingsConfigAllowedForScan(Landroid/bluetooth/le/ScanSettings;)Z
    ...
    .line 402
    iget-object v2, p0, mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;
...
.method private startScan(Ljava/util/List;Landroid/bluetooth/le/ScanSettings;Landroid/bluetooth/le/ScanCallback;Ljava/util/List;)V
    ...
    .line 111
    :cond_d
    iget-object v8, p0, mLeScanClients:Ljava/util/Map;

    monitor-enter v8

    .line 112
    :try_start_10
    iget-object v1, p0, mLeScanClients:Ljava/util/Map;
    ...
    invoke-direct {p0, p3, v1}, postCallbackError(Landroid/bluetooth/le/ScanCallback;I)V
    ...
    :cond_32
    :try_start_32
    invoke-direct {p0, p2}, isSettingsConfigAllowedForScan(Landroid/bluetooth/le/ScanSettings;)Z
...
.method public startScan(Landroid/bluetooth/le/ScanCallback;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, startScan(Ljava/util/List;Landroid/bluetooth/le/ScanSettings;Landroid/bluetooth/le/ScanCallback;)V
...
.method public startScan(Ljava/util/List;Landroid/bluetooth/le/ScanSettings;Landroid/bluetooth/le/ScanCallback;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, startScan(Ljava/util/List;Landroid/bluetooth/le/ScanSettings;Landroid/bluetooth/le/ScanCallback;Ljava/util/List;)V
...
.method public startTruncatedScan(Ljava/util/List;Landroid/bluetooth/le/ScanSettings;Landroid/bluetooth/le/ScanCallback;)V
    ...
    :cond_2d
    invoke-direct {p0, v3, p2, p3, v4}, startScan(Ljava/util/List;Landroid/bluetooth/le/ScanSettings;Landroid/bluetooth/le/ScanCallback;Ljava/util/List;)V
