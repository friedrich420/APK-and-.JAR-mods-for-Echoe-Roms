...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mTuples:Ljava/util/ArrayList;

    .line 51
    iput-object v1, p0, mLastMatch:Landroid/animation/StateListAnimator$Tuple;

    .line 53
    iput-object v1, p0, mRunningAnimator:Landroid/animation/Animator;
    ...
    iput-object v0, p0, mAnimatorListener:Landroid/animation/AnimatorListenerAdapter;
...
.method static synthetic access$000(Landroid/animation/StateListAnimator;)Landroid/animation/Animator;
    ...
    .prologue
    .line 47
    iget-object v0, p0, mRunningAnimator:Landroid/animation/Animator;
...
.method static synthetic access$002(Landroid/animation/StateListAnimator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .prologue
    .line 47
    iput-object p1, p0, mRunningAnimator:Landroid/animation/Animator;
...
.method private cancel()V
    ...
    iput-object v0, p0, mRunningAnimator:Landroid/animation/Animator;
...
.method private clearTarget()V
    ...
    .line 117
    iget-object v2, p0, mTuples:Ljava/util/ArrayList;
    ...
    .line 122
    :cond_1a
    iput-object v3, p0, mViewRef:Ljava/lang/ref/WeakReference;

    .line 123
    iput-object v3, p0, mLastMatch:Landroid/animation/StateListAnimator$Tuple;

    .line 124
    iput-object v3, p0, mRunningAnimator:Landroid/animation/Animator;
...
.method private start(Landroid/animation/StateListAnimator$Tuple;)V
    ...
    invoke-virtual {p0}, getTarget()Landroid/view/View;
...
.method public addState([ILandroid/animation/Animator;)V
    ...
    iget-object v2, p0, mAnimatorListener:Landroid/animation/AnimatorListenerAdapter;

    invoke-virtual {v1, v2}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 77
    iget-object v1, p0, mTuples:Ljava/util/ArrayList;
...
.method public getTarget()Landroid/view/View;
    ...
    .prologue
    .line 95
    iget-object v0, p0, mViewRef:Ljava/lang/ref/WeakReference;
...
.method public getTuples()Ljava/util/ArrayList;
    ...
    .prologue
    .line 170
    iget-object v0, p0, mTuples:Ljava/util/ArrayList;
...
.method public setState([I)V
    ...
    iget-object v4, p0, mTuples:Ljava/util/ArrayList;
    ...
    :cond_1b
    iget-object v4, p0, mLastMatch:Landroid/animation/StateListAnimator$Tuple;
    ...
    .line 147
    :cond_2a
    iput-object v2, p0, mLastMatch:Landroid/animation/StateListAnimator$Tuple;

    .line 148
    if-eqz v2, :cond_1f

    .line 149
    invoke-direct {p0, v2}, start(Landroid/animation/StateListAnimator$Tuple;)V
...
.method public setTarget(Landroid/view/View;)V
    ...
    .line 108
    invoke-direct {p0}, clearTarget()V
    ...
    iput-object v1, p0, mViewRef:Ljava/lang/ref/WeakReference;
