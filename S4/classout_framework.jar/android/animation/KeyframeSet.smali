...
.method public varargs constructor <init>([Landroid/animation/Keyframe;)V
    ...
    iput-object v0, p0, mKeyframes:Ljava/util/ArrayList;

    .line 46
    iget-object v0, p0, mKeyframes:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mFirstKeyframe:Landroid/animation/Keyframe;

    .line 48
    iget-object v0, p0, mKeyframes:Ljava/util/ArrayList;

    iget v1, p0, mNumKeyframes:I
    ...
    iput-object v0, p0, mLastKeyframe:Landroid/animation/Keyframe;

    .line 49
    iget-object v0, p0, mLastKeyframe:Landroid/animation/Keyframe;
...
.method public static varargs ofKeyframe([Landroid/animation/Keyframe;)Landroid/animation/KeyframeSet;
    ...
    invoke-direct {v7, p0}, <init>([Landroid/animation/Keyframe;)V
...
.method public static varargs ofObject([Ljava/lang/Object;)Landroid/animation/KeyframeSet;
    ...
    invoke-direct {v3, v1}, <init>([Landroid/animation/Keyframe;)V
...
.method public clone()Landroid/animation/KeyframeSet;
    ...
    .prologue
    .line 180
    iget-object v1, p0, mKeyframes:Ljava/util/ArrayList;

    .line 181
    .local v1, "keyframes":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/animation/Keyframe;>;"
    iget-object v5, p0, mKeyframes:Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v2}, <init>([Landroid/animation/Keyframe;)V
...
.method public bridge synthetic clone()Landroid/animation/Keyframes;
    ...
    .prologue
    .line 32
    invoke-virtual {p0}, clone()Landroid/animation/KeyframeSet;
...
.method public getType()Ljava/lang/Class;
    ...
    .prologue
    .line 175
    iget-object v0, p0, mFirstKeyframe:Landroid/animation/Keyframe;
...
.method public getValue(F)Ljava/lang/Object;
    ...
    .line 209
    :cond_f
    iget-object v6, p0, mEvaluator:Landroid/animation/TypeEvaluator;

    iget-object v7, p0, mFirstKeyframe:Landroid/animation/Keyframe;

    invoke-virtual {v7}, Landroid/animation/Keyframe;->getValue()Ljava/lang/Object;

    move-result-object v7

    iget-object v8, p0, mLastKeyframe:Landroid/animation/Keyframe;
    ...
    .line 213
    iget-object v6, p0, mKeyframes:Ljava/util/ArrayList;
    ...
    .line 218
    :cond_3a
    iget-object v6, p0, mFirstKeyframe:Landroid/animation/Keyframe;
    ...
    iget-object v6, p0, mLastKeyframe:Landroid/animation/Keyframe;
    ...
    iget-object v7, p0, mLastKeyframe:Landroid/animation/Keyframe;
    ...
    :cond_98
    iget-object v5, p0, mFirstKeyframe:Landroid/animation/Keyframe;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, mKeyframes:Ljava/util/ArrayList;
