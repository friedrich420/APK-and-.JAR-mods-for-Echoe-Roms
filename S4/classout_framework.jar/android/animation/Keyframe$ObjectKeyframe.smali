...
.method public clone()Landroid/animation/Keyframe$ObjectKeyframe;
    ...
    invoke-virtual {p0}, hasValue()Z

    move-result v1

    if-eqz v1, :cond_1d

    iget-object v1, p0, mValue:Ljava/lang/Object;

    :goto_e
    invoke-direct {v0, v2, v1}, <init>(FLjava/lang/Object;)V
...
.method public bridge synthetic clone()Landroid/animation/Keyframe;
    ...
    .prologue
    .line 262
    invoke-virtual {p0}, clone()Landroid/animation/Keyframe$ObjectKeyframe;
