...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, sIsInitialized:Z
    ...
    sput-object v0, sNfcAdapters:Ljava/util/HashMap;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mForegroundDispatchListener:Landroid/app/OnActivityPausedListener;
    ...
    iput-object v0, p0, mNfcActivityManager:Landroid/nfc/NfcActivityManager;
    ...
    iput-object v0, p0, mNfcUnlockHandlers:Ljava/util/HashMap;
...
.method public static getDefaultAdapter()Landroid/nfc/NfcAdapter;
    ...
    invoke-static {v0}, getNfcAdapter(Landroid/content/Context;)Landroid/nfc/NfcAdapter;
...
.method public static declared-synchronized getNfcAdapter(Landroid/content/Context;)Landroid/nfc/NfcAdapter;
    ...
    :try_start_3
    sget-boolean v2, sIsInitialized:Z

    if-nez v2, :cond_48

    .line 487
    invoke-static {}, hasNfcFeature()Z
    ...
    :cond_1e
    :try_start_1e
    invoke-static {}, getServiceInterface()Landroid/nfc/INfcAdapter;

    move-result-object v2

    sput-object v2, sService:Landroid/nfc/INfcAdapter;

    .line 493
    sget-object v2, sService:Landroid/nfc/INfcAdapter;
    ...
    sput-object v2, sTagService:Landroid/nfc/INfcTag;
    :try_end_3d
    ...
    sput-object v2, sCardEmulationService:Landroid/nfc/INfcCardEmulation;
    :try_end_45
    ...
    :try_start_46
    sput-boolean v2, sIsInitialized:Z
    ...
    .line 514
    sget-object v2, sNullContextNfcAdapter:Landroid/nfc/NfcAdapter;
    ...
    invoke-direct {v2, v4}, <init>(Landroid/content/Context;)V

    sput-object v2, sNullContextNfcAdapter:Landroid/nfc/NfcAdapter;

    .line 517
    :cond_56
    sget-object v0, sNullContextNfcAdapter:Landroid/nfc/NfcAdapter;
    :try_end_58
    ...
    .end local v1    # "e":Landroid/os/RemoteException;
    :cond_76
    sget-object v2, sNfcAdapters:Ljava/util/HashMap;
...
.method private isAndroidBeamAllowed(Z)Z
    ...
    iput-object v0, p0, mRestrictionCr:Landroid/database/Cursor;

    .line 1690
    iget-object v0, p0, mRestrictionCr:Landroid/database/Cursor;
    ...
    iget-object v1, p0, mRestrictionCr:Landroid/database/Cursor;
...
.method private isNFCEnabled()Z
    ...
    invoke-interface {v0}, Landroid/database/Cursor;->moveToFirst()Z
    :try_end_2e
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_2e} :catch_5d
    ...
    invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
    :try_end_42
    .catch Landroid/database/CursorIndexOutOfBoundsException; {:try_start_2e .. :try_end_42} :catch_53
    ...
    invoke-interface {v0}, Landroid/database/Cursor;->close()V
    :try_end_51
    .catch Ljava/lang/Exception; {:try_start_46 .. :try_end_51} :catch_5d
    ...
    throw v0
    :try_end_6d
    .catch Ljava/lang/Exception; {:try_start_67 .. :try_end_6d} :catch_5d
...
.method private isNFCStateChangeAllowed()Z
    ...
    iput-object v0, p0, mDevSettingCr:Landroid/database/Cursor;

    .line 1746
    iget-object v0, p0, mDevSettingCr:Landroid/database/Cursor;
    ...
    iget-object v1, p0, mDevSettingCr:Landroid/database/Cursor;
...
.method public addNfcUnlockHandler(Landroid/nfc/NfcAdapter$NfcUnlockHandler;[Ljava/lang/String;)Z
    ...
    .line 1810
    :try_start_9
    iget-object v2, p0, mNfcUnlockHandlers:Ljava/util/HashMap;
    ...
    .line 1812
    sget-object v5, sService:Landroid/nfc/INfcAdapter;
    ...
    .line 1828
    .local v0, "e":Landroid/os/RemoteException;
    invoke-virtual {p0, v0}, attemptDeadServiceRecovery(Ljava/lang/Exception;)V
...
.method public attemptDeadServiceRecovery(Ljava/lang/Exception;)V
    ...
    .line 666
    :cond_15
    sput-object v1, sService:Landroid/nfc/INfcAdapter;
...
.method public disable()Z
    ...
    .line 785
    :try_start_1
    invoke-direct {p0}, isNFCStateChangeAllowed()Z
...
.method public disable(Z)Z
    ...
    .line 805
    :try_start_0
    sget-object v1, sService:Landroid/nfc/INfcAdapter;
...
.method public disableForegroundDispatch(Landroid/app/Activity;)V
    ...
    iget-object v1, p0, mForegroundDispatchListener:Landroid/app/OnActivityPausedListener;
    ...
    invoke-virtual {p0, p1, v0}, disableForegroundDispatchInternal(Landroid/app/Activity;Z)V
...
.method public disableForegroundNdefPush(Landroid/app/Activity;)V
    ...
    .line 1527
    :cond_a
    invoke-virtual {p0, p1}, enforceResumed(Landroid/app/Activity;)V

    .line 1528
    iget-object v0, p0, mNfcActivityManager:Landroid/nfc/NfcActivityManager;
...
.method public enable()Z
    ...
    :cond_c
    :try_start_c
    invoke-direct {p0}, isNFCEnabled()Z
...
.method public enableForegroundDispatch(Landroid/app/Activity;Landroid/app/PendingIntent;[Landroid/content/IntentFilter;[[Ljava/lang/String;)V
    ...
    iget-object v4, p0, mForegroundDispatchListener:Landroid/app/OnActivityPausedListener;
    ...
    .line 1332
    sget-object v3, sService:Landroid/nfc/INfcAdapter;
...
.method public enableNdefPush()Z
    ...
    .line 1542
    invoke-direct {p0, v1}, isAndroidBeamAllowed(Z)Z
    ...
    .line 1543
    invoke-virtual {p0}, disableNdefPush()Z
...
.method public getCardEmulationService()Landroid/nfc/INfcCardEmulation;
    ...
    .line 639
    sget-object v1, sCardEmulationService:Landroid/nfc/INfcCardEmulation;
    ...
    sput-object v1, sCardEmulationService:Landroid/nfc/INfcCardEmulation;
    :try_end_f
...
.method public getService()Landroid/nfc/INfcAdapter;
    ...
    .line 619
    sget-object v0, sService:Landroid/nfc/INfcAdapter;
...
.method public getTagService()Landroid/nfc/INfcTag;
    ...
    .line 628
    sget-object v0, sTagService:Landroid/nfc/INfcTag;
...
.method public isTrustedPkg(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 1779
    invoke-virtual {p0, v1}, attemptDeadServiceRecovery(Ljava/lang/Exception;)V
...
.method public removeNfcUnlockHandler(Landroid/nfc/NfcAdapter$NfcUnlockHandler;)Z
    ...
    .line 1848
    :try_start_3
    iget-object v1, p0, mNfcUnlockHandlers:Ljava/util/HashMap;
...
.method public setBeamPushUris([Landroid/net/Uri;Landroid/app/Activity;)V
    ...
    invoke-direct {p0, v5}, isAndroidBeamAllowed(Z)Z
    ...
    :cond_46
    iget-object v5, p0, mNfcActivityManager:Landroid/nfc/NfcActivityManager;
...
.method public setBeamPushUrisCallback(Landroid/nfc/NfcAdapter$CreateBeamUrisCallback;Landroid/app/Activity;)V
    ...
    invoke-direct {p0, v0}, isAndroidBeamAllowed(Z)Z
...
.method public varargs setNdefPushMessage(Landroid/nfc/NdefMessage;Landroid/app/Activity;[Landroid/app/Activity;)V
    ...
    .line 1071
    invoke-direct {p0, v6}, isAndroidBeamAllowed(Z)Z
    ...
    .line 1076
    :cond_8
    invoke-virtual {p0}, getSdkVersion()I
    ...
    :cond_23
    :try_start_23
    iget-object v6, p0, mNfcActivityManager:Landroid/nfc/NfcActivityManager;
