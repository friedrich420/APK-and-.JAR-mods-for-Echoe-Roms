...
.method public constructor <init>(SSISI)V
    ...
    .line 74
    iput-short p1, p0, mFormat:S

    .line 75
    iput p3, p0, mSampleRate:I

    .line 76
    iput-short p2, p0, mNumChannels:S

    .line 77
    iput-short p4, p0, mBitsPerSample:S

    .line 78
    iput p5, p0, mNumBytes:I
...
.method public getBitsPerSample()S
    ...
    .prologue
    .line 143
    iget-short v0, p0, mBitsPerSample:S
...
.method public getNumChannels()S
    ...
    .prologue
    .line 106
    iget-short v0, p0, mNumChannels:S
...
.method public read(Ljava/io/InputStream;)I
    ...
    invoke-static {p1, v3}, readId(Ljava/io/InputStream;Ljava/lang/String;)V

    .line 184
    invoke-static {p1}, readInt(Ljava/io/InputStream;)I
    ...
    .line 190
    :cond_25
    invoke-static {p1}, readShort(Ljava/io/InputStream;)S

    move-result v3

    iput-short v3, p0, mFormat:S
    ...
    iput-short v3, p0, mNumChannels:S
    ...
    iput-short v3, p0, mBitsPerSample:S

    .line 196
    iget-short v3, p0, mNumChannels:S

    iget v4, p0, mSampleRate:I

    mul-int/2addr v3, v4

    iget-short v4, p0, mBitsPerSample:S
...
.method public setBitsPerSample(S)Landroid/speech/srec/WaveHeader;
    ...
    .prologue
    .line 153
    iput-short p1, p0, mBitsPerSample:S
...
.method public setNumChannels(S)Landroid/speech/srec/WaveHeader;
    ...
    .prologue
    .line 115
    iput-short p1, p0, mNumChannels:S
...
.method public toString()Ljava/lang/String;
    ...
    iget-short v3, p0, mBitsPerSample:S
...
.method public write(Ljava/io/OutputStream;)I
    ...
    invoke-static {p1, v0}, writeId(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0}, writeInt(Ljava/io/OutputStream;I)V
    ...
    invoke-static {p1, v0}, writeShort(Ljava/io/OutputStream;S)V
    ...
    iget v1, p0, mSampleRate:I

    mul-int/2addr v0, v1

    iget-short v1, p0, mBitsPerSample:S
