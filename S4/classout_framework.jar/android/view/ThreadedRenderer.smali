...
.method constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 95
    iput-boolean v6, p0, mInitialized:Z
    ...
    .line 114
    invoke-static {p2, v2, v3}, nCreateProxy(ZJ)J
    ...
    invoke-static {v4, v5, v6, v7}, nSetFrameInterval(JJ)V
...
.method private static checkIfProfilingRequested()Z
    ...
    sget-object v2, VISUALIZERS:[Ljava/lang/String;

    invoke-static {v2, v1}, search([Ljava/lang/String;Ljava/lang/String;)I
...
.method copyLayerInto(Landroid/view/HardwareLayer;Landroid/graphics/Bitmap;)Z
    ...
    invoke-static/range {v0 .. v5}, nCopyLayerInto(JJJ)Z
...
.method draw(Landroid/view/View;Landroid/view/View$AttachInfo;Landroid/view/HardwareRenderer$HardwareDrawCallbacks;)V
    ...
    iget-boolean v0, p0, mProfilingEnabled:Z
    ...
    invoke-virtual {p0, v0}, registerAnimatingRenderNode(Landroid/view/RenderNode;)V
    ...
    invoke-static/range {v0 .. v6}, nSyncAndDrawFrame(JJJF)I
...
.method dumpGfxInfo(Ljava/io/PrintWriter;Ljava/io/FileDescriptor;)V
    ...
    invoke-static {v0, v1, p2}, nDumpProfileInfo(JLjava/io/FileDescriptor;)V
...
.method loadSystemProperties()Z
    ...
    .line 262
    .local v0, "changed":Z
    invoke-static {}, checkIfProfilingRequested()Z

    move-result v1

    .line 263
    .local v1, "wantProfiling":Z
    iget-boolean v2, p0, mProfilingEnabled:Z

    if-eq v1, v2, :cond_11

    .line 264
    iput-boolean v1, p0, mProfilingEnabled:Z
...
.method pauseSurface(Landroid/view/Surface;)V
    ...
    invoke-static {v0, v1, p1}, nPauseSurface(JLandroid/view/Surface;)V
...
.method setup(IILandroid/graphics/Rect;)V
    ...
    .line 195
    :cond_1d
    iput-boolean v7, p0, mHasInsets:Z
    ...
    iget v5, p0, mInsetLeft:I

    sub-int/2addr v3, v5

    iget v5, p0, mSurfaceHeight:I

    iget v6, p0, mInsetTop:I
    ...
    .line 216
    iput-boolean v7, p0, mRootNodeNeedsUpdate:Z
    ...
    iget v5, p0, mLightY:F

    iget v6, p0, mLightZ:F

    iget v7, p0, mLightRadius:F

    iget v8, p0, mAmbientShadowAlpha:I

    iget v9, p0, mSpotShadowAlpha:I

    invoke-static/range {v0 .. v9}, nSetup(JIIFFFFII)V
