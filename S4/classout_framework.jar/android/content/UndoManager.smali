...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mOwners:Ljava/util/HashMap;
    ...
    iput-object v0, p0, mUndos:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mRedos:Ljava/util/ArrayList;

    .line 61
    const/16 v0, 0x14

    iput v0, p0, mHistorySize:I

    .line 63
    const/4 v0, 0x1

    iput v0, p0, mCommitId:I
...
.method private createWorkingState()V
    ...
    iget v1, p0, mCommitId:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, mCommitId:I

    invoke-direct {v0, p0, v1}, Landroid/content/UndoManager$UndoState;-><init>(Landroid/content/UndoManager;I)V

    iput-object v0, p0, mWorking:Landroid/content/UndoManager$UndoState;

    .line 420
    iget v0, p0, mCommitId:I
...
.method private pushWorkingState()V
    ...
    .line 577
    iget-object v1, p0, mUndos:Ljava/util/ArrayList;
    ...
    .line 579
    .local v0, "N":I
    iget-object v1, p0, mWorking:Landroid/content/UndoManager$UndoState;
    ...
    iget-object v2, p0, mWorking:Landroid/content/UndoManager$UndoState;
    ...
    invoke-virtual {p0, v3, v1}, forgetRedos([Landroid/content/UndoOwner;I)I
    ...
    :cond_31
    :goto_31
    iput-object v3, p0, mWorking:Landroid/content/UndoManager$UndoState;

    .line 594
    iget v1, p0, mHistorySize:I
    ...
    invoke-virtual {p0, v3, v1}, forgetUndos([Landroid/content/UndoOwner;I)I
...
.method public addOperation(Landroid/content/UndoOperation;I)V
    ...
    invoke-virtual {p0, v2}, getTopUndo([Landroid/content/UndoOwner;)Landroid/content/UndoManager$UndoState;
    ...
    .line 553
    iput-object v1, p0, mWorking:Landroid/content/UndoManager$UndoState;

    .line 554
    iget-object v2, p0, mUndos:Ljava/util/ArrayList;
...
.method public beginUpdate(Ljava/lang/CharSequence;)V
    ...
    .line 408
    :cond_d
    iget v0, p0, mUpdateCount:I

    if-gtz v0, :cond_18

    .line 409
    invoke-direct {p0}, createWorkingState()V

    .line 410
    iput-boolean v1, p0, mMerged:Z

    .line 411
    iput v1, p0, mUpdateCount:I

    .line 414
    :cond_18
    iget-object v0, p0, mWorking:Landroid/content/UndoManager$UndoState;
...
.method public commitState(Landroid/content/UndoOwner;)I
    ...
    .line 618
    .local v0, "commitId":I
    invoke-direct {p0}, pushWorkingState()V
...
.method public countRedos([Landroid/content/UndoOwner;)I
    ...
    .line 367
    iget-object v2, p0, mRedos:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2, p1, v1}, findNextState(Ljava/util/ArrayList;[Landroid/content/UndoOwner;I)I
...
.method findNextState(Ljava/util/ArrayList;[Landroid/content/UndoOwner;I)I
    ...
    invoke-virtual {p0, v1, p2}, matchOwners(Landroid/content/UndoManager$UndoState;[Landroid/content/UndoOwner;)Z
...
.method public forgetRedos([Landroid/content/UndoOwner;I)I
    ...
    .line 325
    iget-object v3, p0, mRedos:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2, p1}, matchOwners(Landroid/content/UndoManager$UndoState;[Landroid/content/UndoOwner;)Z
...
.method public forgetUndos([Landroid/content/UndoOwner;I)I
    ...
    .line 307
    iget-object v3, p0, mUndos:Ljava/util/ArrayList;
...
.method public getLastOperation(I)Landroid/content/UndoOperation;
    ...
    .line 482
    invoke-virtual {p0, v0, v0, p1}, getLastOperation(Ljava/lang/Class;Landroid/content/UndoOwner;I)Landroid/content/UndoOperation;
...
.method public getLastOperation(Landroid/content/UndoOwner;I)Landroid/content/UndoOperation;
    ...
    invoke-virtual {p0, v0, p1, p2}, getLastOperation(Ljava/lang/Class;Landroid/content/UndoOwner;I)Landroid/content/UndoOperation;
...
.method public getOwner(Ljava/lang/String;Ljava/lang/Object;)Landroid/content/UndoOwner;
    ...
    .line 94
    :cond_15
    iget-object v2, p0, mOwners:Ljava/util/HashMap;
...
.method public getRedoLabel([Landroid/content/UndoOwner;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 395
    invoke-virtual {p0, p1}, getTopRedo([Landroid/content/UndoOwner;)Landroid/content/UndoManager$UndoState;
...
.method getTopRedo([Landroid/content/UndoOwner;)Landroid/content/UndoManager$UndoState;
    ...
    invoke-virtual {p0, v2, p1, v3}, findPrevState(Ljava/util/ArrayList;[Landroid/content/UndoOwner;I)I
    ...
    iget-object v1, p0, mRedos:Ljava/util/ArrayList;
...
.method public getUndoLabel([Landroid/content/UndoOwner;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 385
    invoke-virtual {p0, p1}, getTopUndo([Landroid/content/UndoOwner;)Landroid/content/UndoManager$UndoState;
...
.method public redo([Landroid/content/UndoOwner;I)I
    ...
    .prologue
    .line 274
    iget-object v3, p0, mWorking:Landroid/content/UndoManager$UndoState;
    ...
    invoke-virtual {p0, v3, p1, v0}, findPrevState(Ljava/util/ArrayList;[Landroid/content/UndoOwner;I)I
...
.method public restoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 180
    :cond_f
    invoke-virtual {p0, v7, v5}, forgetUndos([Landroid/content/UndoOwner;I)I

    .line 181
    invoke-virtual {p0, v7, v5}, forgetRedos([Landroid/content/UndoOwner;I)I
    ...
    iput-object v4, p0, mStateOwners:[Landroid/content/UndoOwner;
    ...
    .line 191
    iget-object v4, p0, mUndos:Ljava/util/ArrayList;
    ...
    .line 193
    :cond_42
    iget-object v4, p0, mRedos:Ljava/util/ArrayList;
...
.method restoreOwner(Landroid/os/Parcel;)Landroid/content/UndoOwner;
    ...
    .line 200
    .local v0, "idx":I
    iget-object v3, p0, mStateOwners:[Landroid/content/UndoOwner;
    ...
    .line 205
    iget-object v3, p0, mOwners:Ljava/util/HashMap;
...
.method public saveInstanceState()Landroid/os/Parcelable;
    ...
    iget v3, p0, mStateSeq:I

    add-int/lit8 v3, v3, 0x1

    iput v3, p0, mStateSeq:I
    ...
    .line 133
    iput v4, p0, mStateSeq:I

    .line 135
    :cond_2a
    iput v4, p0, mNextSavedIdx:I

    .line 136
    iget v3, p0, mHistorySize:I
...
.method public setHistorySize(I)V
    ...
    invoke-virtual {p0, v2}, countUndos([Landroid/content/UndoOwner;)I
    ...
    invoke-virtual {p0, v2, v0}, forgetUndos([Landroid/content/UndoOwner;I)I
...
.method public uncommitState(ILandroid/content/UndoOwner;)Z
    ...
    invoke-virtual {p0, v1}, getTopUndo([Landroid/content/UndoOwner;)Landroid/content/UndoManager$UndoState;
...
.method public undo([Landroid/content/UndoOwner;I)I
    ...
    .prologue
    .line 237
    iget-object v4, p0, mWorking:Landroid/content/UndoManager$UndoState;
    ...
    iput-boolean v4, p0, mInUndo:Z

    .line 246
    const/4 v4, 0x0

    invoke-virtual {p0, v4}, getTopUndo([Landroid/content/UndoOwner;)Landroid/content/UndoManager$UndoState;
    ...
    invoke-virtual {p0, v4, p1, v0}, findPrevState(Ljava/util/ArrayList;[Landroid/content/UndoOwner;I)I
