...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V
    ...
    iput-wide v0, p0, mLastLoadCompleteTime:J

    .line 143
    iput-object p2, p0, mExecutor:Ljava/util/concurrent/Executor;
...
.method dispatchOnCancelled(Landroid/content/AsyncTaskLoader$LoadTask;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p2}, onCanceled(Ljava/lang/Object;)V

    .line 241
    iget-object v0, p0, mCancellingTask:Landroid/content/AsyncTaskLoader$LoadTask;

    if-ne v0, p1, :cond_19

    .line 243
    invoke-virtual {p0}, rollbackContentChanged()V
    ...
    iput-object v0, p0, mCancellingTask:Landroid/content/AsyncTaskLoader$LoadTask;

    .line 247
    invoke-virtual {p0}, deliverCancellation()V

    .line 248
    invoke-virtual {p0}, executePendingTask()V
...
.method dispatchOnLoadComplete(Landroid/content/AsyncTaskLoader$LoadTask;Ljava/lang/Object;)V
    ...
    .local p1, "task":Landroid/content/AsyncTaskLoader$LoadTask;, "Landroid/content/AsyncTaskLoader<TD;>.LoadTask;"
    .local p2, "data":Ljava/lang/Object;, "TD;"
    iget-object v0, p0, mTask:Landroid/content/AsyncTaskLoader$LoadTask;

    if-eq v0, p1, :cond_8

    .line 255
    invoke-virtual {p0, p1, p2}, dispatchOnCancelled(Landroid/content/AsyncTaskLoader$LoadTask;Ljava/lang/Object;)V
    ...
    .line 257
    :cond_8
    invoke-virtual {p0}, isAbandoned()Z
    ...
    .line 261
    :cond_12
    invoke-virtual {p0}, commitContentChanged()V
    ...
    iput-object v0, p0, mTask:Landroid/content/AsyncTaskLoader$LoadTask;

    .line 265
    invoke-virtual {p0, p2}, deliverResult(Ljava/lang/Object;)V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 368
    :cond_3f
    iget-wide v0, p0, mUpdateThrottle:J
    ...
    .line 372
    iget-wide v0, p0, mLastLoadCompleteTime:J
...
.method executePendingTask()V
    ...
    .line 217
    .local p0, "this":Landroid/content/AsyncTaskLoader;, "Landroid/content/AsyncTaskLoader<TD;>;"
    iget-object v2, p0, mCancellingTask:Landroid/content/AsyncTaskLoader$LoadTask;

    if-nez v2, :cond_40

    iget-object v2, p0, mTask:Landroid/content/AsyncTaskLoader$LoadTask;
    ...
    iget-object v3, p0, mTask:Landroid/content/AsyncTaskLoader$LoadTask;

    invoke-virtual {v2, v3}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    .line 222
    :cond_1a
    iget-wide v2, p0, mUpdateThrottle:J
    ...
    .line 224
    .local v0, "now":J
    iget-wide v2, p0, mLastLoadCompleteTime:J

    iget-wide v4, p0, mUpdateThrottle:J
    ...
    iget-wide v4, p0, mLastLoadCompleteTime:J

    iget-wide v6, p0, mUpdateThrottle:J
    ...
    iget-object v4, p0, mExecutor:Ljava/util/concurrent/Executor;
...
.method protected onCancelLoad()Z
    ...
    .line 172
    iget-object v1, p0, mTask:Landroid/content/AsyncTaskLoader$LoadTask;

    if-eqz v1, :cond_1d

    .line 173
    iget-object v1, p0, mCancellingTask:Landroid/content/AsyncTaskLoader$LoadTask;
    ...
    .line 182
    :cond_1b
    iput-object v3, p0, mTask:Landroid/content/AsyncTaskLoader$LoadTask;
    ...
    iput-object v1, p0, mCancellingTask:Landroid/content/AsyncTaskLoader$LoadTask;

    .line 197
    invoke-virtual {p0}, cancelLoadInBackground()V
...
.method protected onForceLoad()V
    ...
    .line 163
    invoke-virtual {p0}, cancelLoad()Z
...
.method protected onLoadInBackground()Ljava/lang/Object;
    ...
    .line 312
    .local p0, "this":Landroid/content/AsyncTaskLoader;, "Landroid/content/AsyncTaskLoader<TD;>;"
    invoke-virtual {p0}, loadInBackground()Ljava/lang/Object;
...
.method public setUpdateThrottle(J)V
    ...
    .line 154
    .local p0, "this":Landroid/content/AsyncTaskLoader;, "Landroid/content/AsyncTaskLoader<TD;>;"
    iput-wide p1, p0, mUpdateThrottle:J
