...
.method constructor <init>(JZ)V
    ...
    iput-object v0, p0, mStyleIDs:Landroid/content/res/StringBlock$StyleIDs;

    .line 478
    iput-wide p1, p0, mNative:J

    .line 479
    iput-boolean p3, p0, mUseSparse:Z

    .line 480
    const/4 v0, 0x0

    iput-boolean v0, p0, mOwnsNative:Z
...
.method public constructor <init>([BIIZ)V
    ...
    .line 55
    invoke-static {p1, p2, p3}, nativeCreate([BII)J

    move-result-wide v0

    iput-wide v0, p0, mNative:J

    .line 56
    iput-boolean p4, p0, mUseSparse:Z
...
.method public constructor <init>([BZ)V
    ...
    invoke-static {p1, v0, v1}, nativeCreate([BII)J
    ...
    .line 48
    iput-boolean p2, p0, mUseSparse:Z
...
.method private applyStyles(Ljava/lang/String;[ILandroid/content/res/StringBlock$StyleIDs;)Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v14, v15, v0}, addParagraphSpan(Landroid/text/Spannable;Ljava/lang/Object;II)V
    ...
    iget-wide v14, v0, mNative:J

    invoke-static {v14, v15, v12}, nativeGetString(JI)Ljava/lang/String;
    ...
    invoke-static {v11, v14}, subtag(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v9, v14}, getColor(Ljava/lang/String;Z)Landroid/text/style/CharacterStyle;
...
.method protected finalize()V
    ...
    .line 146
    iget-boolean v0, p0, mOwnsNative:Z

    if-eqz v0, :cond_c

    .line 147
    iget-wide v0, p0, mNative:J
    ...
    iget-boolean v1, p0, mOwnsNative:Z

    if-eqz v1, :cond_17

    .line 147
    iget-wide v2, p0, mNative:J

    invoke-static {v2, v3}, nativeDestroy(J)V
...
.method public get(I)Ljava/lang/CharSequence;
    ...
    .line 64
    :try_start_1
    iget-object v7, p0, mStrings:[Ljava/lang/CharSequence;
    ...
    :cond_d
    iget-object v7, p0, mSparseStrings:Landroid/util/SparseArray;
    ...
    :cond_20
    :try_start_20
    iget-wide v8, p0, mNative:J

    invoke-static {v8, v9}, nativeGetSize(J)I

    move-result v0

    .line 76
    .local v0, "num":I
    iget-boolean v7, p0, mUseSparse:Z
    ...
    iput-object v7, p0, mSparseStrings:Landroid/util/SparseArray;
    ...
    invoke-static {v8, v9, p1}, nativeGetString(JI)Ljava/lang/String;
    ...
    invoke-static {v8, v9, p1}, nativeGetStyle(JI)[I
    ...
    .line 88
    iget-object v7, p0, mStyleIDs:Landroid/content/res/StringBlock$StyleIDs;
    ...
    iput-object v7, p0, mStyleIDs:Landroid/content/res/StringBlock$StyleIDs;
    ...
    iput-object v7, p0, mStrings:[Ljava/lang/CharSequence;
    ...
    invoke-static {v8, v9, v4}, nativeGetString(JI)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v3, v7}, applyStyles(Ljava/lang/String;[ILandroid/content/res/StringBlock$StyleIDs;)Ljava/lang/CharSequence;
