...
.method public constructor <init>(Landroid/database/Cursor;Ljava/lang/String;ZLandroid/os/Handler;)V
    ...
    .line 40
    iput-object v1, p0, mHandlerForUpdateNotifications:Landroid/os/Handler;

    .line 41
    iput-boolean v0, p0, mKeepUpdated:Z

    .line 43
    iput-object v1, p0, mValues:Ljava/util/Map;
    ...
    iput-object v0, p0, mColumnNames:[Ljava/lang/String;
    ...
    iput v0, p0, mKeyColumn:I

    .line 67
    iput-object p4, p0, mHandlerForUpdateNotifications:Landroid/os/Handler;

    .line 68
    invoke-virtual {p0, p3}, setKeepUpdated(Z)V

    .line 73
    if-nez p3, :cond_29

    .line 74
    invoke-direct {p0, p1}, readCursorIntoCache(Landroid/database/Cursor;)V
...
.method private declared-synchronized readCursorIntoCache(Landroid/database/Cursor;)V
    ...
    :try_start_1
    iget-object v3, p0, mValues:Ljava/util/Map;
    ...
    iput-object v3, p0, mValues:Ljava/util/Map;
    ...
    .local v1, "i":I
    :goto_1e
    iget-object v3, p0, mColumnNames:[Ljava/lang/String;
...
.method public declared-synchronized close()V
    ...
    :try_start_1
    iget-object v0, p0, mContentObserver:Landroid/database/ContentObserver;
...
.method public declared-synchronized getRows()Ljava/util/Map;
    ...
    invoke-virtual {p0}, requery()V

    .line 165
    :cond_8
    iget-object v0, p0, mValues:Ljava/util/Map;
    :try_end_a
...
.method public requery()V
    ...
    .line 143
    invoke-direct {p0, v0}, readCursorIntoCache(Landroid/database/Cursor;)V

    .line 144
    invoke-virtual {p0}, setChanged()V

    .line 145
    invoke-virtual {p0}, notifyObservers()V
...
.method public setKeepUpdated(Z)V
    ...
    .prologue
    .line 87
    iget-boolean v0, p0, mKeepUpdated:Z
    ...
    .line 88
    :cond_5
    iput-boolean p1, p0, mKeepUpdated:Z
    ...
    .line 94
    :cond_16
    iget-object v0, p0, mHandlerForUpdateNotifications:Landroid/os/Handler;
    ...
    iput-object v0, p0, mHandlerForUpdateNotifications:Landroid/os/Handler;
    ...
    iget-object v1, p0, mHandlerForUpdateNotifications:Landroid/os/Handler;
