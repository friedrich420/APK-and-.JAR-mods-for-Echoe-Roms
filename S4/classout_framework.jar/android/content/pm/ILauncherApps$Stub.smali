...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v0}, addOnAppsChangedListener(Landroid/content/pm/IOnAppsChangedListener;)V
    ...
    invoke-virtual {p0, v0}, removeOnAppsChangedListener(Landroid/content/pm/IOnAppsChangedListener;)V
    ...
    :goto_4f
    invoke-virtual {p0, v0, v1}, getLauncherActivities(Ljava/lang/String;Landroid/os/UserHandle;)Ljava/util/List;
    ...
    .restart local v1    # "_arg1":Landroid/os/UserHandle;
    :goto_7d
    invoke-virtual {p0, v0, v1}, resolveActivity(Landroid/content/Intent;Landroid/os/UserHandle;)Landroid/content/pm/ResolveInfo;
    ...
    :goto_d4
    invoke-virtual {p0, v0, v1, v2, v3}, startActivityAsUser(Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/os/Bundle;Landroid/os/UserHandle;)V
    ...
    .restart local v3    # "_arg3":Landroid/os/UserHandle;
    :goto_121
    invoke-virtual {p0, v0, v1, v2, v3}, showAppDetailsAsUser(Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/os/Bundle;Landroid/os/UserHandle;)V
    ...
    .local v1, "_arg1":Landroid/os/UserHandle;
    :goto_148
    invoke-virtual {p0, v0, v1}, isPackageEnabled(Ljava/lang/String;Landroid/os/UserHandle;)Z
    ...
    .restart local v1    # "_arg1":Landroid/os/UserHandle;
    :goto_17a
    invoke-virtual {p0, v0, v1}, isActivityEnabled(Landroid/content/ComponentName;Landroid/os/UserHandle;)Z
