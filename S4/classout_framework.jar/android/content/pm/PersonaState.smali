...
.method static constructor <clinit>()V
    ...
    sput-object v0, INVALID:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, CREATING:Landroid/content/pm/PersonaState;
    ...
    invoke-direct {v0, v1, v7, v5}, <init>(Ljava/lang/String;II)V

    sput-object v0, ACTIVE:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, LOCKED:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, SUPER_LOCKED:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, LICENSE_LOCKED:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, ADMIN_LOCKED:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, ADMIN_LICENSE_LOCKED:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, TERMINUS:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, DELETING:Landroid/content/pm/PersonaState;
    ...
    sput-object v0, TIMA_COMPROMISED:Landroid/content/pm/PersonaState;
    ...
    sget-object v1, INVALID:Landroid/content/pm/PersonaState;

    aput-object v1, v0, v5

    sget-object v1, CREATING:Landroid/content/pm/PersonaState;

    aput-object v1, v0, v6

    sget-object v1, ACTIVE:Landroid/content/pm/PersonaState;

    aput-object v1, v0, v7

    sget-object v1, LOCKED:Landroid/content/pm/PersonaState;

    aput-object v1, v0, v8

    const/4 v1, 0x4

    sget-object v2, SUPER_LOCKED:Landroid/content/pm/PersonaState;

    aput-object v2, v0, v1

    const/4 v1, 0x5

    sget-object v2, LICENSE_LOCKED:Landroid/content/pm/PersonaState;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, ADMIN_LOCKED:Landroid/content/pm/PersonaState;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, ADMIN_LICENSE_LOCKED:Landroid/content/pm/PersonaState;

    aput-object v2, v0, v1

    const/16 v1, 0x8

    sget-object v2, TERMINUS:Landroid/content/pm/PersonaState;

    aput-object v2, v0, v1

    const/16 v1, 0x9

    sget-object v2, DELETING:Landroid/content/pm/PersonaState;

    aput-object v2, v0, v1

    const/16 v1, 0xa

    sget-object v2, TIMA_COMPROMISED:Landroid/content/pm/PersonaState;

    aput-object v2, v0, v1

    sput-object v0, $VALUES:[Landroid/content/pm/PersonaState;
...
.method private constructor <init>(Ljava/lang/String;II)V
    ...
    iput v0, p0, knox2_0_state_id:I

    .line 35
    iput p3, p0, knox2_0_state_id:I
...
.method public static values()[Landroid/content/pm/PersonaState;
    ...
    .prologue
    .line 6
    sget-object v0, $VALUES:[Landroid/content/pm/PersonaState;
