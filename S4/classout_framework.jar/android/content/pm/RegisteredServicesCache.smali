...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/pm/XmlSerializerAndParser;)V
    ...
    iput-object v0, p0, mServicesLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mUserServices:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, mExternalReceiver:Landroid/content/BroadcastReceiver;

    .line 115
    iput-object p1, p0, mContext:Landroid/content/Context;

    .line 116
    iput-object p2, p0, mInterfaceName:Ljava/lang/String;

    .line 117
    iput-object p3, p0, mMetaDataName:Ljava/lang/String;

    .line 118
    iput-object p4, p0, mAttributesName:Ljava/lang/String;

    .line 119
    iput-object p5, p0, mSerializerAndParser:Landroid/content/pm/XmlSerializerAndParser;
    ...
    iput-object v0, p0, mPersistentServicesFile:Landroid/util/AtomicFile;
    ...
    iget-object v1, p0, mExternalReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$100(Landroid/content/pm/RegisteredServicesCache;Landroid/content/Intent;I)V
    ...
    .prologue
    .line 70
    invoke-direct {p0, p1, p2}, handlePackageEvent(Landroid/content/Intent;I)V
...
.method private findOrCreateUserLocked(I)Landroid/content/pm/RegisteredServicesCache$UserServices;
    ...
    .line 95
    .local p0, "this":Landroid/content/pm/RegisteredServicesCache;, "Landroid/content/pm/RegisteredServicesCache<TV;>;"
    iget-object v1, p0, mUserServices:Landroid/util/SparseArray;
...
.method private generateServicesMap(I)V
    ...
    iget-object v0, v0, mInterfaceName:Ljava/lang/String;
    ...
    invoke-direct {v0, v12}, parseServiceInfo(Landroid/content/pm/ResolveInfo;)Landroid/content/pm/RegisteredServicesCache$ServiceInfo;
    ...
    .line 340
    :try_start_aa
    invoke-direct/range {p0 .. p1}, findOrCreateUserLocked(I)Landroid/content/pm/RegisteredServicesCache$UserServices;
    ...
    iget-boolean v0, v0, mPersistentServicesFileDidNotExist:Z
    ...
    invoke-direct {v0, v1, v2, v3}, notifyListener(Ljava/lang/Object;IZ)V
    ...
    invoke-direct {v0, v1}, inSystemImage(I)Z
    ...
    invoke-direct {v0, v14, v1, v2}, containsTypeAndUid(Ljava/util/ArrayList;Ljava/lang/Object;I)Z
    ...
    invoke-direct {v0, v14, v1}, containsType(Ljava/util/ArrayList;Ljava/lang/Object;)Z
...
.method private final handlePackageEvent(Landroid/content/Intent;I)V
    ...
    :cond_23
    invoke-direct {p0, p2}, generateServicesMap(I)V
...
.method private notifyListener(Ljava/lang/Object;IZ)V
    ...
    .line 226
    :try_start_1
    iget-object v7, p0, mListener:Landroid/content/pm/RegisteredServicesCacheListener;
...
.method private parseServiceInfo(Landroid/content/pm/ResolveInfo;)Landroid/content/pm/RegisteredServicesCache$ServiceInfo;
    ...
    iget-object v13, v0, mMetaDataName:Ljava/lang/String;
    ...
    iget-object v15, v0, mMetaDataName:Ljava/lang/String;
    ...
    iget-object v13, v0, mAttributesName:Ljava/lang/String;
    ...
    iget-object v15, v0, mAttributesName:Ljava/lang/String;
    ...
    invoke-virtual {v0, v13, v14, v2}, parseServiceAttributes(Landroid/content/res/Resources;Ljava/lang/String;Landroid/util/AttributeSet;)Ljava/lang/Object;
    :try_end_b2
...
.method private readPersistentServicesLocked()V
    ...
    .line 498
    iget-object v10, p0, mUserServices:Landroid/util/SparseArray;

    invoke-virtual {v10}, Landroid/util/SparseArray;->clear()V

    .line 499
    iget-object v10, p0, mSerializerAndParser:Landroid/content/pm/XmlSerializerAndParser;
    ...
    :try_start_d
    iget-object v10, p0, mPersistentServicesFile:Landroid/util/AtomicFile;
    ...
    :goto_1a
    iput-boolean v10, p0, mPersistentServicesFileDidNotExist:Z

    .line 505
    iget-boolean v10, p0, mPersistentServicesFileDidNotExist:Z
    :try_end_1e
    ...
    .line 530
    .local v9, "userId":I
    invoke-direct {p0, v9}, findOrCreateUserLocked(I)Landroid/content/pm/RegisteredServicesCache$UserServices;
...
.method private writePersistentServicesLocked()V
    ...
    .line 553
    .local p0, "this":Landroid/content/pm/RegisteredServicesCache;, "Landroid/content/pm/RegisteredServicesCache<TV;>;"
    iget-object v7, p0, mSerializerAndParser:Landroid/content/pm/XmlSerializerAndParser;
    ...
    :try_start_6
    iget-object v7, p0, mPersistentServicesFile:Landroid/util/AtomicFile;
    ...
    .local v2, "i":I
    :goto_2e
    iget-object v7, p0, mUserServices:Landroid/util/SparseArray;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;I)V
    ...
    .line 190
    .local p0, "this":Landroid/content/pm/RegisteredServicesCache;, "Landroid/content/pm/RegisteredServicesCache<TV;>;"
    iget-object v4, p0, mServicesLock:Ljava/lang/Object;

    monitor-enter v4

    .line 191
    :try_start_3
    invoke-direct {p0, p4}, findOrCreateUserLocked(I)Landroid/content/pm/RegisteredServicesCache$UserServices;
...
.method public getAllServices(I)Ljava/util/Collection;
    ...
    .line 284
    .local p0, "this":Landroid/content/pm/RegisteredServicesCache;, "Landroid/content/pm/RegisteredServicesCache<TV;>;"
    iget-object v2, p0, mServicesLock:Ljava/lang/Object;

    monitor-enter v2

    .line 286
    :try_start_3
    invoke-direct {p0, p1}, findOrCreateUserLocked(I)Landroid/content/pm/RegisteredServicesCache$UserServices;
    ...
    .line 288
    invoke-direct {p0, p1}, generateServicesMap(I)V
...
.method public getListener()Landroid/content/pm/RegisteredServicesCacheListener;
    ...
    .line 205
    :try_start_1
    iget-object v0, p0, mListener:Landroid/content/pm/RegisteredServicesCacheListener;
...
.method public getServiceInfo(Ljava/lang/Object;I)Landroid/content/pm/RegisteredServicesCache$ServiceInfo;
    ...
    .line 271
    :try_start_3
    invoke-direct {p0, p2}, findOrCreateUserLocked(I)Landroid/content/pm/RegisteredServicesCache$UserServices;
...
.method public setListener(Landroid/content/pm/RegisteredServicesCacheListener;Landroid/os/Handler;)V
    ...
    .line 215
    iput-object p1, p0, mListener:Landroid/content/pm/RegisteredServicesCacheListener;
