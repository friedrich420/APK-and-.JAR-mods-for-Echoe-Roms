...
.method public constructor <init>(Landroid/net/Uri;Landroid/net/Uri;Landroid/net/Uri;ILandroid/content/pm/ManifestDigest;)V
    ...
    .line 75
    iput-object p1, p0, mVerificationURI:Landroid/net/Uri;

    .line 76
    iput-object p2, p0, mOriginatingURI:Landroid/net/Uri;

    .line 77
    iput-object p3, p0, mReferrer:Landroid/net/Uri;

    .line 78
    iput p4, p0, mOriginatingUid:I

    .line 79
    iput-object p5, p0, mManifestDigest:Landroid/content/pm/ManifestDigest;

    .line 80
    const/4 v0, -0x1

    iput v0, p0, mInstallerUid:I
...
.method private constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, mVerificationURI:Landroid/net/Uri;
    ...
    iput-object v0, p0, mOriginatingURI:Landroid/net/Uri;
    ...
    iput-object v0, p0, mReferrer:Landroid/net/Uri;
    ...
    iput-object v0, p0, mManifestDigest:Landroid/content/pm/ManifestDigest;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, mVerificationURI:Landroid/net/Uri;

    if-nez v3, :cond_18

    .line 131
    iget-object v3, v0, mVerificationURI:Landroid/net/Uri;
    ...
    iget-object v4, v0, mVerificationURI:Landroid/net/Uri;
    ...
    .line 138
    :cond_24
    iget-object v3, p0, mOriginatingURI:Landroid/net/Uri;

    if-nez v3, :cond_2e

    .line 139
    iget-object v3, v0, mOriginatingURI:Landroid/net/Uri;
    ...
    iget-object v4, v0, mOriginatingURI:Landroid/net/Uri;
    ...
    .line 146
    :cond_3a
    iget-object v3, p0, mReferrer:Landroid/net/Uri;

    if-nez v3, :cond_44

    .line 147
    iget-object v3, v0, mReferrer:Landroid/net/Uri;
    ...
    iget-object v4, v0, mReferrer:Landroid/net/Uri;
    ...
    .line 154
    :cond_50
    iget v3, p0, mOriginatingUid:I

    iget v4, v0, mOriginatingUid:I
    ...
    .line 158
    :cond_58
    iget-object v3, p0, mManifestDigest:Landroid/content/pm/ManifestDigest;

    if-nez v3, :cond_62

    .line 159
    iget-object v3, v0, mManifestDigest:Landroid/content/pm/ManifestDigest;
    ...
    iget-object v4, v0, mManifestDigest:Landroid/content/pm/ManifestDigest;
    ...
    .line 166
    :cond_6e
    iget v3, p0, mInstallerUid:I

    iget v4, v0, mInstallerUid:I
...
.method public getManifestDigest()Landroid/content/pm/ManifestDigest;
    ...
    .prologue
    .line 101
    iget-object v0, p0, mManifestDigest:Landroid/content/pm/ManifestDigest;
...
.method public getOriginatingURI()Landroid/net/Uri;
    ...
    .prologue
    .line 88
    iget-object v0, p0, mOriginatingURI:Landroid/net/Uri;
...
.method public getReferrer()Landroid/net/Uri;
    ...
    .prologue
    .line 92
    iget-object v0, p0, mReferrer:Landroid/net/Uri;
...
.method public getVerificationURI()Landroid/net/Uri;
    ...
    .prologue
    .line 84
    iget-object v0, p0, mVerificationURI:Landroid/net/Uri;
...
.method public hashCode()I
    ...
    .line 177
    .local v0, "hash":I
    iget-object v1, p0, mVerificationURI:Landroid/net/Uri;
    ...
    .line 178
    iget-object v1, p0, mOriginatingURI:Landroid/net/Uri;
    ...
    .line 179
    iget-object v1, p0, mReferrer:Landroid/net/Uri;
    ...
    .line 181
    iget-object v1, p0, mManifestDigest:Landroid/content/pm/ManifestDigest;
