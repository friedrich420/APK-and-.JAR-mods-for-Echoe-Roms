...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/ILauncherApps;)V
    ...
    iput-object v1, p0, mCallbacks:Ljava/util/List;
    ...
    iput-object v1, p0, mAppsChangedListener:Landroid/content/pm/IOnAppsChangedListener$Stub;

    .line 138
    iput-object p1, p0, mContext:Landroid/content/Context;

    .line 139
    iput-object p2, p0, mService:Landroid/content/pm/ILauncherApps;
...
.method private addCallbackLocked(Landroid/content/pm/LauncherApps$Callback;Landroid/os/Handler;)V
    ...
    .prologue
    .line 369
    invoke-direct {p0, p1}, removeCallbackLocked(Landroid/content/pm/LauncherApps$Callback;)V
...
.method private removeCallbackLocked(Landroid/content/pm/LauncherApps$Callback;)V
    ...
    .line 358
    :cond_a
    iget-object v2, p0, mCallbacks:Ljava/util/List;
...
.method public addCallback(Landroid/content/pm/LauncherApps$Callback;)V
    ...
    .prologue
    .line 534
    invoke-virtual {p0, p1}, registerCallback(Landroid/content/pm/LauncherApps$Callback;)V
...
.method public getActivityList(Ljava/lang/String;Landroid/os/UserHandle;)Ljava/util/List;
    ...
    .line 165
    iget-object v1, p0, mPersona:Landroid/os/PersonaManager;
    ...
    :try_start_60
    iget-object v1, p0, mService:Landroid/content/pm/ILauncherApps;
...
.method public registerCallback(Landroid/content/pm/LauncherApps$Callback;)V
    ...
    invoke-virtual {p0, p1, v0}, registerCallback(Landroid/content/pm/LauncherApps$Callback;Landroid/os/Handler;)V
...
.method public registerCallback(Landroid/content/pm/LauncherApps$Callback;Landroid/os/Handler;)V
    ...
    :goto_14
    invoke-direct {p0, p1, p2}, addCallbackLocked(Landroid/content/pm/LauncherApps$Callback;Landroid/os/Handler;)V
    :try_end_17
    ...
    iget-object v2, p0, mAppsChangedListener:Landroid/content/pm/IOnAppsChangedListener$Stub;
...
.method public removeCallback(Landroid/content/pm/LauncherApps$Callback;)V
    ...
    .prologue
    .line 542
    invoke-virtual {p0, p1}, unregisterCallback(Landroid/content/pm/LauncherApps$Callback;)V
...
.method public startAppDetailsActivity(Landroid/content/ComponentName;Landroid/os/UserHandle;Landroid/graphics/Rect;Landroid/os/Bundle;)V
    ...
    .line 267
    :try_start_0
    iget-object v0, p0, mService:Landroid/content/pm/ILauncherApps;
...
.method public unregisterCallback(Landroid/content/pm/LauncherApps$Callback;)V
    ...
    iget-object v1, p0, mAppsChangedListener:Landroid/content/pm/IOnAppsChangedListener$Stub;
