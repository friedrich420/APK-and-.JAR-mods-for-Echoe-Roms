...
.method constructor <init>(Landroid/content/pm/RegisteredServicesCache;Landroid/content/pm/RegisteredServicesCacheListener;Ljava/lang/Object;IZ)V
    ...
    iput-object p1, p0, this$0:Landroid/content/pm/RegisteredServicesCache;

    iput-object p2, p0, val$listener2:Landroid/content/pm/RegisteredServicesCacheListener;

    iput-object p3, p0, val$type:Ljava/lang/Object;

    iput p4, p0, val$userId:I

    iput-boolean p5, p0, val$removed:Z
...
.method public run()V
    ...
    .line 236
    .local p0, "this":Landroid/content/pm/RegisteredServicesCache$3;, "Landroid/content/pm/RegisteredServicesCache.3;"
    iget-object v0, p0, val$listener2:Landroid/content/pm/RegisteredServicesCacheListener;

    iget-object v1, p0, val$type:Ljava/lang/Object;

    iget v2, p0, val$userId:I

    iget-boolean v3, p0, val$removed:Z
