...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {v0, v3}, unregisterContentObserver(Landroid/database/IContentObserver;)V
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, registerContentObserver(Landroid/net/Uri;ZLandroid/database/IContentObserver;I)V
    ...
    .line 95
    invoke-virtual/range {v2 .. v7}, notifyChange(Landroid/net/Uri;Landroid/database/IContentObserver;ZZI)V
    ...
    invoke-virtual {v0, v3, v4, v5}, requestSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v3}, sync(Landroid/content/SyncRequest;)V
    ...
    invoke-virtual {v0, v3, v4}, syncAsUser(Landroid/content/SyncRequest;I)V
    ...
    invoke-virtual {v0, v3, v4, v5}, cancelSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/content/ComponentName;)V
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, cancelSyncAsUser(Landroid/accounts/Account;Ljava/lang/String;Landroid/content/ComponentName;I)V
    ...
    invoke-virtual {v0, v3}, cancelRequest(Landroid/content/SyncRequest;)V
    ...
    invoke-virtual {v0, v3, v4}, getSyncAutomatically(Landroid/accounts/Account;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v3, v4, v5}, getSyncAutomaticallyAsUser(Landroid/accounts/Account;Ljava/lang/String;I)Z
    ...
    invoke-virtual {v0, v3, v4, v5}, setSyncAutomatically(Landroid/accounts/Account;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, setSyncAutomaticallyAsUser(Landroid/accounts/Account;Ljava/lang/String;ZI)V
    ...
    invoke-virtual {v0, v3, v4, v5}, getPeriodicSyncs(Landroid/accounts/Account;Ljava/lang/String;Landroid/content/ComponentName;)Ljava/util/List;
    ...
    .line 333
    invoke-virtual/range {v8 .. v13}, addPeriodicSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;J)V
    ...
    invoke-virtual {v0, v3, v4, v5}, removePeriodicSync(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v3, v4}, getIsSyncable(Landroid/accounts/Account;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v3, v4, v5}, getIsSyncableAsUser(Landroid/accounts/Account;Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v3, v4, v5}, setIsSyncable(Landroid/accounts/Account;Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v3}, setMasterSyncAutomatically(Z)V
    ...
    invoke-virtual {v0, v3, v4}, setMasterSyncAutomaticallyAsUser(ZI)V
    ...
    .line 437
    invoke-virtual/range {p0 .. p0}, getMasterSyncAutomatically()Z
    ...
    invoke-virtual {v0, v3}, getMasterSyncAutomaticallyAsUser(I)Z
    ...
    .line 455
    invoke-virtual/range {p0 .. p0}, getCurrentSyncs()Ljava/util/List;
    ...
    invoke-virtual {v0, v3}, getCurrentSyncsAsUser(I)Ljava/util/List;
    ...
    .line 473
    invoke-virtual/range {p0 .. p0}, getSyncAdapterTypes()[Landroid/content/SyncAdapterType;
    ...
    invoke-virtual {v0, v3}, getSyncAdapterTypesAsUser(I)[Landroid/content/SyncAdapterType;
    ...
    invoke-virtual {v0, v3, v4, v5}, isSyncActive(Landroid/accounts/Account;Ljava/lang/String;Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v0, v3, v4, v5}, getSyncStatus(Landroid/accounts/Account;Ljava/lang/String;Landroid/content/ComponentName;)Landroid/content/SyncStatusInfo;
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, getSyncStatusAsUser(Landroid/accounts/Account;Ljava/lang/String;Landroid/content/ComponentName;I)Landroid/content/SyncStatusInfo;
    ...
    invoke-virtual {v0, v3, v4, v5}, isSyncPending(Landroid/accounts/Account;Ljava/lang/String;Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, isSyncPendingAsUser(Landroid/accounts/Account;Ljava/lang/String;Landroid/content/ComponentName;I)Z
    ...
    invoke-virtual {v0, v3, v4}, addStatusChangeListener(ILandroid/content/ISyncStatusObserver;)V
    ...
    invoke-virtual {v0, v3}, removeStatusChangeListener(Landroid/content/ISyncStatusObserver;)V
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, setIsSyncableAsUser(Landroid/accounts/Account;Ljava/lang/String;II)V
