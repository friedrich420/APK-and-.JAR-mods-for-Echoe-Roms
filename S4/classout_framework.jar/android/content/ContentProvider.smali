...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mCallingPackage:Ljava/lang/ThreadLocal;
    ...
    iput-object v0, p0, mTransport:Landroid/content/ContentProvider$Transport;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[Landroid/content/pm/PathPermission;)V
    ...
    .line 156
    iput-object p2, p0, mReadPermission:Ljava/lang/String;

    .line 157
    iput-object p3, p0, mWritePermission:Ljava/lang/String;

    .line 158
    iput-object p4, p0, mPathPermissions:[Landroid/content/pm/PathPermission;
...
.method static synthetic access$000(Landroid/content/ContentProvider;Landroid/net/Uri;)V
    ...
    .prologue
    .line 93
    invoke-direct {p0, p1}, validateIncomingUri(Landroid/net/Uri;)V
...
.method static synthetic access$100(Landroid/content/ContentProvider;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 93
    invoke-direct {p0, p1}, setCallingPackage(Ljava/lang/String;)Ljava/lang/String;
...
.method private attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;Z)V
    ...
    .line 1704
    iget-object v1, p0, mTransport:Landroid/content/ContentProvider$Transport;
    ...
    invoke-virtual {p0, v0}, setReadPermission(Ljava/lang/String;)V

    .line 1710
    iget-object v0, p2, Landroid/content/pm/ProviderInfo;->writePermission:Ljava/lang/String;

    invoke-virtual {p0, v0}, setWritePermission(Ljava/lang/String;)V

    .line 1711
    iget-object v0, p2, Landroid/content/pm/ProviderInfo;->pathPermissions:[Landroid/content/pm/PathPermission;

    invoke-virtual {p0, v0}, setPathPermissions([Landroid/content/pm/PathPermission;)V

    .line 1712
    iget-boolean v0, p2, Landroid/content/pm/ProviderInfo;->exported:Z

    iput-boolean v0, p0, mExported:Z
    ...
    :goto_3c
    iput-boolean v0, p0, mSingleUser:Z

    .line 1714
    iget-object v0, p2, Landroid/content/pm/ProviderInfo;->authority:Ljava/lang/String;

    invoke-virtual {p0, v0}, setAuthorities(Ljava/lang/String;)V

    .line 1716
    :cond_43
    invoke-virtual {p0}, onCreate()Z
...
.method public static getUriWithoutUserId(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-static {v1}, getAuthorityWithoutUserId(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getUserIdFromAuthority(Ljava/lang/String;)I
    ...
    invoke-static {p0, v0}, getUserIdFromAuthority(Ljava/lang/String;I)I
...
.method public static getUserIdFromUri(Landroid/net/Uri;)I
    ...
    invoke-static {p0, v0}, getUserIdFromUri(Landroid/net/Uri;I)I
...
.method public static getUserIdFromUri(Landroid/net/Uri;I)I
    ...
    invoke-static {v0, p1}, getUserIdFromAuthority(Ljava/lang/String;I)I
...
.method public static maybeAddUserId(Landroid/net/Uri;I)Landroid/net/Uri;
    ...
    .line 1890
    invoke-static {p0}, uriHasUserId(Landroid/net/Uri;)Z
...
.method private setCallingPackage(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 637
    iget-object v1, p0, mCallingPackage:Ljava/lang/ThreadLocal;
...
.method private validateIncomingUri(Landroid/net/Uri;)V
    ...
    invoke-static {v0, v3}, getUserIdFromAuthority(Ljava/lang/String;I)I
    ...
    .line 1817
    :cond_3d
    invoke-static {v0}, getAuthorityWithoutUserId(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0, v3}, matchesOurAuthorities(Ljava/lang/String;)Z
    ...
    iget-object v3, p0, mAuthority:Ljava/lang/String;
    ...
    iget-object v4, p0, mAuthority:Ljava/lang/String;
    ...
    iget-object v4, p0, mAuthorities:[Ljava/lang/String;
...
.method public attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    ...
    invoke-direct {p0, p1, p2, v0}, attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;Z)V
...
.method public bulkInsert(Landroid/net/Uri;[Landroid/content/ContentValues;)I
    ...
    invoke-virtual {p0, p1, v2}, insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
...
.method checkUser(IILandroid/content/Context;)Z
    ...
    iget-boolean v0, p0, mSingleUser:Z
...
.method protected enforceReadPermissionInner(Landroid/net/Uri;)V
    ...
    iget-boolean v0, v0, mExported:Z
    ...
    invoke-virtual {v0, v12, v15, v5}, checkUser(IILandroid/content/Context;)Z
    ...
    .line 511
    invoke-virtual/range {p0 .. p0}, getReadPermission()Ljava/lang/String;
    ...
    :goto_3a
    invoke-virtual/range {p0 .. p0}, getPathPermissions()[Landroid/content/pm/PathPermission;
...
.method protected enforceWritePermissionInner(Landroid/net/Uri;)V
    ...
    .line 573
    invoke-virtual/range {p0 .. p0}, getWritePermission()Ljava/lang/String;
...
.method public getAppOpsManager()Landroid/app/AppOpsManager;
    ...
    .prologue
    .line 774
    iget-object v0, p0, mTransport:Landroid/content/ContentProvider$Transport;
...
.method public final getPathPermissions()[Landroid/content/pm/PathPermission;
    ...
    .prologue
    .line 761
    iget-object v0, p0, mPathPermissions:[Landroid/content/pm/PathPermission;
...
.method public final getReadPermission()Ljava/lang/String;
    ...
    .prologue
    .line 717
    iget-object v0, p0, mReadPermission:Ljava/lang/String;
...
.method public final getWritePermission()Ljava/lang/String;
    ...
    .prologue
    .line 739
    iget-object v0, p0, mWritePermission:Ljava/lang/String;
...
.method protected final matchesOurAuthorities(Ljava/lang/String;)Z
    ...
    .prologue
    .line 685
    iget-object v2, p0, mAuthority:Ljava/lang/String;
    ...
    .line 688
    :cond_b
    iget-object v2, p0, mAuthorities:[Ljava/lang/String;
...
.method public openAssetFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    ...
    .prologue
    .line 1336
    invoke-virtual {p0, p1, p2}, openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method public openAssetFile(Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/content/res/AssetFileDescriptor;
    ...
    .prologue
    .line 1399
    invoke-virtual {p0, p1, p2}, openAssetFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
...
.method public openTypedAssetFile(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;)Landroid/content/res/AssetFileDescriptor;
    ...
    invoke-virtual {p0, p1, v1}, openAssetFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    ...
    .line 1518
    :cond_10
    invoke-virtual {p0, p1}, getType(Landroid/net/Uri;)Ljava/lang/String;
...
.method public openTypedAssetFile(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/content/res/AssetFileDescriptor;
    ...
    .prologue
    .line 1582
    invoke-virtual {p0, p1, p2, p3}, openTypedAssetFile(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;)Landroid/content/res/AssetFileDescriptor;
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    .prologue
    .line 980
    invoke-virtual/range {p0 .. p5}, query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public rejectQuery(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    .line 853
    :goto_a
    invoke-virtual/range {p0 .. p6}, query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method protected final setAuthorities(Ljava/lang/String;)V
    ...
    .line 674
    iput-object p1, p0, mAuthority:Ljava/lang/String;

    .line 675
    iput-object v2, p0, mAuthorities:[Ljava/lang/String;
    ...
    .line 677
    :cond_11
    iput-object v2, p0, mAuthority:Ljava/lang/String;
    ...
    iput-object v0, p0, mAuthorities:[Ljava/lang/String;
...
.method protected final setPathPermissions([Landroid/content/pm/PathPermission;)V
    ...
    .prologue
    .line 750
    iput-object p1, p0, mPathPermissions:[Landroid/content/pm/PathPermission;
...
.method protected final setReadPermission(Ljava/lang/String;)V
    ...
    .prologue
    .line 706
    iput-object p1, p0, mReadPermission:Ljava/lang/String;
...
.method protected final setWritePermission(Ljava/lang/String;)V
    ...
    .prologue
    .line 728
    iput-object p1, p0, mWritePermission:Ljava/lang/String;
