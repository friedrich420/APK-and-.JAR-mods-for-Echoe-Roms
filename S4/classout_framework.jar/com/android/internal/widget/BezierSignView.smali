...
.method private addToPathForDrawing(I)V
    ...
    .line 112
    iget-object v9, p0, mSignatureInputData:[Ljava/util/ArrayList;
    ...
    .line 128
    :cond_63
    iget-object v9, p0, mPath:Landroid/graphics/Path;
    ...
    .end local v8    # "y":F
    :cond_79
    iget v9, p0, mBezierX:F

    iput v9, p0, mX:F

    .line 138
    iget v9, p0, mBezierY:F
...
.method doBezier(IFFFFJF)V
    ...
    iget-object v2, v0, mSignatureInputData:[Ljava/util/ArrayList;

    invoke-virtual/range {p0 .. p0}, getIndex()I
...
.method protected handleActionDown(Landroid/view/MotionEvent;FF)V
    ...
    iput-boolean v0, p0, mBezierEnabled:Z
...
.method protected handleActionMove(Landroid/view/MotionEvent;FF)V
    ...
    iget-boolean v1, p0, mUseHistoricalEvent:Z
    ...
    .line 71
    invoke-direct {p0, v0}, addToPathForDrawing(I)V
