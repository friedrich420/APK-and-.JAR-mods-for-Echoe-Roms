...
.method public getWatermark()J
    ...
    :try_end_14
    .catch Ljava/io/FileNotFoundException; {:try_start_b .. :try_end_14} :catch_8b
    .catch Ljava/io/IOException; {:try_start_b .. :try_end_14} :catch_95
    .catchall {:try_start_b .. :try_end_14} :catchall_9f
    ...
    invoke-direct {p0, v0, v1}, extractMemValue([BI)J
    :try_end_7e
    .catch Ljava/io/FileNotFoundException; {:try_start_17 .. :try_end_7e} :catch_b7
    .catch Ljava/io/IOException; {:try_start_17 .. :try_end_7e} :catch_b4
    .catchall {:try_start_17 .. :try_end_7e} :catchall_b1
    ...
    invoke-virtual {v3}, Ljava/io/FileInputStream;->close()V
    :try_end_86
    .catch Ljava/io/IOException; {:try_start_83 .. :try_end_86} :catch_a9
    ...
    invoke-virtual {v2}, Ljava/io/FileInputStream;->close()V
    :try_end_91
    .catch Ljava/io/IOException; {:try_start_8e .. :try_end_91} :catch_ab
    ...
    invoke-virtual {v2}, Ljava/io/FileInputStream;->close()V
    :try_end_a5
    .catch Ljava/io/IOException; {:try_start_a2 .. :try_end_a5} :catch_af
