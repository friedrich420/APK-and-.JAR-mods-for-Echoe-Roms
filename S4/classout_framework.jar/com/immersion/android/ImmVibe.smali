...
.method public closeDevice(I)V
    ...
    .line 143
    invoke-direct {p0, p1}, CloseDevice2(I)V
...
.method public createStreamingEffect(I)I
    ...
    .prologue
    .line 220
    invoke-direct {p0, p1}, CreateStreamingEffect(I)I
...
.method public deleteIVTFile(Ljava/lang/String;)V
    ...
    .prologue
    .line 298
    invoke-direct {p0, p1}, DeleteIVTFile(Ljava/lang/String;)V
...
.method public destroyStreamingEffect(II)V
    ...
    .prologue
    .line 224
    invoke-direct {p0, p1, p2}, DestroyStreamingEffect(II)V
...
.method public getBuiltInEffects()[B
    ...
    .prologue
    .line 236
    invoke-direct {p0}, GetBuiltInEffects()[B
...
.method public getDeviceCapabilityBool(II)Z
    ...
    .prologue
    .line 42
    invoke-direct {p0, p1, p2}, GetDeviceCapabilityBool(II)Z
...
.method public getDeviceCapabilityInt32(II)I
    ...
    .prologue
    .line 46
    invoke-direct {p0, p1, p2}, GetDeviceCapabilityInt32(II)I
...
.method public getDeviceCapabilityString(II)Ljava/lang/String;
    ...
    .prologue
    .line 50
    invoke-direct {p0, p1, p2}, GetDeviceCapabilityString(II)Ljava/lang/String;
...
.method public getDeviceCount()I
    ...
    .prologue
    .line 34
    invoke-direct {p0}, GetDeviceCount()I
...
.method public getDevicePropertyBool(II)Z
    ...
    .prologue
    .line 148
    invoke-direct {p0, p1, p2}, GetDevicePropertyBool(II)Z
...
.method public getDevicePropertyInt32(II)I
    ...
    .prologue
    .line 156
    invoke-direct {p0, p1, p2}, GetDevicePropertyInt32(II)I
...
.method public getDevicePropertyString(II)Ljava/lang/String;
    ...
    .prologue
    .line 164
    invoke-direct {p0, p1, p2}, GetDevicePropertyString(II)Ljava/lang/String;
...
.method public getDeviceState(I)I
    ...
    .prologue
    .line 38
    invoke-direct {p0, p1}, GetDeviceState(I)I
...
.method public getEffectState(II)I
    ...
    .prologue
    .line 200
    invoke-direct {p0, p1, p2}, GetEffectState(II)I
...
.method public getIVTEffectCount([B)I
    ...
    .prologue
    .line 266
    invoke-direct {p0, p1}, GetIVTEffectCount([B)I
...
.method public getIVTEffectDuration([BI)I
    ...
    .prologue
    .line 282
    invoke-direct {p0, p1, p2}, GetIVTEffectDuration([BI)I
...
.method public getIVTEffectIndexFromName([BLjava/lang/String;)I
    ...
    .prologue
    .line 274
    invoke-direct {p0, p1, p2}, GetIVTEffectIndexFromName([BLjava/lang/String;)I
...
.method public getIVTEffectName([BI)Ljava/lang/String;
    ...
    .prologue
    .line 270
    invoke-direct {p0, p1, p2}, GetIVTEffectName([BI)Ljava/lang/String;
...
.method public getIVTEffectType([BI)I
    ...
    .prologue
    .line 278
    invoke-direct {p0, p1, p2}, GetIVTEffectType([BI)I
...
.method public getIVTMagSweepEffectDefinition([BI[I[I[I[I[I[I[I)V
    ...
    .prologue
    .line 286
    invoke-direct/range {p0 .. p9}, GetIVTMagSweepEffectDefinition([BI[I[I[I[I[I[I[I)V
...
.method public getIVTPeriodicEffectDefinition([BI[I[I[I[I[I[I[I[I)V
    ...
    .prologue
    .line 290
    invoke-direct/range {p0 .. p10}, GetIVTPeriodicEffectDefinition([BI[I[I[I[I[I[I[I[I)V
...
.method public getIVTSize([B)I
    ...
    .prologue
    .line 306
    invoke-direct {p0, p1}, GetIVTSize2([B)I
...
.method public initialize()V
    ...
    .prologue
    .line 24
    invoke-direct {p0}, Initialize2()V
...
.method public initializeIVTBuffer(I)[B
    ...
    .prologue
    .line 302
    invoke-direct {p0, p1}, InitializeIVTBuffer(I)[B
...
.method public insertIVTElement([BII[I)[B
    ...
    invoke-direct {p0, p1, p3, p4, v0}, InsertIVTElement2([BI[I[B)[B
...
.method public insertIVTElement([BI[I[B)[B
    ...
    .prologue
    .line 325
    invoke-direct {p0, p1, p2, p3, p4}, InsertIVTElement2([BI[I[B)[B
...
.method public modifyPlayingMagSweepEffect(IIIIIIIII)V
    ...
    .prologue
    .line 192
    invoke-direct/range {p0 .. p9}, ModifyPlayingMagSweepEffect(IIIIIIIII)V
...
.method public modifyPlayingPeriodicEffect(IIIIIIIIII)V
    ...
    .prologue
    .line 196
    invoke-direct/range {p0 .. p10}, ModifyPlayingPeriodicEffect(IIIIIIIIII)V
...
.method public openCompositeDevice(I)I
    ...
    invoke-direct {p0, v0, p1}, OpenCompositeDevice2([II)I
...
.method public openCompositeDevice([IILjava/lang/String;)I
    ...
    invoke-direct {p0, v2, p2}, OpenCompositeDevice2([II)I
    ...
    :try_start_10
    invoke-virtual {p0, v1, v2, p3}, setDevicePropertyString(IILjava/lang/String;)V
    :try_end_13
    ...
    invoke-direct {p0, v1}, CloseDevice2(I)V
...
.method public openDevice(I)I
    ...
    .prologue
    .line 54
    invoke-direct {p0, p1}, OpenDevice2(I)I
...
.method public openDevice(ILjava/lang/String;)I
    ...
    :try_start_f
    invoke-virtual {p0, v1, v2, p2}, setDevicePropertyString(IILjava/lang/String;)V
    :try_end_12
...
.method public pausePlayingEffect(II)V
    ...
    .prologue
    .line 204
    invoke-direct {p0, p1, p2}, PausePlayingEffect(II)V
...
.method public playBuiltInEffect(II)I
    ...
    invoke-direct {p0, p1, v0, p2}, PlayIVTEffect(I[BI)I
...
.method public playBuiltInEffectRepeat(IIB)I
    ...
    invoke-direct {p0, p1, v0, p2, p3}, PlayIVTEffectRepeat(I[BIB)I
...
.method public playIVTEffect(I[BI)I
    ...
    .prologue
    .line 172
    invoke-direct {p0, p1, p2, p3}, PlayIVTEffect(I[BI)I
...
.method public playIVTEffectRepeat(I[BIB)I
    ...
    .prologue
    .line 176
    invoke-direct {p0, p1, p2, p3, p4}, PlayIVTEffectRepeat(I[BIB)I
...
.method public playMagSweepEffect(IIIIIIII)I
    ...
    .prologue
    .line 180
    invoke-direct/range {p0 .. p8}, PlayMagSweepEffect(IIIIIIII)I
...
.method public playPeriodicEffect(IIIIIIIII)I
    ...
    .prologue
    .line 184
    invoke-direct/range {p0 .. p9}, PlayPeriodicEffect(IIIIIIIII)I
...
.method public playStreamingSample(II[BI)V
    ...
    .prologue
    .line 228
    invoke-direct {p0, p1, p2, p3, p4}, PlayStreamingSample(II[BI)V
...
.method public playStreamingSampleWithOffset(II[BII)V
    ...
    .prologue
    .line 232
    invoke-direct/range {p0 .. p5}, PlayStreamingSampleWithOffset(II[BII)V
...
.method public playWaveformEffect(I[BIIII)I
    ...
    .prologue
    .line 188
    invoke-direct/range {p0 .. p6}, PlayWaveformEffect(I[BIIII)I
...
.method public readIVTElement([BII)[I
    ...
    .prologue
    .line 381
    invoke-direct {p0, p1, p2, p3}, ReadIVTElement2([BII)[I
...
.method public readIVTElement([BIII)[I
    ...
    .prologue
    .line 399
    invoke-direct {p0, p1, p3, p4}, ReadIVTElement2([BII)[I
...
.method public readIVTElementData([BII)[B
    ...
    .prologue
    .line 403
    invoke-direct {p0, p1, p2, p2}, ReadIVTElementData([BII)[B
...
.method public removeIVTElement([BII)[B
    ...
    .prologue
    .line 359
    invoke-direct {p0, p1, p2, p3}, RemoveIVTElement2([BII)[B
...
.method public removeIVTElement([BIII)[B
    ...
    .prologue
    .line 377
    invoke-direct {p0, p1, p3, p4}, RemoveIVTElement2([BII)[B
...
.method public resumePausedEffect(II)V
    ...
    .prologue
    .line 208
    invoke-direct {p0, p1, p2}, ResumePausedEffect(II)V
...
.method public saveIVTFile([BLjava/lang/String;)V
    ...
    .prologue
    .line 294
    invoke-direct {p0, p1, p2}, SaveIVTFile([BLjava/lang/String;)V
...
.method public setDevicePropertyBool(IIZ)V
    ...
    .prologue
    .line 152
    invoke-direct {p0, p1, p2, p3}, SetDevicePropertyBool(IIZ)V
...
.method public setDevicePropertyInt32(III)V
    ...
    .prologue
    .line 160
    invoke-direct {p0, p1, p2, p3}, SetDevicePropertyInt32(III)V
...
.method public setDevicePropertyString(IILjava/lang/String;)V
    ...
    .prologue
    .line 168
    invoke-direct {p0, p1, p2, p3}, SetDevicePropertyString(IILjava/lang/String;)V
...
.method public stopAllPlayingEffects(I)V
    ...
    .prologue
    .line 216
    invoke-direct {p0, p1}, StopAllPlayingEffects(I)V
...
.method public stopPlayingEffect(II)V
    ...
    .prologue
    .line 212
    invoke-direct {p0, p1, p2}, StopPlayingEffect(II)V
