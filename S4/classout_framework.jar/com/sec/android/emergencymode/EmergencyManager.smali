...
.method static constructor <clinit>()V
    ...
    sput-object v0, sInstance:Lcom/sec/android/emergencymode/EmergencyManager;
...
.method private constructor <init>(Landroid/os/Handler;Landroid/content/Context;)V
    ...
    iput-object v0, p0, mReceiverUPSM:Landroid/content/BroadcastReceiver;
    ...
    .line 79
    invoke-direct {p0}, ensureServiceConnected()V
...
.method static synthetic access$000(Lcom/sec/android/emergencymode/EmergencyManager;ZIZ)V
    ...
    .prologue
    .line 51
    invoke-direct {p0, p1, p2, p3}, triggerEmergencyMode(ZIZ)V
...
.method private ensureServiceConnected()V
    ...
    .line 84
    :try_start_0
    sget-object v1, mService:Lcom/sec/android/emergencymode/IEmergencyManager;
    ...
    sput-object v1, mService:Lcom/sec/android/emergencymode/IEmergencyManager;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/sec/android/emergencymode/EmergencyManager;
    ...
    :try_start_3
    sget-object v1, sInstance:Lcom/sec/android/emergencymode/EmergencyManager;
    ...
    invoke-direct {v1, v0, p0}, <init>(Landroid/os/Handler;Landroid/content/Context;)V

    sput-object v1, sInstance:Lcom/sec/android/emergencymode/EmergencyManager;
...
.method private registerReceiver()V
    ...
    iget-object v4, p0, mReceiverUPSM:Landroid/content/BroadcastReceiver;
...
.method private declared-synchronized stopService()V
    ...
    :try_start_1
    sget-object v2, mService:Lcom/sec/android/emergencymode/IEmergencyManager;
    ...
    sput-object v2, mService:Lcom/sec/android/emergencymode/IEmergencyManager;
    :try_end_39
...
.method private triggerEmergencyMode(ZIZ)V
    ...
    invoke-direct {p0, v0, p1, p2, p3}, startService(Ljava/lang/String;ZIZ)V
...
.method public canSetMode()Z
    ...
    .line 488
    invoke-static {}, supportUltraPowerSavingMode()Z
    ...
    :try_start_21
    invoke-virtual {p0}, isModifying()Z
    ...
    :try_end_4c
    .catch Ljava/lang/Exception; {:try_start_21 .. :try_end_4c} :catch_ca
...
.method public readyEmergencyMode()V
    ...
    invoke-static {v0}, isEmergencyMode(Landroid/content/Context;)Z
    ...
    .line 140
    invoke-direct {p0, v2, v7, v8, v7}, startService(Ljava/lang/String;ZIZ)V
    ...
    invoke-direct {p0, v0, v7, v8, v7}, startService(Ljava/lang/String;ZIZ)V
