...
.method private update(Ljava/util/Collection;Ljava/util/Collection;Ljava/lang/String;)Z
    ...
    .line 207
    sget-object v13, Lcom/android/common/contacts/DataUsageStatUpdater;->TAG:Ljava/lang/String;
    ...
    const-string v14, "Given list for data IDs is null. Ignoring."
    ...
    .line 211
    :cond_1
    sget-object v13, Lcom/android/common/contacts/DataUsageStatUpdater$DataUsageFeedback;->FEEDBACK_URI:Landroid/net/Uri;
    ...
    invoke-virtual {v13, v9, v14, v15, v0}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v15, "update toward data rows "
    ...
    const-string v14, "Given list for contact IDs is null. Ignoring."
    ...
    .line 231
    .local v12, "whereBuilder":Ljava/lang/StringBuilder;
    ...
    .line 233
    .local v7, "questionMarks":[Ljava/lang/String;
    ...
    invoke-static {v7, v13}, Ljava/util/Arrays;->fill([Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v14, v7}, Landroid/text/TextUtils;->join(Ljava/lang/CharSequence;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-string v15, "contactId where: "
    ...
    const-string v15, "contactId selection: "
    ...
    iget-object v14, v0, Lcom/android/common/contacts/DataUsageStatUpdater;->mResolver:Landroid/content/ContentResolver;
    ...
    invoke-virtual {v14, v15, v10, v0, v13}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v15, "update toward raw contacts "
